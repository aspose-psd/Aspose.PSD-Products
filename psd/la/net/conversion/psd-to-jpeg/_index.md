---
title: Converte PSD ad JPEG cum C#
...
url: la/net/conversion/psd-to-jpeg/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1=" Converte PSD ad JPEG per C#" h2=".NET Photoshop API ad PSD & PSB Conversion ad raster imagines inter JPEG">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=" High Quality Reddendo of PSD ut JPEG" %}}
1. Load the PSD with [Image.Load] (https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) methodo
1. crea instantia [JpegOptions] (https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/jpegoptions) classis
1. Voca [Image.Save] (https://apireference.aspose.com/psd/net/aspose.psd/image/methods/save/index) methodus
1. Transi output name and object of JpegOptions
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# Codex ad PSD ad JPEG Conversionis" gistPath="" %}}
