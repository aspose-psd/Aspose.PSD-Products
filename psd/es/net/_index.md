---
title: API de manipulación de Photoshop C# .NET - Aspose
weight: 90
description: C# ASP.NET VB.NET Biblioteca de Photoshop para crear, editar y convertir formatos Photoshop PSD PSB
url: net/
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1=".NET API para manipular archivos de Photoshop" h2="Cree, lea, edite y convierta archivos PSD y PSB sin ninguna dependencia de Adobe Photoshop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/headers/aspose_psd-for-net.svg" pfName="Aspose.PSD" subTitlepfName="para .NET" downloadUrl="https://releases.aspose.com/psd/net" >}}
...
<p>Aspose.PSD para .NET es una API avanzada de manipulación de formatos de archivos AI de nivel de entrada y PSD sin ninguna dependencia de Adobe Photoshop o Adobe Illustrator. La API permite crear y editar los archivos de Photoshop, además de brindar la capacidad de actualizar las propiedades de las capas, agregar marcas de agua, realizar operaciones gráficas o convertir un formato de archivo a otro.</p>

<p>
 La API admite la importación como una capa y la exportación a los siguientes formatos:
 ...
 junto con la exportación a Pdf con texto seleccionable. Aspose.PSD es compatible parcialmente con funciones de Adobe Photoshop como capas de ajuste, representación y edición de capas de texto, capas de relleno, efectos de capas, edición de raster y máscaras vectoriales para capas.
</p>
...
<div class="diagram1 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt=".NET API de procesamiento PSD" src="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-net.svg"/>
  <header>
   Aspose.PSD
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Independencia de plataforma" description="Aspose.PSD para .NET es compatible con cualquier marco .NET a partir de 2.0." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
  ...
  <div class="d1-col d1-right">
   ...
   <ul>
    ...
    <li>
     Aplicación de Windows basada en .NET Core
    </li>
   </ul>
  </div>
 </div>
...
{{< blocks/products/pf/carousel-item h3="Formatos de archivo compatibles" description="Aspose.PSD para .NET es compatible con los formatos de archivo [Photoshop e imagen rasterizada](https://docs.aspose.com/psd/net/supported-file-formats/) más populares." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Características avanzadas de la API de manipulación de PSD de .NET
   </h2>
   <p>
    &amp;nbsp
   </p>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/converting-psd-image-to-raster-format/">Convertir archivos de Photoshop a imágenes</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/cropping-psd-file-while-converting-to-png/">Recortar a una región rectangular</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/converting-psd-image-to-raster-format/">Archivo PSD Vista previa Exportación perfecta de píxeles</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Fecha y hora de creación de la capa
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/layers-and-mask-information-section/">Máscaras de capa</a>
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-pencil-square-o ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/working-with-text-layers/#update-text-layer-in-psd-file">Actualización de Capas de Texto en Tiempo de Ejecución</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/modifying-images/#color-balance-adjustment-layer">Capa de ajuste de balance de color</a>
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-repeat ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/modifying-images/#invert-adjustment-layer">Invertir capa de ajuste</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/manipulating-adobe-photoshop-formats/#manager-photo-filter-adjustment-layer">Capa de ajuste de filtro de fotos</a>
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-scissors ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/layer-vector-mask/">Rasterización en tiempo de ejecución de máscaras de capa vectorial</a>
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-pencil-square-o ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/editing-raster-layer-masks-in-psd-file-via-api/">Edición de Máscaras de Capa Raster</a>
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-clone ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/manipulating-adobe-photoshop-formats/#manage-opacity-of-layers">Administrar opacidad de capas y aplanar capas</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/list-of-psd-layer-resources/">Soporte de una gran cantidad de recursos de capa</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/list-of-the-supported-psd-global-image-resources/">Soporte de una gran cantidad de recursos de la sección de imágenes</a>
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-pencil-square-o ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/working-with-layers/#support-of-linked-layers">Adición y eliminación de capas vinculadas</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/manipulating-adobe-illustrator-formats/">Capacidad para abrir y exportar archivos AI</a>
    </p>
   </div>
   <!--<div class="col-lg-12">

<h2 class="h2title">Últimas características de la API de PSD</h2>

<p>Aspose.PSD para la API de .NET agrega continuamente más funciones para que sea más potente. Aquí hay una lista de algunas selecciones de las últimas añadidas.</p>

<ul>

<li>Soporte de capas de Relleno. Relleno de patrón, color y degradado</li>

<li>Soporte de GdFlResource, VmskResource, PtFlResource y VsmsResource</li>

<li>Cargar archivos de imagen JPEG/PNG/etc a PsdImage sin carga directa</li>

<li>Rasterización de máscaras vectoriales de capa y FlipRotate personalizado de capa de texto</li>

<li>Representación del efecto Trazo con Relleno de color para exportar</li>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Exportar PSD a varios formatos ráster
    </h2>
    <p>
     Aspose.PSD para .NET brinda la capacidad de exportar archivos PSD a cualquiera de los formatos de imagen ráster admitidos, con solo unas pocas líneas de código.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Convertir PSD a PNG, JPEG y TIFF - C#
     </h3>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Acceder y manipular capas PSD
    </h2>
    <p>
     Aspose.PSD para .NET le permite acceder a capas de un PSD con la capacidad de dibujar sobre él con imagen o texto. Puede fusionar capas, actualizar texto en capas, establecer efectos o exportar capas como una imagen. También puede usar la API PSD .NET para detectar archivos PSD planos o crear miniaturas.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.PSD para .NET no solo admite la carga de formatos de archivo PSD y PSB para su manipulación y conversión, sino que también proporciona la capacidad de crear archivos PSD y PSB desde cero. Los desarrolladores de .NET pueden usar la API para automatizar escenarios que pueden ayudarlos en su camino.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Crear PSD desde cero - C#
     </h3>
...
{{< blocks/products/pf/slr-element name="Notas de la versión" href="https://docs.aspose.com/psd/net/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
