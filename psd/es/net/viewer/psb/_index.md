...
weight: 320
description: Código fuente de C# para cargar, renderizar y mostrar documentos PSB en .NET Framework, .NET Core.
url: net/viewer/psb/
---
...
<!-- aboutfile Starts -->
 ...
 Aspose.PSD es una API de manipulación de formatos de Photoshop. Se pueden generar, modificar y convertir documentos de Adobe Photoshop e Illustrator. Además, los usuarios finales pueden realizar operaciones gráficas, actualizar las propiedades de las capas, añadir marcas de agua o renderizar un formato a PNG, GIF, BMP, TIFF, JPEG, JPEG2000, PSD, PSB, etc. Es una API independiente y no requiere la instalación de Adobe Photoshop. 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Aplicación gratuita para ver PSB" sectionDescription="Echa un vistazo a nuestras demostraciones en directo para [Ver PSB](https://products.aspose.app/psd/viewer/psb) con las siguientes ventajas»." >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text="No es necesario descargar ni configurar nada" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text="No hay necesidad de escribir o compilar código" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Simplemente sube el archivo PSB y pulsa el botón\" Ver\»" >}}
