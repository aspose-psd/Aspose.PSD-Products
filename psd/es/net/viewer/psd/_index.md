...
weight: 100
description: Código fuente C# para cargar, renderizar y mostrar documentos PSD en .NET Framework, .NET Core.
---
...
<!-- aboutfile Starts -->
 ...
 Aspose.PSD es una API de manipulación de formato de Photoshop. Se pueden generar, modificar y convertir documentos de Adobe Photoshop e Illustrator. Además, los usuarios finales pueden realizar operaciones gráficas, actualizar las propiedades de las capas, agregar marcas de agua o renderizar un formato a PNG, GIF, BMP, TIFF, JPEG, JPEG2000, PSD, PSB, etc. Es una API independiente y no requiere la instalación de Adobe Photoshop.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Aplicación gratuita para ver PSD" sectionDescription="Consulte nuestras demostraciones en vivo para [Ver PSD](https://products.aspose.app/psd/viewer/psd) con los siguientes beneficios." >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No es necesario descargar ni configurar nada" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No es necesario escribir ni compilar código" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Simplemente cargue el archivo PSD y presione \"View\" button" >}}
