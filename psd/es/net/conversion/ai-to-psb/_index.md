---
title: Convertir AI a PSB a través de C#
description: Código de muestra para la conversión de AI a PSB C#. Utilice el código de ejemplo de API para la conversión de archivos AI por lotes a PSB dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
url: es/net/conversion/ai-to-psb/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir AI a PSB a través de C#" h2="" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PSB" pfName="Aspose.PSD" subTitlepfName="para .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PSD" fileiconsmall4="XML" fileiconsmall5="AI" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir AI a PSB mediante C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD facilita a los desarrolladores la carga y conversión de archivos AI a PSB con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra la conversión de AI a PSB C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicación gratuita para convertir AI a PSB" sectionDescription="Consulte nuestras demostraciones en vivo para [conversión de AI a PSB](https://products.aspose.app/psd/conversion/ai-to-psb) con los siguientes beneficios." >}}
