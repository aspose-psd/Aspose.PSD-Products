---
title: Convertir AI a PSD a través de C#
description: Código de muestra para la conversión de AI a PSD C#. Utilice el código de ejemplo de API para la conversión de archivos AI por lotes a PSD dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
url: es/net/conversion/ai-to-psd/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir AI a PSD a través de C#" h2="" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PSD" pfName="Aspose.PSD" subTitlepfName="para .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PSD" fileiconsmall4="XML" fileiconsmall5="AI" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD facilita a los desarrolladores la carga y conversión de archivos AI a PSD con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue la IA con el método [Image.Load](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index)
1. Cree una instancia de la clase [PsdOptions](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/PsdOptions)
1. Llame al método [Image.Save](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/save/index)
1. Pase el nombre del archivo de salida y el objeto de PsdOptions
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra la conversión de AI a PSD C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicación gratuita para convertir AI a PSD" sectionDescription="Consulte nuestras demostraciones en vivo para [conversión de AI a PSD](https://products.aspose.app/psd/conversion/ai-to-psd) con los siguientes beneficios." >}}
