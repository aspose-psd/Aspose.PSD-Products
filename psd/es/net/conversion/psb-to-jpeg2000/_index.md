---
title: Convierta PSB a JPEG2000 mediante C#
description: Código de ejemplo para la conversión de PSB a JPEG2000 a C#. Utilice el código de ejemplo de API para la conversión por lotes de archivos PSB a JPEG2000 en VB.NET, ASP.Net o cualquier aplicación basada en .NET.
url: psb-to-jpeg2000/
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD facilita a los desarrolladores la carga y conversión de archivos PSB a JPEG2000 en solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/code-block title="Este código de ejemplo muestra la conversión de AI a JPEG 2000 en C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicación gratuita para convertir PSB a JPEG2000" sectionDescription="Check our live demos for [PSB to JPEG2000 conversion](https://products.aspose.app/psd/conversion/psb-to-jpeg2000) with following benefits." >}}
