---
title: Convertir PSD a GIF con C#
...
url: es/net/conversion/psd-to-gif/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PSD a GIF a través de C#" h2=".NET Photoshop API para conversión de PSD y PSB a imágenes rasterizadas, incluido GIF">}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET Código C# para conversión de PSD a GIF" gistPath="" %}}
