---
title: Convertir AI a JPEG2000 a través de C#
description: Código de muestra para la conversión de AI a JPEG2000 C#. Utilice el código de ejemplo de API para la conversión de archivos AI por lotes a JPEG2000 dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
url: es/net/conversion/ai-to-jpeg2000/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir AI a JPEG2000 a través de C#" h2="" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG2000" pfName="Aspose.PSD" subTitlepfName="para .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PSD" fileiconsmall4="XML" fileiconsmall5="AI" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir AI a JPEG2000 a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD facilita a los desarrolladores la carga y conversión de archivos AI a JPEG2000 con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra la conversión de AI a JPEG2000 C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicación gratuita para convertir AI a JPEG2000" sectionDescription="Consulte nuestras demostraciones en vivo para [conversión de AI a JPEG2000](https://products.aspose.app/psd/conversion/ai-to-jpeg2000) con los siguientes beneficios." >}}
