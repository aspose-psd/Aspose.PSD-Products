---
title: Convertir PSD a PDF a través de C#
weight: 200
description: Código de muestra para la conversión de PSD a PDF C#. Utilice el código de ejemplo API para la conversión de archivos PSD por lotes a PDF dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
url: es/net/conversion/psd-to-pdf/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir PSD a PDF a través de C#" h2="" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="Aspose.PSD" subTitlepfName="para .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSD" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD facilita a los desarrolladores la carga y conversión de archivos PSD a PDF con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra la conversión de PSD a PDF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicación gratuita para convertir PSD a PDF" sectionDescription="Consulte nuestras demostraciones en vivo para [conversión de PSD a PDF](https://products.aspose.app/psd/conversion/psd-to-pdf) con los siguientes beneficios." >}}
