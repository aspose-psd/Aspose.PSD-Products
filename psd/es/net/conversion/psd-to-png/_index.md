---
title: Convertir PSD a PNG con C#
...
url: es/net/conversion/psd-to-png/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PSD a PNG a través de C#" h2=".NET Photoshop API para conversión de PSD y PSB a imágenes raster, incluido PNG">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Representación de alta calidad de PSD como PNG" %}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET Código C# para conversión de PSD a PNG" gistPath="" %}}
