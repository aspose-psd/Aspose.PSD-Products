---
title: Convierte PSD a PNG con C#
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PSD a PNG a través de C#" h2="API .NET Photoshop para conversión de PSD y PSB a imágenes rasterizadas, incluido JPEG" >}}
...
1. Cargue el PSD con [Imagen. Cargar](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) método
 [Opciones de PNG](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/pngoptions) clase
...
{{% blocks/products/pf/agp/code-autogen title="Código.NET C# para la conversión de PSD a PNG" gistPath="" %}}
