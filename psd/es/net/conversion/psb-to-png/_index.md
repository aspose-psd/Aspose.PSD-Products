---
title: Convertir PSB a PNG con C#
...
url: es/net/conversion/psb-to-png/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PSB a PNG a través de C#" h2=".NET Photoshop API para conversión de PSD y PSB a imágenes de trama, incluido PNG">}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET Código C# para conversión de PSB a PNG" gistPath="" %}}
