...
1. Crea una instancia de [Opciones de GIF](https://reference.aspose.com/psd/net/aspose.psd.imageoptions/gifoptions/) clase
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicación gratuita para convertir AI a GIF" sectionDescription="Consulte nuestras demostraciones en vivo para [Conversión de AI a GIF](https://products.aspose.app/psd/conversion/ai-to-gif) con las siguientes ventajas»." >}}
