---
title: Convierta AI a JPEG2000 mediante C#
description: Código de ejemplo para la conversión de AI a JPEG2000 a C#. Utilice el código de ejemplo de API para la conversión de archivos AI por lotes a JPEG2000 en VB.NET, ASP.Net o cualquier aplicación basada en .NET.
url: ai-to-jpeg2000/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/upper-banner h1="Convierte AI a JPEG2000 a través de C#" h2="" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG2000" pfName="Aspose.PSD" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PSD" fileiconsmall4="XML" fileiconsmall5="AI" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD facilita a los desarrolladores la carga y conversión de archivos AI a JPEG2000 en solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue la AI con [Imagen. Cargar](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) método
1. Crea una instancia de [Opciones de Jpeg 2000](https://reference.aspose.com/psd/net/aspose.psd.imageoptions/jpeg2000options/) clase
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicación gratuita para convertir AI a JPEG2000" sectionDescription="Consulte nuestras demostraciones en vivo para [Conversión de AI a JPEG2000](https://products.aspose.app/psd/conversion/ai-to-jpeg2000) con las siguientes ventajas»." >}}
