---
title: Convierte PSD a BMP con C#
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PSD a BMP mediante C#" h2="API .NET Photoshop para conversión de PSD y PSB a imágenes rasterizadas, incluido BMP" >}}
...
{{% blocks/products/pf/agp/code-autogen title="Código.NET C# para la conversión de PSD a BMP" gistPath="" %}}
