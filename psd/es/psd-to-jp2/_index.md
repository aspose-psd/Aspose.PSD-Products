---
title: Convierta PSD a JP2 con C#
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PSD a JP2 a través de C#" h2="API .NET Photoshop para conversión de PSD y PSB a imágenes rasterizadas, incluido JP2" >}}
...
1. Crea una instancia de gráficos a partir de la imagen. [Opciones de Jpeg 2000](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/jpeg2000options) clase
...
{{% blocks/products/pf/agp/code-autogen title="Código.NET C# para la conversión de PSD a JP2" gistPath="" %}}
