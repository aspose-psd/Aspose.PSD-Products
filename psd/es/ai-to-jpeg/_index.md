...
1. Crea una instancia de [Opciones JPEG](https://reference.aspose.com/psd/net/aspose.psd.imageoptions/jpegoptions/) clase
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicación gratuita para convertir AI a JPEG" sectionDescription="Consulte nuestras demostraciones en vivo para [Conversión de AI a JPEG](https://products.aspose.app/psd/conversion/ai-to-jpeg) con las siguientes ventajas»." >}}
