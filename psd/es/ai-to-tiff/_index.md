---
title: Convierta AI a TIFF a través de C#
description: Código de ejemplo para la conversión de AI a TIFF C#. Utilice el código de ejemplo de API para la conversión de archivos AI por lotes a TIFF en VB.NET, ASP.Net o cualquier aplicación basada en .NET.
url: ai-to-tiff/
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD facilita a los desarrolladores la carga y conversión de archivos AI a TIFF en solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/code-block title="Este código de ejemplo muestra la conversión de AI a TIFF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicación gratuita para convertir AI a TIFF" sectionDescription="Check our live demos for [AI to TIFF conversion](https://products.aspose.app/psd/conversion/ai-to-tiff) with following benefits." >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-download" text="Obtendrá al instante el enlace de descarga del archivo TIFF resultante»." >}}
