---
title: Convertir PSB a BMP a través de Java
weight: 300
description: Ejemplo de código de conversión de Java para formato PSB a archivo BMP. Utilice este código de ejemplo para convertir PSB a BMP dentro de cualquier aplicación basada en Web o Java de escritorio.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir PSB a BMP a través de Java" h2="API de Java Photoshop para conversión de PSB a imágenes raster, incluido BMP" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="Aspose.PSD" subTitlepfName="para Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSB" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir PSB a BMP usando Java" %}}
 ...
 Para convertir PSB a BMP, usaremos
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demostraciones en vivo de conversión de PSB a BMP" sectionDescription="[Convertir PSB a BMP](https://products.aspose.app/psd/conversion/psb-to-bmp) ahora mismo visitando nuestro sitio web de demostraciones en vivo. La demostración en vivo tiene los siguientes beneficios" >}}
