---
title: Convierta AI a JPEG2000 a través de Java
description: Ejemplo de código de conversión de Java para el formato AI a un archivo JPEG2000. Utilice este código de ejemplo para convertir AI a JPEG2000 en cualquier aplicación web o de escritorio basada en Java.
url: java/conversion/ai-to-jpeg2000/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/upper-banner h1="Convierte AI a JPEG2000 a través de Java" h2="Biblioteca nativa de Java para leer, escribir y exportar AI a JPEG2000 sin necesidad de Adobe»." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG2000" pfName="Aspose.PSD" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="JPEG2000" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AI" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 La API Aspose.PSD facilita a los desarrolladores la conversión de archivos AI a JPEG2000 en solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

- Cargar imagen AI de entrada
- Inicializar [Opciones de Jpeg 2000](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/jpeg2000Options) objeto de clase
- Especificar las propiedades de la imagen
- Guarde la imagen JPEG2000 de salida
...
{{% blocks/products/pf/agp/code-block title="Convierta AI a JPEG2000 - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demostraciones en vivo de conversión de AI a JPEG2000" sectionDescription="[Convert AI to JPEG2000](https://products.aspose.app/psd/conversion/ai-to-jpeg2000) ahora mismo visitando nuestro sitio web de demostraciones en vivo. La demostración en vivo tiene las siguientes ventajas" >}}
