---
title: Convertir AI a TIFF a través de Java
description: Ejemplo de código de conversión de Java para formato AI a archivo TIFF. Utilice este código de ejemplo para convertir AI a TIFF dentro de cualquier aplicación basada en Web o Java de escritorio.
url: es/java/conversion/ai-to-tiff/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir AI a TIFF a través de Java" h2="Biblioteca Java nativa para leer, escribir y exportar AI a TIFF sin necesidad de Adobe." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="Aspose.PSD" subTitlepfName="para Java" downloadUrl="" fileiconsmall1="TIFF" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AI" >}}
...
- Inicializar [TiffOptions](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/tiffOptions) objeto de clase
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demostraciones en vivo de conversión de AI a TIFF" sectionDescription="[Convertir AI a TIFF](https://products.aspose.app/psd/conversion/ai-to-tiff) ahora mismo visitando nuestro sitio web de demostraciones en vivo. La demostración en vivo tiene los siguientes beneficios" >}}
