---
title: Convertir AI a PSB a través de Java
description: Ejemplo de código de conversión de Java para formato AI a archivo PSB. Utilice este código de ejemplo para convertir AI a PSB dentro de cualquier aplicación basada en Java web o de escritorio.
url: es/java/conversion/ai-to-psb/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir AI a PSB a través de Java" h2="Biblioteca Java nativa para leer, escribir y exportar AI a PSB sin necesidad de Adobe." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PSB" pfName="Aspose.PSD" subTitlepfName="para Java" downloadUrl="" fileiconsmall1="PSB" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AI" >}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demostraciones en vivo de conversión de AI a PSB" sectionDescription="[Convertir AI a PSB](https://products.aspose.app/psd/conversion/ai-to-psb) ahora mismo visitando nuestro sitio web de demostraciones en vivo. La demostración en vivo tiene los siguientes beneficios" >}}
