---
title: Convierta AI a PDF a través de Java
description: Ejemplo de código de conversión de Java para formato AI a archivo PDF. Utilice este código de ejemplo para convertir AI a PDF en cualquier aplicación web o de escritorio basada en Java.
url: java/conversion/ai-to-pdf/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/upper-banner h1="Convierta AI a PDF a través de Java" h2="Biblioteca nativa de Java para leer, escribir y exportar AI a PDF sin necesidad de Adobe»." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="Aspose.PSD" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PDF" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AI" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 La API Aspose.PSD facilita a los desarrolladores la conversión de archivos AI a PDF en solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

- Cargar imagen AI de entrada
- Inicializar [Opciones de PDF](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/pdfOptions) objeto de clase
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demostraciones en vivo de conversión de AI a PDF" sectionDescription="[Convert AI to PDF](https://products.aspose.app/psd/conversion/ai-to-pdf) ahora mismo visitando nuestro sitio web de demostraciones en vivo. La demostración en vivo tiene las siguientes ventajas" >}}
