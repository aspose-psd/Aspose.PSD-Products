---
title: Convierte PSD a TIFF con C#
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PSD a TIFF a través de C#" h2="API .NET Photoshop para conversión de PSD y PSB a imágenes rasterizadas, incluido GIF" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Representación de alta calidad de PSD como TIFF" %}}
1. Cargue el PSD con [Imagen. Cargar](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) método
1. Crea una instancia de gráficos a partir de la imagen. [Opciones de TIFF](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/tiffoptions) clase
...
{{% blocks/products/pf/agp/code-autogen title="Código.NET C# para la conversión de PSD a TIFF" gistPath="" %}}
