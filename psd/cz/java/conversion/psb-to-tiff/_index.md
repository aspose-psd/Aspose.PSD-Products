---
title: Převést PSB na TIFF přes Java
weight: 40
description: Ukázkový kód převodu Java pro formát PSB do souboru TIFF. Pomocí tohoto příkladu kódu můžete převést PSB na TIFF v libovolné webové nebo desktopové aplikaci Java.
url: java/conversion/psb-to-tiff/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/upper-banner h1="Převést PSB na TIFF přes Javu" h2="Java Photoshop API pro PSB konverzi na rastrové obrázky včetně TIFF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="Aspose.PSD" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSB" >}}

{{< blocks/products/pf/main-container pfName="Aspose.PSD " subTitlepfName="for Java" >}}
{{< blocks/products/pf/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-psd" liveDemosLink="https://products.aspose.app/psd/family" docsLink="https://docs.aspose.com/psd/java" installationsDocsLink="https://docs.aspose.com/psd/java" nugetLink="" nugetPackageName="" downloadAsLink="https://releases.aspose.com/psd/java" learnAsLink="https://docs.aspose.com/psd/java" apiReference="" mavenRepoLink="https://repository.aspose.com/psd/" >}}

{{% blocks/products/pf/agp/content h2="Jak převést PSB na TIFF pomocí Java" %}}

 Abychom mohli PSB vykreslit TIFF, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod PSB na TIFF přes Java" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD API usnadňuje vývojářům převést soubor PSB na TIFF v několika řádcích kódu.
...
{{% blocks/products/pf/agp/code-block title="Převést PSB na TIFF - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živé ukázky konverze PSB na TIFF" sectionDescription="[Převést PSB na TIFF](https://products.aspose.app/psd/conversion/psb-to-tiff) právě teď navštívíte naše webové stránky Live Demos. Živé demo má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text="Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text="Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Stačí nahrát váš soubor PSB, bude okamžitě převeden na TIFF." >}}
