...
{{< blocks/products/pf/upper-banner h1="Převod AI do PDF přes Javu" h2="Nativní knihovna Java pro čtení, zápis a export AI do PDF bez potřeby Adobe." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="Aspose.PSD" subTitlepfName="pro Javu" downloadUrl="" fileiconsmall1="PDF" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AI" >}}
...
K vykreslení AI do PDF použijeme<a href="/psd/{{< lang-code >}}java">Aspose.PSD pro Javu</a> API, což je funkčně bohaté, výkonné a snadno použitelné konverzní API pro platformu Java. Jeho nejnovější verzi si můžete stáhnout přímo z<a href="https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-psd">Maven</a> a nainstalujte jej do svého projektu založeného na Maven přidáním následujících konfigurací do souboru pom.xml.
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod AI do PDF přes Java" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD API usnadňuje vývojářům převod AI souboru do PDF pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

- Načtěte vstupní AI obrázek
- Inicializujte objekt třídy [PdfOptions](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/pdfOptions)
- Určete vlastnosti
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka převodu AI do PDF" sectionDescription="[Převést AI do PDF](https://products.aspose.app/psd/conversion/ai-to-pdf) právě teď na našem webu Živá ukázka. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor AI a bude okamžitě převeden do PDF." >}}
