---
title: Převést PSB na BMP přes Java
weight: 300
description: Ukázkový kód převodu Java pro formát PSB do souboru BMP. Tento příklad kódu použijte k převodu PSB na BMP v libovolné webové nebo desktopové aplikaci Java.
url: java/conversion/psb-to-bmp/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/upper-banner h1="Převést PSB na BMP přes Java" h2="Java Photoshop API pro PSB konverzi na rastrové obrázky včetně BMP" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="Aspose.PSD" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSB" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést AI na BMP pomocí Java" %}}
 ...
 Abychom mohli vykreslit PSB do BMP, použijeme
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD API usnadňuje vývojářům převést soubor PSB na BMP v několika řádcích kódu.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živé ukázky konverze PSB na BMP" sectionDescription="[Převést PSB na BMP](https://products.aspose.app/psd/conversion/psb-to-bmp) právě teď navštívíte naše webové stránky Live Demos. Živé demo má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text="Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text="Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Stačí nahrát váš soubor PSB, bude okamžitě převeden na BMP." >}}
