...
{{< blocks/products/pf/carousel-item h3="Podporované formáty souborů" description="Aspose.PSD pro Javu [podporované formáty souborů](https://docs.aspose.com/psd/java/supported-file-formats/)  jsou uvedeny níže." >}}
