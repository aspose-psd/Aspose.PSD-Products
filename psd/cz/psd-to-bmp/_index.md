...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést PSD na BMP přes C#" h2=".NET Photoshop API pro PSD a PSB Konverze na rastrové obrázky včetně BMP" >}}
...
1. Vytvořte instanci grafiky z obrázku. [BMPoptions](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/bmpoptions) třída
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# kód pro PSD na BMP konverzi" gistPath="" %}}
