...
{{% blocks/products/pf/agp/content h2="Jak převést AI do PDF pomocí jazyka C#" %}}

Abychom mohli převést AI do PDF, použijeme <a href="/psd/{{< lang-code >}}net">Aspose.PSD pro .NET</a> Rozhraní API, které je bohaté na funkce, výkonné a snadno použitelné rozhraní API pro manipulaci s dokumenty a konverze pro platformu C#. Otevřeno <a href="https://www.nuget.org/packages/aspose.psd">NuGet</a> správce balíčků, hledat <b>Co je Aspose.PSD</b> a nainstalovat. Můžete také použít následující příkaz z konzoly Správce balíčků.
...
1. Vytvořte instanci [Možnosti PDFOptions](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/PdfOptions) třída
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod AI do PDF" sectionDescription="Podívejte se na naše živé ukázky [Konverze AI do PDF](https://products.aspose.app/psd/conversion/ai-to-pdf) s následujícími výhodami." >}}
