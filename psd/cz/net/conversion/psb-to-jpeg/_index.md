...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést PSB do formátu JPEG přes C#" h2=".NET Photoshop API pro PSD a PSB Konverze na rastrové obrázky včetně JPEG" >}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# kód pro konverzi PSB na JPEG" gistPath="" %}}
