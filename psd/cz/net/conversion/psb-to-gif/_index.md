...
url: cz/net/conversion/psb-to-gif/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést PSB na GIF přes C#" h2=".NET Photoshop API pro převod PSD a PSB na rastrové obrázky včetně GIF">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Vysoce kvalitní vykreslení PSB jako GIF" %}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# kód pro převod PSB na GIF" gistPath="" %}}
