---
title: Převést PSB na BMP pomocí C#
...
url: cz/net/conversion/psb-to-bmp/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést PSB na BMP přes C#" h2=".NET Photoshop API pro převod PSD a PSB na rastrové obrázky včetně BMP">}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# kód pro převod PSB na BMP" gistPath="" %}}
