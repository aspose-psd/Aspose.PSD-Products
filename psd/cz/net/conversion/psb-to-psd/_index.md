...
{{% blocks/products/pf/agp/content h2="Jak převést PSB na PSD pomocí C#" %}}
 ...
 Abychom převedli PSB na PSD, použijeme
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD usnadňuje vývojářům načítání a převod PSB souborů na PSD v několika řádcích kódu.
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi PSB na PSD C#" offSpacer="" %}}
