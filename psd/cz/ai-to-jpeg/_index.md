...
1. Vytvořte instanci [JPEGOptions](https://reference.aspose.com/psd/net/aspose.psd.imageoptions/jpegoptions/) třída
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod AI na JPEG" sectionDescription="Podívejte se na naše živé ukázky [Převod AI na JPEG](https://products.aspose.app/psd/conversion/ai-to-jpeg) s následujícími výhodami." >}}
