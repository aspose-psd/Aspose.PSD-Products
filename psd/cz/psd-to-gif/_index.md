---
title: Převést PSD na GIF pomocí C#
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést PSD na GIF přes C#" h2=".NET Photoshop API pro PSD a PSB Konverze na rastrové obrázky včetně GIF" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Vysoce kvalitní vykreslování PSD jako GIF" %}}
1. Načíst PSD pomocí [Image.Načíst](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) metoda
1. Vytvořte instanci grafiky z obrázku. [Možnosti GifOptions](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/gifoptions) třída
