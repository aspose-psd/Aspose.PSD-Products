---
title: .NET a Java Photoshop API | Analyzujte soubory PSD a PSB
weight: 10
description: Knihovna pro čtení, zápis a export souborů PSD a PSB na více platformách. Extrahujte vrstvy a manipulujte s nimi bez nainstalovaného Photoshopu.
url: cz/family/
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1="Rozhraní API pro manipulaci se soubory PSD, PSB a AI" h2=".NET & Java API pro vytváření, úpravu a převod souborů Adobe Photoshop a Adobe Illustrator." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd.svg" pfName="Aspose.PSD" downloadUrl="https://downloads.aspose.com/psd/net" tryOnlineUrl="" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Proč produktová řada Aspose.PSD?" tabId="success-stories" >}}
