...
1. Vytvořte instanci [Možnosti GifOptions](https://reference.aspose.com/psd/net/aspose.psd.imageoptions/gifoptions/) třída
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod AI na GIF" sectionDescription="Podívejte se na naše živé ukázky [Konverze AI na GIF](https://products.aspose.app/psd/conversion/ai-to-gif) s následujícími výhodami." >}}
