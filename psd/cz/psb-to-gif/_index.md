---
title: Převést PSB na GIF pomocí C#
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést PSB na GIF přes C#" h2=".NET Photoshop API pro PSD a PSB Konverze na rastrové obrázky včetně GIF" >}}
...
{{% blocks/products/pf/agp/code-autogen title="Kód .NET C# pro konverzi PSB na GIF" gistPath="" %}}
