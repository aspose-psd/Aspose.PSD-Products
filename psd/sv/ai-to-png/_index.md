...
1. Skapa en instans av [PNGOptions](https://reference.aspose.com/psd/net/aspose.psd.imageoptions/pngoptions/) klass
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera AI till PNG" sectionDescription="Kolla in våra live-demos för [AI till PNG konvertering](https://products.aspose.app/psd/conversion/ai-to-png) med följande fördelar." >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-download" text="Du kommer omedelbart att få nedladdningslänken för resulterande PNG-fil." >}}
