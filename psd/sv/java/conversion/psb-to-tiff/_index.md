...
weight: 40
description: Exempel på Java-konverteringskod för PSB-format till TIFF-fil. Använd den här exempelkoden för att konvertera PSB till TIFF inom alla Java-baserade webb- eller skrivbordsapplikationer.
url: sv/java/conversion/psb-to-tiff/
---
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar PSB till TIFF med Java" %}}

 För att rendera PSB till TIFF kommer vi att använda
...
{{< blocks/products/pf/agp/demobox sectionTitle="PSB till TIFF Conversion Live Demos" sectionDescription="[Konvertera PSB till TIFF](https://products.aspose.app/psd/conversion/psb-to-tiff) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din PSB-fil, den konverteras omedelbart till TIFF." >}}
