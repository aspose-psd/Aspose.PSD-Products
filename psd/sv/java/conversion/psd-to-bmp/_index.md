...
weight: 260
description: Exempel på Java-konverteringskod för PSD-format till BMP-fil. Använd den här exempelkoden för att konvertera PSD till BMP inom alla Java-baserade webb- eller skrivbordsapplikationer.
---
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar PSD till BMP med Java" %}}

 För att rendera PSD till BMP kommer vi att använda
...
{{< blocks/products/pf/agp/demobox sectionTitle="PSD till BMP Conversion Live Demos" sectionDescription="[Konvertera PSD till BMP](https://products.aspose.app/psd/conversion/psd-to-bmp) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din PSD-fil, den kommer omedelbart att konverteras till BMP." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/psd/java/conversion/psd-to-psb/" name="PSD TO PSB" description="Adobe Photoshop-fil" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/psd/java/conversion/psd-to-tiff/" name="PSD TO TIFF" description="Taggat bildformat" >}}
