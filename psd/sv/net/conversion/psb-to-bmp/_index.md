---
title: Konvertera PSB till BMP med C#
...
url: sv/net/conversion/psb-to-bmp/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertera PSB till BMP via C#" h2=".NET Photoshop API för PSD & PSB Konvertering till rasterbilder inklusive BMP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Högkvalitetsrendering av PSB som BMP" %}}
1. Ladda PSB med metoden [Image.Load](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index)
1. Skapa en instans av klassen [BmpOptions](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/bmpoptions)
1. Anropa metoden [Image.Save](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/save/index)
1. Skicka ut filnamn och objekt för BmpOptions
...
{{% blocks/products/pf/agp/code-autogen title=".NET C#-kod för PSB till BMP-konvertering" gistPath="" %}}
