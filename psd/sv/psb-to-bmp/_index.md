...
{{% blocks/products/pf/agp/feature-section-col title="Hög kvalitet Rendering av PSB som BMP" %}}
1. Ladda PSB med [Image.Load](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) metod
1. Skapa en instans av grafik från bilden. [BMPoptions](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/bmpoptions) klass
