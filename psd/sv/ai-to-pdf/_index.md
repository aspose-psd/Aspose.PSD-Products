...
1. Skapa en instans av grafik från bilden. [PDFOptions](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/PdfOptions) klass
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera AI till PDF" sectionDescription="Check our live demos for [AI to PDF conversion](https://products.aspose.app/psd/conversion/ai-to-pdf) with following benefits." >}}
