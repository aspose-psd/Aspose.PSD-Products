---
title: Konvertera PSD till JPEG med C#
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertera PSD till JPEG via C#" h2=".NET Photoshop API för PSD & PSB Konvertering till rasterbilder inklusive JPEG" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Hög kvalitet Rendering av PSD som JPEG" %}}
1. Ladda PSD med [Image.Load](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) metod
1. Skapa en instans av grafik från bilden. [JPEGOptions](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/jpegoptions) klass
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# kod för PSD till JPEG-konvertering" gistPath="" %}}
