---
title: Konvertera PSB till TIFF med C#
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertera PSB till TIFF via C#" h2=".NET Photoshop API för PSD & PSB Konvertering till rasterbilder inklusive TIFF" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Hög kvalitet Rendering av PSB som TIFF" %}}
1. Ladda PSB med [Image.Load](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) metod
1. Skapa en instans av grafik från bilden. [TiffOptions](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/tiffoptions) klass
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# -kod för PSB till TIFF-konvertering" gistPath="" %}}
