...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD API:n avulla kehittäjien on helppo muuntaa PSD-tiedosto PSB-muotoon vain muutamalla koodirivillä.

{{% /blocks/products/pf/agp/text %}}

1. Lataa PSD-tiedosto Image.load-menetelmällä
1. Cast Image-objekti PsdImageen
1. Kutsu PsdImage.save-menetelmä tulostiedostopolulla ja PsdOptions-instase
...
{{% blocks/products/pf/agp/code-block title="Muunna PSD PSB:ksi - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="PSD:stä PSB:ksi muunnettavat live-esittelyt" sectionDescription="[Muunna PSD PSB:ksi](https://products.aspose.app/psd/conversion/psd-to-psb) heti käymällä Live Demos -sivustollamme. Live-demolla on seuraavat edut" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Lataa vain PSD-tiedostosi, se muunnetaan välittömästi PSB:ksi." >}}
