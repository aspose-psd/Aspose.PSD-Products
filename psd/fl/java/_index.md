...
<h2 class="h2title">Viimeisimmät PSD API -ominaisuudet</h2>

<p>Aspose.PSD for .NET API lisää jatkuvasti uusia ominaisuuksia tehdäkseen siitä tehokkaan. Tässä on luettelo muutamasta poiminnasta viimeisimmistä lisätyistä.</p>
...
<li>Tasovektorimaskien ja tekstikerroksen mukautetun FlipRotaten tuki</li>

<li>Viivoustehosteen renderöiminen väritäytteellä vientiä varten</li>
...
<h2 class="h2title">Kuvankäsittelysuodattimien käyttöönotto</h2>

<p>Aspose.PSD for Java tarjoaa keskeiset kuvantamisominaisuudet, kuten värinsäädön, luokkakirjastojensa kautta. Kehittäjät voivat helposti säätää API:n lataaman rasterikuvan kirkkautta, kontrastia tai gammaa. Lisäksi kehittäjät voivat dynaamisesti häivyttää tai sumentaa kuvia sekä käyttää suosittuja suodattimia, kuten Median, Motion Wiener, Gauss Wiener ja Bradley Threshold.</p>
