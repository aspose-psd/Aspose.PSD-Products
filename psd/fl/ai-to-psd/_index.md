---
title: Muunna AI PSD: ksi C#: n kautta
description: Esimerkkikoodi AI PSD C# muuntaminen. Käytä API-esimerkkikoodia erän AI-tiedostoille PSD-muuntamiseen VB.NET-, ASP.net- tai missä tahansa .NET-pohjaisessa sovelluksessa.
url: ai-to-psd/
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD on helppo kehittäjät ladata ja muuntaa AI-tiedostoja PSB vain muutaman rivin koodia.

{{% /blocks/products/pf/agp/text %}}

1. Lataa tekoäly [Kuvan.Load](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) menetelmä
1. Luo kuvasta Grafiikka-ilmentymä. [PSDOptions](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/PsdOptions) luokka
...
{{% blocks/products/pf/agp/code-block title="Tämä näytekoodi näyttää tekoälyn PSD C# -muunnokseen" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ilmainen sovellus muuntaa tekoäly PSD: ksi" sectionDescription="Check our live demos for [AI to PSD conversion](https://products.aspose.app/psd/conversion/ai-to-psd) with following benefits." >}}
