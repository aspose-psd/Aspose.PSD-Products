 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/python-net/text-layer-manipulation/">Tekstikerroksen muokkaus PSD: ssä</a>
    </p>
   </div>
   <div class="col-lg-4">
...
{{< blocks/products/pf/slr-tab tabTitle="Miksi Aspose.PSD Pythonille?" tabId="success-stories" >}}
