---
title: Преобразование PSD в PNG через Java
weight: 80
description: Пример Java-кода преобразования формата PSD в файл PNG. Используйте этот пример кода для преобразования PSD в PNG в любом веб-приложении или приложении для рабочего стола на основе Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Конвертировать PSD в PNG через Java" h2="Java Photoshop API для преобразования PSD в растровые изображения, включая PNG" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="Aspose.PSD" subTitlepfName="для Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSD" >}}
...
{{% blocks/products/pf/agp/content h2="Как конвертировать PSD в PNG с помощью Java" %}}
 ...
 Чтобы преобразовать PSD в PNG, мы будем использовать
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD API позволяет разработчикам легко конвертировать PSD-файл в PNG всего за несколько строк кода.
...
{{% blocks/products/pf/agp/code-block title="Конвертировать PSD в PNG - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Преобразование PSD в PNG в реальном времени" sectionDescription="[Конвертируйте PSD в PNG](https://products.aspose.app/psd/conversion/psd-to-png) прямо сейчас, посетив наш веб-сайт Live Demos.Живое демо имеет следующие преимущества" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Просто загрузите свой PSD-файл, и он будет мгновенно преобразован в PNG." >}}
