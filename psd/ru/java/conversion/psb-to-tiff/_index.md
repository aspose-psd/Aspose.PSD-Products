---
title: Преобразование PSB в TIFF через Java
weight: 40
description: Пример Java-кода преобразования формата PSB в файл TIFF. Используйте этот пример кода для преобразования PSB в TIFF в любом веб-приложении или приложении для рабочего стола на основе Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Конвертировать PSB в TIFF через Java" h2="Java Photoshop API для преобразования PSB в растровые изображения, включая TIFF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="Aspose.PSD" subTitlepfName="для Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSB" >}}
...
{{% blocks/products/pf/agp/content h2="Как конвертировать PSB в TIFF с помощью Java" %}}
 ...
 Чтобы преобразовать PSB в TIFF, мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги по конвертации PSB в TIFF через Java" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD API позволяет разработчикам легко конвертировать файл PSB в TIFF всего за несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

- Загрузите файл PSB
- Создайте экземпляр [класса TiffOptions] (https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/TiffOptions).
...
{{% blocks/products/pf/agp/code-block title="Конвертировать PSB в TIFF - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Прямые демонстрации преобразования PSB в TIFF" sectionDescription="[Конвертируйте PSB в TIFF](https://products.aspose.app/psd/conversion/psb-to-tiff) прямо сейчас, посетив наш веб-сайт Live Demos.Живое демо имеет следующие преимущества" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Просто загрузите файл PSB, и он будет мгновенно преобразован в формат TIFF." >}}
