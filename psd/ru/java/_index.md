---
title: API Java Photoshop | Синтаксический анализ форматов PSD и PSB
weight: 270
description: Создайте модифицировать или конвертировать форматы PSD и PSB, используя эту библиотеку в любом Java приложении без требования программы Photoshop
url: java/
---
...
<p>
 Aspose.PSD для Java — это простой в использовании API управления форматами файлов Adobe Photoshop. Он может легко загружать и читать файлы PSD, PSB и AI, что позволяет разработчикам Java выполнять такие операции, как обновление свойств слоев, добавление водяных знаков, сжатие, поворот, масштабирование или рендеринг одного формата файла в другой без необходимости установки Adobe Photoshop. Форматы изображений, такие как JPEG, TIFF, GIF, PNG, BMP, JPEG2000, могут быть легко открыты и добавлены в виде слоя всего за несколько строк кода. Файлы PSD, PSB и AI можно экспортировать в указанный формат и дополнительно в формат PDF
</p>
...
<div class="diagram1 d1-java">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt=«API обработки Java PSD» src="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" />
  <header>
   Aspose.PSD
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Независимость платформы" description="API поддерживает настольные, веб- и консольные приложения на таких платформах, как Windows, Linux/Unix, MacOS, где доступно Java»." >}}
<div class="diagram1 d1-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Расширенные возможности Java-API Photoshop
   </h2>
   <p>
    &amp;nbsp
   </p>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/java/creating-opening-and-saving-images/#opening-image-files">Загрузка существующих файлов Photoshop</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/java/cropping-psd-file-while-converting-to-png/">Прикрепите к прямоугольной области</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/java/drawing-images/">Рисуйте и заполняйте базовые фигуры</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/java/crop-rotate-and-resize-images/">Обрезайте, поворачивайте и изменяйте размер изображений</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/java/manipulating-photoshop-formats/#support-flatten-layers">Сглаживание слоев</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/java/converting-psd-image-to-raster-format/">Возможность экспорта предварительного просмотра PSD-файла</a>
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-pencil-square-o ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/java/export-layer-group-to-image/">Создание и экспорт группы слоев</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/java/color-space-conversion-for-jpeg-through-icc-profiles/">Открывайте и экспортируйте PSD-файлы в некоторой комбинации режимов RGB, CMYK, LAB, Grayscale с 8/16/32 битами на канал.</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/java/manipulating-photoshop-formats/#support-layer-effects-for-psd">Поддержка наиболее часто используемых эффектов слоев</a>
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-clone ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/java/support-of-fill-layers/#stroke-effect-with-color-fill">Эффект удара снаружи, внутри и по центру</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/java/support-of-fill-layers/">Эффект слоя цвет/узора/градиента</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/java/layer-types/adjustment-layer/">Настраивающие слои, такие как яркость/контрастность, кривые, цветовой оттенок и насыщенность, фотофильтр и многое другое</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/java/apply-masking/">Поддержка векторных, растровых, режущих масок и их комбинаций</a>
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-eye-slash ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/java/supported-resources/">Поддержка большого количества ресурсов слоев</a>
    </p>
   </div>
   <div class="col-lg-4">
...
<li>Rendering of Stroke effect with Color Fill for export</li>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Конвертируйте PSD-файлы в растровые изображения
    </h2>
    <p>
     Библиотека Aspose.PSD для Java поддерживает преобразование файлов PSD в любое из поддерживаемых растровых изображений с помощью всего нескольких строк кода.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Преобразование PSD в формат BMP, GIF и JPEG - Java
     </h3>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     С легкостью манипулируйте слоями Photoshop
    </h2>
    <p>
     Манипуляции со слоями PSD, такие как слияние слоев, обновление текста на слоях, настройка эффектов или экспорт слоя в виде изображения, — вот лишь некоторые из функций манипуляций, которые предоставляет API. Кроме того, он может обнаруживать сплющенные документы PSD, а также создавать миниатюры.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Обрезайте, поворачивайте и изменяйте размер изображений в любом месте
    </h2>
    <p>
     Любая функция управления изображениями, такая как перелистывание, обрезка, поворот и изменение размера изображений, может быть реализована всего несколькими строками кода, например, приведенный ниже фрагмент поворачивает изображение.
    </p>
    <div class="codeblock" id="code">
     <h3>
    ...
    <p>
     Кроме того, API предоставляет различные фильтры обработки изображений, такие как регулировка контрастности, яркости или гаммы на растровых изображениях, сглаживание или размытие изображений, а также самые известные фильтры, включая фильтры Гаусса Винера, Медиана, Порог Брэдли и Motion Wiener.
    </p>
   </div>
   <!--<div class="col-lg-12">
...
{{< blocks/products/pf/slr-element name="Примечания к релизу" href="https://docs.aspose.com/psd/java/release-notes/" >}}
{{< /blocks/products/pf/slr-tab >}}
