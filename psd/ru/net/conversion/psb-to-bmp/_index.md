---
title: Преобразование PSB в BMP с помощью C#
...
url: ru/net/conversion/psb-to-bmp/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Конвертировать PSB в BMP через C#" h2=".NET Photoshop API для преобразования PSD и PSB в растровые изображения, включая BMP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Высококачественный рендеринг PSB в виде BMP" %}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# код для преобразования PSB в BMP" gistPath="" %}}
