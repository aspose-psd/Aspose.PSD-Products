...
{{% blocks/products/pf/agp/feature-section-col title="Шаги по преобразованию AI в PDF с помощью C#" %}}
...
1. Создайте экземпляр [Опции PDF](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/PdfOptions) учебный класс
...
{{< blocks/products/pf/agp/demobox sectionTitle="Бесплатное приложение для конвертации AI в PDF" sectionDescription="Посмотрите наши живые демоверсии для [Конвертирование AI в PDF](https://products.aspose.app/psd/conversion/ai-to-pdf) со следующими преимуществами»." >}}
