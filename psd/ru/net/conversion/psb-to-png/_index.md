---
title: Преобразование PSB в PNG с помощью C#
...
url: ru/net/conversion/psb-to-png/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Конвертировать PSB в PNG с помощью C#" h2=".NET Photoshop API для преобразования PSD и PSB в растровые изображения, включая PNG">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Высококачественный рендеринг PSB в формате PNG" %}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# код для преобразования PSB в PNG" gistPath="" %}}
