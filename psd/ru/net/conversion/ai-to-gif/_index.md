...
1. Загрузите ИИ с помощью [Изображение. Загрузить](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) метод [Варианты GIF](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/GifOptions) учебный класс
1. Позвонить
