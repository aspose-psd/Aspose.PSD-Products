...
1. Создайте экземпляр [Опции PSD](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/PsdOptions) учебный класс
...
{{< blocks/products/pf/agp/demobox sectionTitle="Бесплатное приложение для конвертации AI в PSD" sectionDescription="Посмотрите наши живые демоверсии для [Преобразование AI в PSD](https://products.aspose.app/psd/conversion/ai-to-psd) со следующими преимуществами»." >}}
