...
1. Создайте экземпляр [Варианты GIF](https://reference.aspose.com/psd/net/aspose.psd.imageoptions/gifoptions/) учебный класс
...
{{< blocks/products/pf/agp/demobox sectionTitle="Бесплатное приложение для конвертации AI в GIF" sectionDescription="Посмотрите наши живые демоверсии для [Преобразование AI в GIF](https://products.aspose.app/psd/conversion/ai-to-gif) со следующими преимуществами»." >}}
