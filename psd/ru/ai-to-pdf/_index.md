---
title: Конвертируйте AI в PDF с помощью C#
description: Пример кода для преобразования AI в PDF C#. Используйте пример кода API для пакетного преобразования файлов AI в PDF в VB.NET, ASP.Net или любом приложении на базе .NET.
url: ai-to-pdf/
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD позволяет разработчикам легко загружать и конвертировать файлы AI в PDF всего за несколько строк кода.
...
1. Создайте экземпляр графики из изображения. [Опции PDF](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/PdfOptions) учебный класс
...
{{< blocks/products/pf/agp/demobox sectionTitle="Бесплатное приложение для конвертации AI в PDF" sectionDescription="Check our live demos for [AI to PDF conversion](https://products.aspose.app/psd/conversion/ai-to-pdf) with following benefits." >}}
