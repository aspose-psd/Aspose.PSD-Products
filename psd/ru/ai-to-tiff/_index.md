---
title: Конвертируйте AI в TIFF с помощью C#
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD позволяет разработчикам легко загружать и конвертировать файлы AI в TIFF всего за несколько строк кода.
