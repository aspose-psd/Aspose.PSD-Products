...
description: Sample Java conversion code for AI format to GIF file. Use this example code to convert AI to GIF within any Web or Desktop Java based application.
---
...
- Load input AI image
- Initialize [GifOptions](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/gifOptions) class object
- Specify image properties
- Save output GIF image
