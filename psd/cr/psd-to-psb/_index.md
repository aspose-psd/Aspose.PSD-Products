...
weight: 210
description: Uzorak koda za pretvorbu PSD u PSB C#. Upotrijebite API primjer koda za batch PSD datoteke u PSB pretvorbu unutar VB.NET, ASP.Net ili bilo koje .NET aplikacije.
url: psd-to-psb/
---
...
{{% blocks/products/pf/agp/content h2="Kako pretvoriti PSD u PSB koristeći Java" %}}
 ...
 Da bismo pretvorili PSD u PSB, koristit ćemo
...
1. Nazovite metodu Image.Save s izlaznom putanjom datoteke i instancom PSDoptions
...
{{% blocks/products/pf/agp/code-block title="Ovaj uzorak koda prikazuje PSD u PSB C# pretvorbu" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Besplatna aplikacija za pretvaranje PSD-a u PSB" sectionDescription="Check our live demos for [PSD to PSB conversion](https://products.aspose.app/psd/conversion/psd-to-psb) with following benefits." >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-download" text="Odmah ćete dobiti vezu za preuzimanje za rezultirajuću PSB datoteku." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="net/conversion/psd-to-gif/" name="PSD U GIF" description="GIF" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="net/conversion/psd-to-jpeg/" name="PSD U JPEG" description="JPEG" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="net/conversion/psd-to-pdf/" name="PSD U PDF" description="PDF" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="net/conversion/psd-to-png/" name="PSD U PNG" description="PNG" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="net/conversion/psd-to-psb/" name="PSD U PSB" description="PSB" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="net/conversion/psd-to-tiff/" name="PSD NA TIFF" description="TIFF" >}}
