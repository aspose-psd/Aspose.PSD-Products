...
Da bismo pretvorili PSB u JPEG2000, koristit ćemo <a href="/psd/{{< lang-code >}}net">Aspose.PSD za .NET</a> API koji je značajka-bogata, moćan i jednostavan za korištenje pretvorbe API za Java platformu. Njegovu najnoviju verziju možete preuzeti izravno s <a href="https://www.nuget.org/packages/aspose.psd">NuGet</a> upravitelj paketa, traži <b>Aspose.PSD</b> i instalirati. Također možete upotrijebiti sljedeću naredbu iz konzole Package Manager.
