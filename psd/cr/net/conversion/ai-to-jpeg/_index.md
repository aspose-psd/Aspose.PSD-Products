...
description: Primjer koda za pretvorbu AI u JPEG C#. Koristite API primjer koda za skupnu pretvorbu AI datoteka u JPEG unutar VB.NET, Asp.NET ili bilo koje .NET aplikacije.
url: cr/net/conversion/ai-to-jpeg/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Pretvorite AI u JPEG putem C#" h2="" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="Aspose.PSD" subTitlepfName="za .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PSD" fileiconsmall4="XML" fileiconsmall5="AI" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD programerima olakšava učitavanje i pretvaranje AI datoteka u JPEG u samo nekoliko redaka koda.
...
{{% blocks/products/pf/agp/code-block title="Ovaj primjer koda prikazuje pretvorbu AI u JPEG C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Besplatna aplikacija za pretvaranje AI u JPEG" sectionDescription="Provjerite naše demonstracije uživo za [AI to JPEG konverziju](https://products.aspose.app/psd/conversion/ai-to-jpeg) sa sljedećim pogodnostima." >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-download" text=" Odmah ćete dobiti vezu za preuzimanje rezultirajuće JPEG datoteke." >}}
