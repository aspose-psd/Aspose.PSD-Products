...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Pretvori PSD u PNG putem C#" h2=".NET Photoshop API za PSD i PSB pretvorbe u rasterske slike, uključujući PNG" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Kvalitetno prikazivanje PSD-a kao PNG" %}}
1. Učitajte PSD s [Image.Opterećenje](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) metoda
1. Stvorite instancu grafike sa slike. [PNGOpcije](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/pngoptions) klasa
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# kod za PSD u PNG pretvorbe" gistPath="" %}}
