---
title: Convert PSB to JPEG via C# 
weight: 250
url: /net/conversion/psb-to-jpeg/ 
description: Sample code for PSB to JPEG C# conversion. Use API example code for batch PSB files to JPEG conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert PSB to JPEG Using C#" %}}
 ...
 In order to convert PSB to JPEG, we’ll use
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PSB to JPEG C# Conversion" offSpacer="" %}}
