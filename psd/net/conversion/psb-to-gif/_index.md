---
title: Convert PSB to GIF via C# 
weight: 120
url: /net/conversion/psb-to-gif/ 
description: Sample code for PSB to GIF C# conversion. Use API example code for batch PSB files to GIF conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PSB to GIF via C#" h2="" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="Aspose.PSD" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSB" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert PSB to GIF Using C#" %}}
 ...
 In order to convert PSB to GIF, we’ll use
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PSB to GIF C# Conversion" offSpacer="" %}}
