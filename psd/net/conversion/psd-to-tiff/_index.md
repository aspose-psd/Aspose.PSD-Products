---
title: Convert PSD to TIFF via .NET 
weight: 310
...
{{< blocks/products/pf/upper-banner h1="Convert PSD to TIFF via C#" h2="" logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/psd/272x272/aspose_psd-for-net.png" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="Aspose.PSD" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSD" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert PSD to TIFF Using C#" %}}
 ...
 In order to convert PSD to TIFF, weвЂ™ll use
