---
title: Convert PSD to GIF via C# 
weight: 50
url: /net/conversion/psd-to-gif/ 
description: Sample code for PSD to GIF C# conversion. Use API example code for batch PSD files to GIF conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PSD to GIF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD makes it easy for the developers to load & convert PSD files to GIF in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows PSD to GIF C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert PSD to GIF" sectionDescription="Check our live demos for [PSD to GIF conversion](https://products.aspose.app/psd/conversion/psd-to-gif) with following benefits." >}}
