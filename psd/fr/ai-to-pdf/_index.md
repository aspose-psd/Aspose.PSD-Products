...
1. Créez une instance de Graphics à partir de l'image. [Options PDF](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/PdfOptions) classe
