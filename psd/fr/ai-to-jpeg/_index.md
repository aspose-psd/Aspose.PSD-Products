...
1. Créez une instance de [Options JPEG](https://reference.aspose.com/psd/net/aspose.psd.imageoptions/jpegoptions/) classe
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir AI en JPEG" sectionDescription="Consultez nos démos en direct pour [Conversion AI en JPEG](https://products.aspose.app/psd/conversion/ai-to-jpeg) avec les avantages suivants." >}}
