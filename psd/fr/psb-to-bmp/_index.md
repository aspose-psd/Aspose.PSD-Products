---
title: Convertir PSB en BMP avec C#
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PSB en BMP via C#" h2="API .NET Photoshop pour la conversion de PSD et PSB en images matricielles, y compris BMP" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Rendu de haute qualité du PSB en tant que BMP" %}}
1. Chargez le PSB avec [Image. Charger](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) méthode
1. Créez une instance de Graphics à partir de l'image. [Options BMP](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/bmpoptions) classe
...
{{% blocks/products/pf/agp/code-autogen title="Code .NET C# pour la conversion PSB en BMP" gistPath="" %}}
