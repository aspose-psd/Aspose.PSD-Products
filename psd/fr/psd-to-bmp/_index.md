---
title: Convertir PSD en BMP avec C#
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PSD en BMP via C#" h2="API .NET Photoshop pour la conversion de PSD et PSB en images matricielles, y compris BMP" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Rendu de haute qualité du PSD en BMP" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Code .NET C# pour la conversion de PSD en BMP" gistPath="" %}}
