...
1. Créez une instance de [Options GIF](https://reference.aspose.com/psd/net/aspose.psd.imageoptions/gifoptions/) classe
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir AI en GIF" sectionDescription="Consultez nos démos en direct pour [Conversion AI en GIF](https://products.aspose.app/psd/conversion/ai-to-gif) avec les avantages suivants." >}}
