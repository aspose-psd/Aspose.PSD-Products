---
title: Convertir PSB en PNG avec C#
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PSB en PNG via C#" h2="API .NET Photoshop pour la conversion des fichiers PSD et PSB en images matricielles, y compris les fichiers PNG" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Rendu de haute qualité de PSB au format PNG" %}}
1. Chargez le PSB avec [Image. Charger](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) méthode
1. Créez une instance de Graphics à partir de l'image. [Options PNG](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/pngoptions) classe
...
{{% blocks/products/pf/agp/code-autogen title="Code .NET C# pour la conversion PSB en PNG" gistPath="" %}}
