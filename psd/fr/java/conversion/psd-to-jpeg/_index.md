...
weight: 20
description: Exemple de code de conversion Java pour le format PSD en fichier JPEG. Utilisez cet exemple de code pour convertir PSD en JPEG dans n'importe quelle application Java Web ou de bureau.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir PSD en JPEG via Java" h2="API Java Photoshop pour la conversion PSD en images raster, y compris JPEG" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="Asposer.PSD" subTitlepfName="pour Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSD" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir PSD en JPEG à l'aide de Java" %}}

 Afin de rendre PSD en JPEG, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir PSD en JPEG via Java" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démos en direct sur la conversion PSD en JPEG" sectionDescription="[Convert PSD to JPEG](https://products.aspose.app/psd/conversion/psd-to-jpeg) dès maintenant en visitant notre site Web Live Demos. La démo en direct présente les avantages suivants" >}}
