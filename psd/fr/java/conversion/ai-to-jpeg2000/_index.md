...
description: Exemple de code de conversion Java pour le format AI en fichier JPEG2000. Utilisez cet exemple de code pour convertir AI en JPEG2000 dans n'importe quelle application Java Web ou de bureau.
url: fr/java/conversion/ai-to-jpeg2000/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir AI en JPEG2000 via Java" h2="Bibliothèque Java native pour lire, écrire et exporter l'IA vers JPEG2000 sans avoir besoin d'Adobe." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG2000" pfName="Asposer.PSD" subTitlepfName="pour Java" downloadUrl="" fileiconsmall1="JPEG2000" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AI" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir AI en JPEG2000 via Java" %}}
...
- Initialiser l'objet de classe [Jpeg2000Options](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/jpeg2000Options)
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de conversion AI vers JPEG2000" sectionDescription="[Convert AI to JPEG2000](https://products.aspose.app/psd/conversion/ai-to-jpeg2000) dès maintenant en visitant notre site Web Live Demos. La démo en direct présente les avantages suivants" >}}
