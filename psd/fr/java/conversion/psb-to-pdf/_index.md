...
weight: 190
description: Exemple de code de conversion Java pour le format PSB en fichier PDF. Utilisez cet exemple de code pour convertir un PSB en PDF dans n'importe quelle application Web ou de bureau basée sur Java.
url: java/conversion/psb-to-pdf/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/upper-banner h1="Convertir PSB en PDF via Java" h2="API Java Photoshop pour la conversion de PSB en PDF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="Aspose.PSD" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSB" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir un PSB en PDF à l'aide de Java" %}}
 ...
 Afin de convertir PSB en PDF, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 L'API Aspose.PSD permet aux développeurs de convertir facilement un fichier PSB en PDF en quelques lignes de code.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de conversion PSB en PDF" sectionDescription="[Convertir PSB en PDF](https://products.aspose.app/psd/conversion/psb-to-pdf) dès maintenant en visitant notre site Web de démos en direct. La démo en direct présente les avantages suivants" >}}
