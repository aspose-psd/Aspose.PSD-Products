...
weight: 170
description: Exemple de code de conversion Java pour le format PSD en fichier TIFF. Utilisez cet exemple de code pour convertir un PSD en TIFF dans n'importe quelle application Java Web ou de bureau.
url: java/conversion/psd-to-tiff/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/upper-banner h1="Convertir PSD en TIFF via Java" h2="API Java Photoshop pour la conversion PSD en images matricielles, y compris le TIFF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="Aspose.PSD" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSD" >}}

{{< blocks/products/pf/main-container pfName="Aspose.PSD " subTitlepfName="for Java" >}}
{{< blocks/products/pf/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-psd" liveDemosLink="https://products.aspose.app/psd/family" docsLink="https://docs.aspose.com/psd/java" installationsDocsLink="https://docs.aspose.com/psd/java" nugetLink="" nugetPackageName="" downloadAsLink="https://releases.aspose.com/psd/java" learnAsLink="https://docs.aspose.com/psd/java" apiReference="" mavenRepoLink="https://repository.aspose.com/psd/" >}}

{{% blocks/products/pf/agp/content h2="Comment convertir un PSD en TIFF à l'aide de Java" %}}

 Afin de convertir PSD en TIFF, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir un PSD en TIFF via Java" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de conversion PSD en TIFF" sectionDescription="[Convertir PSD en TIFF](https://products.aspose.app/psd/conversion/psd-to-tiff) dès maintenant en visitant notre site Web de démos en direct. La démo en direct présente les avantages suivants" >}}
