...
- Initialiser [Options JPEG](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/jpegOptions) objet de classe
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de conversion AI en JPEG" sectionDescription="[Convertir AI en JPEG](https://products.aspose.app/psd/conversion/ai-to-jpeg) dès maintenant en visitant notre site Web de démos en direct. La démo en direct présente les avantages suivants" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text="Pas besoin de télécharger l’API Aspose." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text="Pas besoin d'écrire de code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Il suffit de télécharger votre fichier AI, il sera converti instantanément en JPEG." >}}
