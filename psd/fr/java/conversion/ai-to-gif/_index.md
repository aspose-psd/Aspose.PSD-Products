...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir AI en GIF via Java" %}}
...
- Initialiser [Options GIF](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/gifOptions) objet de classe
...
{{% blocks/products/pf/agp/code-block title="Convertir AI en GIF - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de conversion de l'IA en GIF" sectionDescription="[Convertir AI en GIF](https://products.aspose.app/psd/conversion/ai-to-gif) dès maintenant en visitant notre site Web de démos en direct. La démo en direct présente les avantages suivants" >}}
