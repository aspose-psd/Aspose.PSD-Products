---
title: Convertir PSD en PNG avec C#
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PSD en PNG via C#" h2="API .NET Photoshop pour la conversion des fichiers PSD et PSB en images matricielles, y compris les fichiers PNG" >}}
...
{{% blocks/products/pf/agp/code-autogen title="Code .NET C# pour la conversion de PSD en PNG" gistPath="" %}}
