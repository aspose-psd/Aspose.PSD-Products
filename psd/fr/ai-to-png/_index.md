...
1. Créez une instance de [Options PNG](https://reference.aspose.com/psd/net/aspose.psd.imageoptions/pngoptions/) classe
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir AI en PNG" sectionDescription="Consultez nos démos en direct pour [Conversion AI en PNG](https://products.aspose.app/psd/conversion/ai-to-png) avec les avantages suivants." >}}
