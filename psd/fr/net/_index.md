 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/working-with-text-layers/#update-text-layer-in-psd-file">Mise à jour des calques de texte au moment de l'exécution</a>
    </p>
   </div>
   <div class="col-lg-4">
...
<li>Rasterisation des masques vectoriels de calque et FlipRotate personnalisé du calque de texte</li>
