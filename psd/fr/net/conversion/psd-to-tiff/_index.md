---
title: Convertir PSD en TIFF avec C#
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PSD en TIFF via C#" h2="API .NET Photoshop pour la conversion des fichiers PSD et PSB en images matricielles, y compris le format TIFF" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Rendu de haute qualité du PSD au format TIFF" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Code .NET C# pour la conversion de PSD en TIFF" gistPath="" %}}
