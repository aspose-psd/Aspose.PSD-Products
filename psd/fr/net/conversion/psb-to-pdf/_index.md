...
weight: 340
description: Exemple de code pour la conversion PSB en PDF C#. Utilisez le code d'exemple d'API pour la conversion de fichiers PSB par lots en PDF dans VB.NET, Asp.NET ou toute autre application basée sur .NET.
url: fr/net/conversion/psb-to-pdf/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir PSB en PDF via C#" h2="" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="Asposer.PSD" subTitlepfName="pour .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSB" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir un PSB en PDF à l'aide de C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir PSB en PDF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD permet aux développeurs de charger et de convertir facilement des fichiers PSB en PDF en quelques lignes de code seulement.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir PSB en PDF" sectionDescription="Consultez nos démos en direct pour la [conversion PSB en PDF](https://products.aspose.app/psd/conversion/psb-to-pdf) avec les avantages suivants." >}}
