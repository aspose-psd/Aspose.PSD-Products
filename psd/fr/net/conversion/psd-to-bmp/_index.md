...
url: fr/net/conversion/psd-to-bmp/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PSD en BMP via C#" h2=".NET API Photoshop pour PSD et PSB Conversion en images raster, y compris BMP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Rendu de haute qualité de PSD en BMP" %}}
1. Chargez le PSD avec la méthode [Image.Load](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index)
1. Créez une instance de la classe [BmpOptions](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/bmpoptions)
...
{{% blocks/products/pf/agp/code-autogen title=".NET Code C# pour la conversion PSD en BMP" gistPath="" %}}
