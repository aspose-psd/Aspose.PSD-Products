...
1. Créez une instance de [Options PDF](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/PdfOptions) classe
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir AI en PDF" sectionDescription="Consultez nos démos en direct pour [Conversion AI en PDF](https://products.aspose.app/psd/conversion/ai-to-pdf) avec les avantages suivants." >}}
