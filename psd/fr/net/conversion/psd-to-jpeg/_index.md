...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir PSD en JPEG via C#" h2="API .NET Photoshop pour la conversion de PSD et PSB en images matricielles, y compris JPEG" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Rendu de haute qualité du PSD au format JPEG" %}}
1. Chargez le PSD avec [Image. Charger](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) méthode
 [Options JPEG](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/jpegoptions) classe
...
{{% blocks/products/pf/agp/code-autogen title="Code .NET C# pour la conversion de PSD en JPEG" gistPath="" %}}
