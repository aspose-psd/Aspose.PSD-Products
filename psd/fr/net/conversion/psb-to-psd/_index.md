...
weight: 240
description: Exemple de code pour la conversion PSB en PSD C#. Utilisez le code d'exemple d'API pour la conversion de fichiers PSB par lots en PSD dans VB.NET, Asp.NET ou toute autre application basée sur .NET.
url: fr/net/conversion/psb-to-psd/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir PSB en PSD via C#" h2="" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PSD" pfName="Asposer.PSD" subTitlepfName="pour .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSB" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir PSB en PSD à l'aide de C#" %}}

 Afin de convertir PSB en PSD, nous utiliserons
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion PSB en PSD C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir PSB en PSD" sectionDescription="Consultez nos démos en direct pour [la conversion PSB en PSD](https://products.aspose.app/psd/conversion/psb-to-psd) avec les avantages suivants." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Pas besoin de télécharger ou de configurer quoi que ce soit." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Pas besoin d'écrire de code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez simplement votre fichier PSB et appuyez sur le \"Convert\" button." >}}
        {{< blocks/products/pf/agp/democard icon="fa-download" text=" Vous obtiendrez instantanément le lien de téléchargement du fichier PSD résultant." >}}
