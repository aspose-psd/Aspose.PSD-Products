...
{{% blocks/products/pf/agp/content h2="Comment afficher un fichier PSD à l'aide de C#" %}}

 Pour afficher le fichier PSD, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour afficher PSD via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Code C# pour afficher PSD" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.PSD est une API de manipulation de format Photoshop. On peut générer, modifier et convertir des documents Adobe Photoshop et Illustrator. De plus, les utilisateurs finaux peuvent effectuer des opérations graphiques, mettre à jour les propriétés des calques, ajouter des filigranes ou rendre un format au format PNG, GIF, BMP, TIFF, JPEG, JPEG2000, PSD, PSB, etc. C'est une API autonome et ne nécessite pas l'installation d'Adobe Photoshop.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour afficher PSD" sectionDescription="Consultez nos démos en direct pour [Afficher PSD](https://products.aspose.app/psd/viewer/psd) avec les avantages suivants." >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Pas besoin de télécharger ou de configurer quoi que ce soit" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Pas besoin d'écrire ou de compiler du code" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez simplement le fichier PSD et appuyez sur le \"View\" button" >}}
