---
title: Python PSD, PSB, AI Manipulation API - Aspose
weight: 90
description: Python Photoshop File Format library to create edit and convert PSD, PSB and AI formats
url: python-net/
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1="Python APIs to Manipulate Photoshop Files" h2="Create, Read, Edit and Convert PSD, PSB & AI files without any Adobe Photoshop or Adobe Illustrator dependencies." logoImageSrc="https://products.aspose.com/psd/images/aspose_psd-for-python-via-net.svg" pfName="Aspose.PSD" subTitlepfName="for Python via .NET" downloadUrl="https://releases.aspose.com/psd/python-net" >}}
...
{{< blocks/products/pf/carousel-item h3="Platform Independence" description="Aspose.PSD for Python via .NET supports any OS including Windows, Linux, MacOS and MacOS-arm" >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
  ...
  <div class="d1-col d1-right">
   ...
   <ul>
    ...
    <li>
     OS-dependant application with UI
    </li>
    <li>
     Console applications and utils
    </li>	
   </ul>
  </div>
 </div>
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="PSD Manipulation APIs" src="https://products.aspose.com/psd/images/aspose_psd-for-python-via-net.svg" />
  <header>
   Aspose.PSD
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Supported File Formats" description="Aspose.PSD for Python via .NET supports most popular [Photoshop & raster image](https://docs.aspose.com/psd/net/supported-file-formats/)  file formats." >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/python-net/create-psd-psb-images-from-scratch/">Create PSD and PSB images from scratch</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/python-net/open-export-psd-psb-ai-images-to-pdf-jpeg-png-tiff-bmp-gif-bmp/">Open and Export of PSD, PSB and AI images to PDF, JPEG, PNG, TIFF, BMP, GIF, BMP</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="/psd/python-net/ai-file-manipulation/">Aspose.PSD Team actively work on manipulation with AI files</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="/psd/python-net/update-psd-psb-files-with-python/">Update PSD and PSB images</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="/psd/python-net/add-layer-from-file-for-editing/">Adding of JPEG, PNG, TIFF, BMP, GIF, BMP files as a layers for editing</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/python-net/layer-manipulation/">Regular layer manipulation</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/python-net/text-layer-manipulation/">Edit of Text Layer in PSD</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/python-net/replace-smart-object">Replace Smart Object</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="(https://docs.aspose.com/psd/python-net/group-layer/">Support of Group Layers</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/python-net/adjustment-layer-enhancement/">Enhancement with Adjustment Layers</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/python-net/psd-shape-layer-manipulation/">Shape Layer Manipulation</a>
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-clone ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/python-net/blending-options/">Blending Options</a>
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-pencil-square-o ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/python-net/layer-effects/">Layer Effects</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/python-net/update-create-layer-mask/">Raster, Vector and Clipping Masks</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/python-net/warp-transform/">Warp Transformations</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/python-net/smart-filters/">Smart Filters</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/python-net/graphics-api/">Draw lines, circles, ellipses, texts, complex paths, and images using the classes Graphics</a>
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-repeat ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/python-net/pixel-data-manipulation/">Process images (including per-pixel modifications)</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/python-net/bit-depth-color-mode-convert/">Convert PSD and PSB Files  between different Color Modes and Bit Depths</a>
    </p>
   </div>   
...
{{< blocks/products/pf/slr-element name="API References" href="https://apireference.aspose.com/python-net/psd" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Why Aspose.PSD for Python?" tabId="success-stories" >}}
