...
{{< blocks/products/pf/upper-banner h1=" .NET API 來操作 Photoshop 文件" h2=" 無需任何 Adob​​e Photoshop 依賴即可創建、讀取、編輯和轉換 PSD 和 PSB 文件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/headers/aspose_psd-for-net.svg" pfName=" Aspose.PSD" subTitlepfName=" 用於 .NET" downloadUrl="https://downloads.aspose.com/psd/net" >}}

{{< blocks/products/pf/main-container pfName=" Aspose.PSD" subTitlepfName=" 用於 .NET" >}}
...
<p> Aspose.PSD for .NET 是一個高級 PSD 和入門級 AI 文件格式操作 API，沒有任何 Adob​​e Photoshop 或 Adob​​e Illustrator 依賴項。 API 允許創建和編輯 Photoshop 文件以及提供更新圖層屬性、添加水印、執行圖形操作或將一種文件格式轉換為另一種文件格式的能力。</p>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/drawing-images/"> 抽獎 &amp;填充基本形狀</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/manipulating-adobe-photoshop-formats/#support-layer-effects-at-runtime"> 應用圖層效果</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/working-with-text-layers/#update-text-layer-in-psd-file"> 在運行時更新文本層</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/manipulating-adobe-photoshop-formats/#support-of-adjustment-layers"> 支持調整層</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/modifying-images/#color-balance-adjustment-layer">色彩平衡調整層</a>
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-repeat ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/manipulating-adobe-photoshop-formats/#manage-exposure-layers"> 曝光調整層</a>
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/manipulating-adobe-photoshop-formats/#manager-photo-filter-adjustment-layer"> 照片濾鏡調整層</a>
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-scissors ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/manipulating-adobe-photoshop-formats/#support-of-clipping-mask"> 渲染剪貼蒙版</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/editing-raster-layer-masks-in-psd-file-via-api/"> 編輯光柵層蒙版</a>
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-clone ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/manipulating-adobe-photoshop-formats/#manage-opacity-of-layers"> 管理圖層的不透明度和展平圖層</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/list-of-psd-layer-resources/"> 支持大量層資源</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/list-of-the-supported-psd-global-image-resources/"> 支持大量圖像部分資源</a>
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-pencil-square-o ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/manipulating-adobe-illustrator-formats/"> 能夠打開和導出 AI 文件</a>
    </p>
   </div>
   <!--<div class="col-lg-12">

<h2 class="h2title"> 最新的 PSD API 功能</h2>

<p> Aspose.PSD for .NET API 不斷添加更多功能使其更強大。以下是最新添加的一些精選列表。</p>

<ul>

<li> 支持填充層。圖案、顏色和漸變填充</li>

<li> 支持 GdFlResource、VmskResource、PtFlResource 和 VsmsResource</li>

<li> 將JPEG/PNG/etc圖像文件加載到PsdImage而不直接加載</li>

<li> 圖層矢量蒙版和文本圖層自定義翻轉旋轉的光柵化</li>

<li> 使用顏色填充渲染描邊效果以進行導出</li>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.PSD for .NET 不僅支持加載 PSD &amp;用於操作的 PSB 文件格式轉換，但它還提供了創建 PSD 和PSB 文件從頭開始。 .NET 開發人員可以使用 API 來自動化可能對他們有所幫助的場景。
    </p>
    <div class="codeblock" id="code">
     <h3>
      從頭開始創建 PSD - C#
