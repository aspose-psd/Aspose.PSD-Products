---
title: C# .NET API управления Photoshop — Aspose
weight: 90
url: /ru/net/ 
...
<p>
 ...
 вместе с экспортом в PDF с возможностью выбора текста. Aspose.PSD частично поддерживает такие функции Adobe Photoshop, как корректирующие слои, рендеринг и редактирование текстового слоя, слои-заливки, эффекты слоев, редактирование растровых и векторных масок для слоев.
</p>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/drawing-images/"> Draw &amp; заполнить основные формы</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/crop-rotate-and-resize-images/"> Обрезать, повернуть и повернуть изменить размер изображений</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/converting-psd-image-to-raster-format/"> Предварительный просмотр PSD-файла Экспорт в режиме Pixel-Perfect</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Черный и усилитель; Белый корректирующий слой
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/manipulating-adobe-photoshop-formats/#manager-photo-filter-adjustment-layer"> корректирующий слой фотофильтра</a>
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-scissors ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/manipulating-adobe-photoshop-formats/#manage-opacity-of-layers"> Управление непрозрачностью слоев &amp; Свести слои</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/list-of-the-supported-psd-global-image-resources/"> Поддержка большого количества ресурсов разделов изображений</a>
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-pencil-square-o ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/manipulating-adobe-illustrator-formats/"> Возможность открывать и экспортировать AI-файлы.</a>
    </p>
   </div>
   <!--<div class="col-lg-12">

<h2 class="h2title"> Последние возможности PSD API</h2>

<p> Aspose.PSD для .NET API постоянно добавляет новые функции, чтобы сделать его более мощным. Вот список нескольких вариантов из последних добавленных.</p>

<ul>

<li> Поддержка слоев заливки. Узор, цвет и градиентная заливка</li>

<li> Поддержка GdFlResource, VmskResource, PtFlResource и VsmsResource</li>

<li> Загружать файлы изображений JPEG/PNG/и т. д. в PsdImage без прямой загрузки</li>

<li> Растеризация векторных масок слоя и пользовательского FlipRotate текстового слоя</li>

<li> Визуализация эффекта обводки с цветовой заливкой для экспорта</li>
   ...
   <div class="col-lg-12">
    ...
    <div class="codeblock" id="code">
     <h3>
      Преобразование PSD в PNG, JPEG и amp; ТИФФ — С#
     </h3>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.PSD для .NET не только поддерживает загрузку PSD &amp; Форматы файлов PSB для манипуляций &amp; преобразование, но также предоставляет возможность создавать PSD &amp; Файлы PSB с нуля. Разработчики .NET могут использовать API для автоматизации сценариев, которые могут им помочь.
    </p>
    <div class="codeblock" id="code">
     <h3>
