...
<p>
 ...
 sekä vienti PDF-muotoon valittavalla tekstillä. Aspose.PSD tukee osittain sellaisia ​​Adobe Photoshop -ominaisuuksia, kuten säätötasot, tekstikerroksen renderöinti ja muokkaus, täyttötasot, tasotehosteet, rasterien muokkaus ja vektorimaskit tasoille.
</p>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/drawing-images/"> Piirrä &amp; täyttää perusmuodot</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/crop-rotate-and-resize-images/"> Rajaa, kierrä &amp; muuttaa kuvien kokoa</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/manipulating-adobe-photoshop-formats/?#merge-psd-layers-into-other-layers-1"> Yhdistä tasot</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/working-with-text-layers/#update-text-layer-in-psd-file"> Tekstitasojen päivitys ajon aikana</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/manipulating-adobe-photoshop-formats/#add-curves-adjustment-layers"> Käyrien säätökerros</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/manipulating-adobe-photoshop-formats/#support-of-clipping-mask"> Leikkaavien maskien renderöinti</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/manipulating-adobe-photoshop-formats/#manage-opacity-of-layers"> Hallitse tasojen peittävyyttä &amp; Tasoita kerrokset</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/support-of-fill-layers/"> Manipulointi täyttökerroksilla</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/working-with-layers/#support-of-linked-layers"> Linkitettyjen kerrosten lisääminen ja poistaminen</a>
    </p>
   </div>
   <div class="col-lg-4">
...
<h2 class="h2title"> Uusimmat PSD API -ominaisuudet</h2>

<p> Aspose.PSD .NET API:lle lisää jatkuvasti uusia ominaisuuksia tehdäkseen siitä tehokkaan. Tässä on luettelo muutamasta poiminnasta viimeisimmistä lisätyistä.</p>

<ul>

<li> Täyttötasojen tuki. Kuvio, väri ja gradienttitäyttö</li>

<li> GdFlResourcen, VmskResourcen, PtFlResourcen ja VsmsResourcen tuki</li>

<li> Lataa JPEG/PNG/etc-kuvatiedostoja PsdImageen ilman suoraa lataamista</li>

<li> Tasovektorimaskien rasterointi ja mukautettu tekstikerroksen FlipRotate</li>

<li> Stroke-tehosteen renderöinti väritäytöllä vientiä varten</li>
   ...
   <div class="col-lg-12">
    ...
    <div class="codeblock" id="code">
     <h3>Muunna PSD PNG-, JPEG- ja amp; TIFF - C#
     </h3>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.PSD for .NET ei vain tue PSD:n &amp; PSB-tiedostomuodot käsittelyyn &amp; muunnos, mutta se tarjoaa myös mahdollisuuden luoda PSD &amp; PSB-tiedostoja tyhjästä. .NET-kehittäjät voivat käyttää API:a automatisoidakseen skenaarioita, jotka voivat auttaa heitä matkallaan.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Luo PSD tyhjästä - C#
