---
title: Konvertu PSD al BMP per Java
weight: 260
description: Ekzempla Ĝava konverta kodo por PSD-formato al BMP-dosiero. Uzu ĉi tiun ekzemplan kodon por konverti PSD al BMP ene de iu ajn retejo aŭ labortabla Java aplikaĵo.
---
...
{{% blocks/products/pf/agp/content h2="Kiel Konverti PSD al BMP Uzante Java" %}}

 Por redoni PSD al BMP, ni uzos
 ...
 kaj instalu ĝin en via Maven-bazita projekto aldonante la sekvajn agordojn al la pom.xml.
...
{{% blocks/products/pf/agp/feature-section-col title="Paŝoj por Konverti PSD al BMP per Java" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD API faciligas por la programistoj konverti PSD dosieron al BMP en nur kelkaj linioj de kodo.
...
{{% blocks/products/pf/agp/code-block title="Konverti PSD al BMP - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Vivaj Demonstraĵoj de Konvertiĝo de PSD al BMP" sectionDescription="[Konverti PSD al BMP](https://products.aspose.app/psd/conversion/psd-to-bmp) nun vizitante nian retejon de Live Demos. La viva demo havas la jenajn avantaĝojn" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Nur alŝutu vian PSD-dosieron, ĝi estos tuj konvertita al BMP." >}}
