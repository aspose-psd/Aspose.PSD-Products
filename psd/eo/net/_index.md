...
<p>
 ...
 kune kun eksporto al Pdf kun elektebla teksto. Aspose.PSD parte subtenas tiajn funkciojn de Adobe Photoshop kiel Alĝustigo-Tavoloj, Teksta Tavolo-bildigo kaj redaktado, Plenigi Tavoloj, Tavoloj-Efikoj, Redaktado de Raster kaj Vektoraj Maskoj por tavoloj.
</p>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/manipulating-adobe-photoshop-formats/?#merge-psd-layers-into-other-layers-1">Kunfandi tavolojn</a>
    </p>
   </div>
   <div class="col-lg-4">
...
<h2 class="h2title">La plej novaj PSD API-Trajtoj</h2>

<p>Aspose.PSD por .NET API senĉese aldonas pliajn funkciojn por fari ĝin potenca. Jen listo de kelkaj elektoj el la plej novaj aldonitaj.</p>

<ul>

<li>Subteno de Plenigaj tavoloj. Ŝablono, Koloro kaj Gradiento plenigas</li>

<li>Subteno de GdFlResource, VmskResource, PtFlResource kaj VsmsResource</li>

<li> Ŝarĝu bilddosieroj JPEG/PNG/ktp al PsdImage sen rekta ŝarĝo</li>

<li>Rasterigo de Tavolaj Vektoraj Maskoj kaj Teksta Tavolo Propra FlipRotate</li>

<li>Reprezentado de Stroke-efiko kun Kolora Plenigo por eksporto</li>
...
{{< blocks/products/pf/slr-tab tabTitle="Kial Aspose.PSD por .NET?" tabId="success-stories" >}}
