---
title: Converter AI para GIF via C#
description: Código de exemplo para conversão de AI para GIF C#. Use o código de exemplo da API para conversão de arquivos AI em lote para GIF em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
url: pt/net/conversion/ai-to-gif/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter AI para GIF via C#" h2="" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="Aspose.PSD" subTitlepfName="para .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PSD" fileiconsmall4="XML" fileiconsmall5="AI" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter AI para GIF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 O Aspose.PSD facilita para os desenvolvedores carregar e converter arquivos AI para GIF em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a conversão de AI para GIF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter AI para GIF" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de AI para GIF](https://products.aspose.app/psd/conversion/ai-to-gif) com os seguintes benefícios." >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-download" text=" Você receberá instantaneamente o link de download para o arquivo GIF resultante." >}}
