---
title: Converter AI para JPEG via C#
description: Código de exemplo para conversão de AI para JPEG C#. Use o código de exemplo da API para arquivos AI em lote para conversão JPEG em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
url: pt/net/conversion/ai-to-jpeg/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter AI para JPEG via C#" h2="" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="Aspose.PSD" subTitlepfName="para .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PSD" fileiconsmall4="XML" fileiconsmall5="AI" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter AI para JPEG via C#" %}}

{{% blocks/products/pf/agp/text %}}

 O Aspose.PSD torna mais fácil para os desenvolvedores carregar e converter arquivos AI para JPEG em apenas algumas linhas de código.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter AI para JPEG" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de AI para JPEG](https://products.aspose.app/psd/conversion/ai-to-jpeg) com os seguintes benefícios." >}}
