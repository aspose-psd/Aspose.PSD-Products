---
title: Converter PSB para PNG com C#
...
url: pt/net/conversion/psb-to-png/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter PSB para PNG via C#" h2=".NET Photoshop API para PSD e PSB Conversão para imagens raster, incluindo PNG">}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# Código para conversão de PSB para PNG" gistPath="" %}}
