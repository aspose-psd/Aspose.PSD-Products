---
title: Converter PSB para JP2 com C#
...
url: pt/net/conversion/psb-to-jp2/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter PSB para JP2 via C#" h2=".NET Photoshop API para PSD e PSB Conversão para imagens raster, incluindo JP2">}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# Código para conversão de PSB para JP2" gistPath="" %}}
