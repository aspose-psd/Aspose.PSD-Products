---
title: Converter PSB para BMP com C#
...
url: pt/net/conversion/psb-to-bmp/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter PSB para BMP via C#" h2=".NET Photoshop API para PSD e PSB Conversão para imagens raster incluindo BMP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Renderização de alta qualidade de PSB como BMP" %}}
1. Carregue o PSB com o método [Image.Load](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index)
1. Crie uma instância da classe [BmpOptions](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/bmpoptions)
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# Código para conversão de PSB para BMP" gistPath="" %}}
