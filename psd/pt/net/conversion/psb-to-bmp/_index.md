---
title: Converta PSB em BMP com C#
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter PSB em BMP via C#" h2="API .NET Photoshop para conversão de PSD e PSB em imagens rasterizadas, incluindo BMP" >}}
...
1. Carregue o PSB com [Image.Load](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) método
 [Opções de BMP](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/bmpoptions) classe
...
{{% blocks/products/pf/agp/code-autogen title="Código.NET C# para conversão de PSB em BMP" gistPath="" %}}
