---
title: Converta PSB para GIF com C#
...
url: pt/net/conversion/psb-to-gif/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter PSB para GIF via C#" h2=".NET Photoshop API para PSD e PSB Conversão para imagens raster, incluindo GIF">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Renderização de alta qualidade de PSB como GIF" %}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# Code para conversão de PSB para GIF" gistPath="" %}}
