...
1. Crie uma instância de [Opções de PDF](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/PdfOptions) classe
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter AI em PDF" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de AI para PDF](https://products.aspose.app/psd/conversion/ai-to-pdf) com os seguintes benefícios." >}}
