...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter AI em PDF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 O Aspose.PSD torna mais fácil para os desenvolvedores carregar e converter arquivos AI para PDF em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue a IA com o método [Image.Load](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index)
1. Crie uma instância da classe [PdfOptions](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/PdfOptions)
...
{{% blocks/products/pf/agp/code-block title="Este código de exemplo mostra a conversão de AI para PDF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter AI para PDF" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de AI para PDF](https://products.aspose.app/psd/conversion/ai-to-pdf) com os seguintes benefícios." >}}
