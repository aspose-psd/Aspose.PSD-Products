---
title: Converter PSD para PNG com C#
...
url: pt/net/conversion/psd-to-png/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter PSD para PNG via C#" h2=".NET Photoshop API para PSD e PSB Conversão para imagens raster, incluindo PNG">}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET Código C# para conversão de PSD para PNG" gistPath="" %}}
