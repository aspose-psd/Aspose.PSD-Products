---
title: Converter PSD para BMP com C#
...
url: pt/net/conversion/psd-to-bmp/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter PSD para BMP via C#" h2=".NET Photoshop API para PSD e PSB Conversão para imagens raster incluindo BMP">}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET Código C# para conversão de PSD para BMP" gistPath="" %}}
