---
title: Converta PSD em BMP com C#
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter PSD em BMP via C#" h2="API .NET Photoshop para conversão de PSD e PSB em imagens rasterizadas, incluindo BMP" >}}
...
{{% blocks/products/pf/agp/code-autogen title="Código.NET C# para conversão de PSD em BMP" gistPath="" %}}
