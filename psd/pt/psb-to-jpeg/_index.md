---
title: Converta PSB em JPEG com C#
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter PSB em JPEG via C#" h2="API .NET Photoshop para conversão de PSD e PSB em imagens rasterizadas, incluindo JPEG" >}}
...
1. Crie uma instância de gráficos a partir da imagem. [Opções de JPEG](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/jpegoptions) classe
...
{{% blocks/products/pf/agp/code-autogen title="Código.NET C# para conversão de PSB em JPEG" gistPath="" %}}
