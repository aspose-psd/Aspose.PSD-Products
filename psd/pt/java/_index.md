...
<li>Suporte de Máscaras de vetor de camada e FlipRotate personalizado de camada de texto</li>
...
<h2 class="h2title">Implementação de filtros de imagem</h2>

<p>Aspose.PSD para Java fornece os principais recursos de imagem, como ajuste de cores, por meio de suas bibliotecas de classes. Os desenvolvedores podem facilmente ajustar o brilho, contraste ou gama na imagem raster carregada pela API. Além disso, os desenvolvedores podem dinamicamente pontilhar ou desfocar imagens, bem como usar filtros populares, incluindo Median, Motion Wiener, Gauss Wiener e Bradley Threshold.</p>
