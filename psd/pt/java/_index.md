---
title: API Java Photoshop | Análise de formatos PSD e PSB
weight: 270
description: Crie, modifique ou converta formatos PSD e PSB usando essa biblioteca em qualquer aplicativo Java sem precisar do software Photoshop.
url: java/
---
...
<p>
 O Aspose.PSD para Java é uma API de manipulação de formato de arquivo do Adobe Photoshop fácil de usar. Ele pode carregar e ler facilmente arquivos PSD, PSB e AI, possibilitando que os desenvolvedores de Java realizem operações como atualizar as propriedades da camada, adicionar marcas d'água, compressão, rotação, dimensionamento ou renderização de um formato de arquivo para outro sem precisar instalar o Adobe Photoshop. Formatos de imagem como JPEG, TIFF, GIF, PNG, BMP, JPEG2000 podem ser facilmente abertos e adicionados como uma camada com apenas algumas linhas de código. Arquivos PSD, PSB e AI podem ser exportados para o formato listado e, adicionalmente, para o formato PDF
</p>
...
<div class="diagram1 d1-java">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt=“API de processamento Java psd” src="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" />
  <header>
   Aspose.PSD
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Independência da plataforma" description="A API oferece suporte a aplicativos de desktop, Web e console em plataformas como Windows, Linux/Unix e macOS, onde o Java está disponível." >}}
<div class="diagram1 d1-java">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/java/manipulating-adobe-illustrator-formats/">Exportação de arquivos AI para formatos rasterizados</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/java/cropping-psd-file-while-converting-to-png/">Corte em uma região retangular</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/java/crop-rotate-and-resize-images/">Corte, gire e redimensione imagens</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/java/manipulating-photoshop-formats/#support-flatten-layers">Achatamento da camada</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/java/converting-psd-image-to-raster-format/">Capacidade de exportar a pré-visualização do arquivo PSD</a>
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-pencil-square-o ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/java/color-space-conversion-for-jpeg-through-icc-profiles/">Abra e exporte arquivos PSD com alguma combinação dos modos RGB, CMYK, LAB e Grayscale com 8/16/32 bits por canal.</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/java/manipulating-photoshop-formats/#support-layer-effects-for-psd">Suporte dos efeitos de camada mais usados</a>
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-clone ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/java/support-of-fill-layers/#stroke-effect-with-color-fill">Efeito de Curso Externo/Interno/Central</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/java/support-of-fill-layers/">Efeito de camada de cor/padrão/gradiente</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/java/manipulating-photoshop-formats/#support-of-text-layers-on-runtime">Adicionar e editar camadas de texto em tempo de execução</a>
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-clone ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/java/apply-masking/">Suporte de máscaras vetoriais, rasterizadas, de recorte e suas combinações</a>
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-eye-slash ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Extração de dados dos recursos da secção de imagens
    </p>
   </div>
   <div class="col-lg-4">
...
<li>Rendering of Stroke effect with Color Fill for export</li>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Converter arquivos PSD em imagens rasterizadas
    </h2>
    <p>
     A biblioteca Aspose.PSD para Java suporta a conversão de arquivos PSD para qualquer uma das imagens rasterizadas suportadas, com apenas algumas linhas de código.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Converta PSD em BMP, GIF e JPEG - Java
     </h3>
   ...
   <div class="col-lg-12">
    ...
    <p>
     A manipulação de camadas PSD, como mesclar camadas, atualizar texto em camadas, definir efeitos ou exportar camadas como imagem, são alguns dos recursos de manipulação que a API fornece. Além disso, ele pode detectar documentos PSD achatados, bem como criar miniaturas.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Corte, gire e redimensione imagens em qualquer lugar
    </h2>
    <p>
    ...
    <p>
     Além disso, a API fornece diferentes filtros de imagem, como ajuste de contraste, brilho ou gama em imagens rasterizadas, pontilhamento ou desfoque de imagens, bem como os filtros mais famosos, incluindo Gauss Wiener, Median, Bradley Threshold e Motion Wiener.
    </p>
   </div>
   <!--<div class="col-lg-12">
