---
title: Converta PSB em PDF via Java
weight: 190
description: Exemplo de código de conversão Java para o formato PSB em arquivo PDF. Use esse código de exemplo para converter PSB em PDF em qualquer aplicativo baseado em Java para Web ou desktop.
url: java/conversion/psb-to-pdf/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/upper-banner h1="Converter PSB em PDF via Java" h2="API Java Photoshop para conversão de PSB em PDF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="Aspose.PSD" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSB" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter PSB em PDF usando Java" %}}
 ...
 Para renderizar PSB em PDF, usaremos
...
{{% blocks/products/pf/agp/text %}}
 ...
 A API Aspose.PSD torna mais fácil para os desenvolvedores converter arquivos PSB em PDF em apenas algumas linhas de código.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demonstrações ao vivo de conversão de PSB para PDF" sectionDescription="[Converter PSB em PDF](https://products.aspose.app/psd/conversion/psb-to-pdf) agora mesmo, visitando nosso site de demonstrações ao vivo. A demonstração ao vivo tem os seguintes benefícios" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Basta fazer o upload do seu arquivo PSB, ele será convertido instantaneamente em PDF." >}}
