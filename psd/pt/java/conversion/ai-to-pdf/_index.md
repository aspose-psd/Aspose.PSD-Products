...
{{% blocks/products/pf/agp/text %}}
 ...
 A API Aspose.PSD facilita para os desenvolvedores a conversão de arquivos AI para PDF em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

- Carregar imagem AI de entrada
- Inicialize o objeto de classe [PdfOptions](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/pdfOptions)
...
{{% blocks/products/pf/agp/code-block title="Converter AI para PDF - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demos ao vivo de conversão de AI para PDF" sectionDescription="[Converter AI para PDF](https://products.aspose.app/psd/conversion/ai-to-pdf) agora mesmo visitando nosso site de Demonstrações ao vivo. A demonstração ao vivo tem os seguintes benefícios" >}}
