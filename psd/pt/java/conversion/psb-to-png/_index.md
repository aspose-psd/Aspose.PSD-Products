---
title: Converter PSB para PNG via Java
weight: 110
description: Exemplo de código de conversão Java para formato PSB para arquivo PNG. Use este código de exemplo para converter PSB para PNG em qualquer aplicativo baseado em Web ou Desktop Java.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter PSB para PNG via Java" h2="Java Photoshop API para PSB Conversão para imagens raster, incluindo PNG" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="Aspose.PSD" subTitlepfName="para Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSB" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter PSB para PNG usando Java" %}}

 Para renderizar PSB para PNG, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter PSB para PNG via Java" %}}

{{% blocks/products/pf/agp/text %}}

 A API Aspose.PSD facilita para os desenvolvedores a conversão de arquivos PSB para PNG em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Converter PSB para PNG - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demos ao vivo de conversão de PSB para PNG" sectionDescription="[Converter PSB para PNG](https://products.aspose.app/psd/conversion/psb-to-png) agora mesmo visitando nosso site de Demonstrações ao vivo. A demonstração ao vivo tem os seguintes benefícios" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta fazer o upload do seu arquivo PSB, ele será convertido instantaneamente para PNG." >}}
