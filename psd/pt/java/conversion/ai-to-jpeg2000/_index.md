---
title: Converter AI para JPEG2000 via Java
description: Exemplo de código de conversão Java para formato AI para arquivo JPEG2000. Use este código de exemplo para converter AI para JPEG2000 em qualquer aplicativo baseado em Java Web ou Desktop.
url: pt/java/conversion/ai-to-jpeg2000/
---
...
{{% blocks/products/pf/agp/content h2="Como converter AI para JPEG2000 usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter AI para JPEG2000 via Java" %}}

{{% blocks/products/pf/agp/text %}}

 A API Aspose.PSD facilita para os desenvolvedores a conversão de arquivos AI para JPEG2000 em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

- Carregar imagem AI de entrada
- Inicialize o objeto de classe [Jpeg2000Options](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/jpeg2000Options)
- Especifique as propriedades da imagem
- Salvar imagem JPEG2000 de saída
...
{{% blocks/products/pf/agp/code-block title="Converter AI para JPEG2000 - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demos ao vivo de conversão de AI para JPEG2000" sectionDescription="[Converter AI para JPEG2000](https://products.aspose.app/psd/conversion/ai-to-jpeg2000) agora mesmo visitando nosso site de Demonstrações ao vivo. A demonstração ao vivo tem os seguintes benefícios" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta carregar seu arquivo AI, ele será convertido instantaneamente para JPEG2000." >}}
