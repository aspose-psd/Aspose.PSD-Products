---
title: Converta PSB em TIFF com C#
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter PSB em TIFF via C#" h2="API .NET Photoshop para conversão de PSD e PSB em imagens rasterizadas, incluindo TIFF" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Renderização de alta qualidade do PSB como TIFF" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Código.NET C# para conversão de PSB em TIFF" gistPath="" %}}
