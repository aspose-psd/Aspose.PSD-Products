---
title: APIs .NET e Java Photoshop | Analisar arquivos PSD e PSB
weight: 10
description: Biblioteca para ler, gravar e exportar arquivos PSD e PSB em várias plataformas. Extraia e manipule camadas sem o Photoshop instalado.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1="APIs para manipular arquivos PSD, PSB e AI" h2=".NET e APIs Java para criar, editar e converter arquivos Adobe Photoshop e Adobe Illustrator." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd.svg" pfName="Aspose.PSD" downloadUrl="https://downloads.aspose.com/psd/net" tryOnlineUrl="" >}}

{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/product-card-row title="Aspose.PSD High Code APIs incluem" >}}

{{< blocks/products/pf/product pfName="Aspose.PSD para" title=".NET" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-net.svg" productLink="/psd/net/" >}}
Destina-se a Windows Forms, ASP.NET ou qualquer tipo de aplicativo baseado em .NET Framework 2.0 ou posterior.
{{< /blocks/products/pf/product >}}

{{< blocks/products/pf/product pfName="Aspose.PSD para" title="Java" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" productLink="/psd/java/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Por que família de produtos Aspose.PSD?" tabId="success-stories" >}}
