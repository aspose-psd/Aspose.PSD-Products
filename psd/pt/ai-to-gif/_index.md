...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter AI em GIF via C#" %}}
...
1. Crie uma instância de [Opções de GIF](https://reference.aspose.com/psd/net/aspose.psd.imageoptions/gifoptions/) classe
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter AI em GIF" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de AI para GIF](https://products.aspose.app/psd/conversion/ai-to-gif) com os seguintes benefícios." >}}
