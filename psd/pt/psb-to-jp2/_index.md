---
title: Converta PSB em JP2 com C#
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter PSB em JP2 via C#" h2="API .NET Photoshop para conversão de PSD e PSB em imagens rasterizadas, incluindo JP2" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Renderização de alta qualidade de PSB como JP2" %}}
1. Carregue o PSB com [Image.Load](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) método
1. Crie uma instância de gráficos a partir da imagem. [Opções do JPEG 2000](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/Jpeg2000Options) classe
