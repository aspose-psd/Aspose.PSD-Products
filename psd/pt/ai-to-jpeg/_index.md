...
1. Crie uma instância de [Opções de JPEG](https://reference.aspose.com/psd/net/aspose.psd.imageoptions/jpegoptions/) classe
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter AI em JPEG" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão AI para JPEG](https://products.aspose.app/psd/conversion/ai-to-jpeg) com os seguintes benefícios." >}}
