---
title: Converter PSD em PSB via C#
weight: 210
description: Código de amostra para conversão de PSD em PSB C#. Use o código de exemplo de API para conversão de arquivos PSD em lote para PSB em VB.NET, ASP.NET ou qualquer aplicativo baseado em .NET.
url: psd-to-psb/
---
...
{{% blocks/products/pf/agp/content h2="Como converter PSD em PSB usando Java" %}}
 ...
 Para converter PSD em PSB, usaremos
...
{{% blocks/products/pf/agp/text %}}
 ...
 O Aspose.PSD torna mais fácil para os desenvolvedores carregar e converter arquivos PSD em PSB em apenas algumas linhas de código.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter PSD em PSB" sectionDescription="Check our live demos for [PSD to PSB conversion](https://products.aspose.app/psd/conversion/psd-to-psb) with following benefits." >}}
