...
1。创建的实例 [PSD 选项](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/PsdOptions) 班级
...
{{< blocks/products/pf/agp/demobox sectionTitle="将 AI 转换为 PSB 的免费应用程序" sectionDescription="看看我们的现场演示 [AI 到 PSB 的转换](https://products.aspose.app/psd/conversion/ai-to-psb) 具有以下好处。" >}}
