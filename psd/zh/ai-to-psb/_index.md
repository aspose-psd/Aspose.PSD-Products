---
title: 通过 C# 将 AI 转换为 PSB
description: AI 到 PSB C# 转换的示例代码。使用 API 示例代码在 VB.NET、ASP.NET 或任何基于 .NET 的应用程序中将 AI 文件批量转换为 PSB。
url: ai-to-psb/
---
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 将 AI 转换为 PSB" %}}

为了将 AI 转换为 PSB，我们将使用 <a href="/psd/{{< lang-code >}}net">Aspose.PSD for .NET</a> API 是适用于 Java 平台的功能丰富、强大且易于使用的转换 API。您可以直接从以下网址下载其最新版本 <a href="https://www.nuget.org/packages/aspose.psd">NuGet</a> 包管理器，搜索 <b>Aspose.PSD</b> 并安装。您也可以使用包管理器控制台中的以下命令。
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Java 将 AI 转换为 PSB 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD 使开发人员只需几行代码即可轻松地将 AI 文件加载并转换为 PSB。

{{% /blocks/products/pf/agp/text %}}

1。为 AI 加载 [图片。加载](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) 方法
1。从图像创建 Graphics 实例。 [PSD 选项](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/PsdOptions) 班级
1。打电话 [图片。保存](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/save/index) 方法
1。传递 psdOptions 的输出文件名和对象
...
{{% blocks/products/pf/agp/code-block title="此示例代码显示了 AI 到 PSB C# 的转换" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="将 AI 转换为 PSB 的免费应用程序" sectionDescription="Check our live demos for [AI to PSB conversion](https://products.aspose.app/psd/conversion/ai-to-psb) with following benefits." >}}
