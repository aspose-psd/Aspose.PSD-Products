---
title: 通过 C# 将 PSD 转换为 PDF
weight: 200
description: 将 PSD 转换为 PDF C# 的示例代码。使用 API 示例代码在 VB.NET、ASP.NET 或任何基于 .NET 的应用程序中将 PSD 文件批量转换为 PDF。
url: psd-to-pdf/
---
...
{{% blocks/products/pf/agp/code-block title="此示例代码显示了 PSD 到 PDF C# 的转换" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="将 PSD 转换为 PDF 的免费应用程序" sectionDescription="Check our live demos for [PSD to PDF conversion](https://products.aspose.app/psd/conversion/psd-to-pdf) with following benefits." >}}
