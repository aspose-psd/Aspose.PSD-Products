...
url: zh/net/conversion/psd-to-bmp/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="通過C#將PSD轉BMP" h2=".NET Photoshop API 用於 PSD 和 PSB 轉換為包括 BMP 在內的光柵圖像">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="高質量渲染PSD為BMP" %}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# PSD 到 BMP 轉換代碼" gistPath="" %}}
