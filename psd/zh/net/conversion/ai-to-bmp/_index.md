...
url: zh/net/conversion/ai-to-bmp/
---
...
為了將 AI 轉換為 BMP，我們將使用<a href="/psd/{{< lang-code >}}net">Aspose.PSD for .NET</a> API 是一個功能豐富、功能強大且易於使用的 C# 平台文檔操作和轉換 API。打開<a href="https://www.nuget.org/packages/aspose.psd">NuGet</a> 包管理器，搜索<b>Aspose.PSD</b> 並安裝。您也可以從包管理器控制台使用以下命令。
