...
1。用以下方式加载 PSB [图片。加载](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) 方法 [JPEG 选项](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/jpegoptions) 班级
1。打电话
