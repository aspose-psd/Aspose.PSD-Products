...
1。用以下方式加载 PSD [图片。加载](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) 方法 [TIF 期权](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/tiffoptions) 班级
1。打电话
