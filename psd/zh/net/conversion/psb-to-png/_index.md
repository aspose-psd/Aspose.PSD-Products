...
url: zh/net/conversion/psb-to-png/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="通過C#將PSB轉為PNG" h2=".NET Photoshop API 用於 PSD 和 PSB 轉換為包括 PNG 在內的光柵圖像">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="將PSB高質量渲染為PNG" %}}
1. 使用 [Image.Load](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) 方法加載 PSB
1.創建[PngOptions](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/pngoptions)類的實例
1.調用[Image.Save](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/save/index)方法
1.傳遞PngOptions的輸出文件名和對象
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# 代碼用於 PSB 到 PNG 的轉換" gistPath="" %}}
