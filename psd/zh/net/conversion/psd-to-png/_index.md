...
url: zh/net/conversion/psd-to-png/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="通過C#將PSD轉為PNG" h2=".NET Photoshop API 用於 PSD 和 PSB 轉換為包括 PNG 在內的光柵圖像">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="將PSD高質量渲染為PNG" %}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# PSD轉PNG代碼" gistPath="" %}}
