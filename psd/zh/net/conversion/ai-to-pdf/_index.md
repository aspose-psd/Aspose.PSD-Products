...
1。为 AI 加载 [图片。加载](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) 方法 [PDF 选项](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/PdfOptions) 班级
1。打电话
...
{{< blocks/products/pf/agp/demobox sectionTitle="将 AI 转换为 PDF 的免费应用程序" sectionDescription="Check our live demos for [AI to PDF conversion](https://products.aspose.app/psd/conversion/ai-to-pdf) with following benefits." >}}
