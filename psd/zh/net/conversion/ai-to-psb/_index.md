...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 AI 转换为 PSB" %}}

为了将 AI 转换为 PSB，我们将使用 <a href="/psd/{{< lang-code >}}net">Aspose.PSD for .NET</a> API 是功能丰富、功能强大且易于使用的针对 C# 平台的文档操作和转换 API。打开 <a href="https://www.nuget.org/packages/aspose.psd">NuGet</a> 包管理器，搜索 <b>Aspose.PSD</b> 并安装。您也可以使用包管理器控制台中的以下命令。
...
{{% blocks/products/pf/agp/feature-section-col title="通过 C# 将 AI 转换为 PSB 的步骤" %}}
...
1。为 AI 加载 [图片。加载](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) 方法 [PSD 选项](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/PsdOptions) 班级
1。打电话
