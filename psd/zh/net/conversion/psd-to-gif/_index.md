...
url: zh/net/conversion/psd-to-gif/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="通過C#將PSD轉為GIF" h2=".NET Photoshop API 用於 PSD 和 PSB 轉換為包括 GIF 在內的光柵圖像">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="高質量的PSD渲染成GIF" %}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# PSD轉GIF代碼" gistPath="" %}}
