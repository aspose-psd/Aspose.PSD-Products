---
title: 通過 C# 將 AI 轉為 PNG
description: AI 到 PNG C# 轉換的示例代碼。使用 API 示例代碼在 VB.NET、Asp.NET 或任何基於 .NET 的應用程序中將 AI 文件批量轉換為 PNG。
url: zh/net/conversion/ai-to-png/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="通過C#將AI轉為PNG" h2="" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="Aspose.PSD" subTitlepfName=".NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PSD" fileiconsmall4="XML" fileiconsmall5="AI" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用C#將AI轉為PNG" %}}

為了將 AI 轉換為 PNG，我們將使用<a href="/psd/{{< lang-code >}}net">Aspose.PSD for .NET</a> API 是一個功能豐富、功能強大且易於使用的 C# 平台文檔操作和轉換 API。打開<a href="https://www.nuget.org/packages/aspose.psd">NuGet</a> 包管理器，搜索<b>Aspose.PSD</b> 並安裝。您也可以從包管理器控制台使用以下命令。
...
{{% blocks/products/pf/agp/feature-section-col title="通過C#將AI轉為PNG的步驟" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD 讓開發人員只需幾行代碼即可輕鬆加載 AI 文件並將其轉換為 PNG。
...
{{% blocks/products/pf/agp/code-block title="這個示例代碼展示了AI到PNG的C#轉換" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="將AI轉換為PNG的免費應用" sectionDescription="查看我們的 [AI 到 PNG 轉換](https://products.aspose.app/psd/conversion/ai-to-png) 的現場演示，具有以下優勢。" >}}
