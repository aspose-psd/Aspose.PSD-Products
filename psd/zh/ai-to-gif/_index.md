...
1。创建的实例 [GIF 选项](https://reference.aspose.com/psd/net/aspose.psd.imageoptions/gifoptions/) 班级
...
{{< blocks/products/pf/agp/demobox sectionTitle="将 AI 转换为 GIF 的免费应用程序" sectionDescription="看看我们的现场演示 [将 AI 转换为 GIF](https://products.aspose.app/psd/conversion/ai-to-gif) 具有以下好处。" >}}
