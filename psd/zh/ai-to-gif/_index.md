...
为了将 AI 转换为 GIF，我们将使用 <a href="/psd/{{< lang-code >}}net">Aspose.PSD for .NET</a> API 是适用于 Java 平台的功能丰富、强大且易于使用的转换 API。您可以直接从以下网址下载其最新版本 <a href="https://www.nuget.org/packages/aspose.psd">NuGet</a> 包管理器，搜索 <b>Aspose.PSD</b> 并安装。您也可以使用包管理器控制台中的以下命令。
