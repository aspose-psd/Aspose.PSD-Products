...
1。创建的实例 [JPEG 选项](https://reference.aspose.com/psd/net/aspose.psd.imageoptions/jpegoptions/) 班级
...
{{< blocks/products/pf/agp/demobox sectionTitle="将 AI 转换为 JPEG 的免费应用程序" sectionDescription="看看我们的现场演示 [AI 到 JPEG 的转换](https://products.aspose.app/psd/conversion/ai-to-jpeg) 具有以下好处。" >}}
