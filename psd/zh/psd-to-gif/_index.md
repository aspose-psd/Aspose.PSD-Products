...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通过 C# 将 PSD 转换为 GIF" h2="用于 PSD 和 PSB 的 .NET Photoshop API 转换为包括 GIF 在内的光栅图像" >}}
...
1。从图像创建 Graphics 实例。 [GIF 选项](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/gifoptions) 班级
