...
-加载 PSB 文件
-创建一个实例
 [tiff 期权类别](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/TiffOptions)-使用 Image.Save（字符串、tiffOptions）方法进行转换。
...
{{< blocks/products/pf/agp/demobox sectionTitle="PSB 到 TIFF 转换直播演示" sectionDescription="[Convert PSB to TIFF](https://products.aspose.app/psd/conversion/psb-to-tiff) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
