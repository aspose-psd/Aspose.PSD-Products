---
title: 通过 Java 将 PSD 转换为 PNG
weight: 80
description: 将 PSD 格式转换为 PNG 文件的 Java 示例代码。使用此示例代码在任何基于 Web 或桌面 Java 的应用程序中将 PSD 转换为 PNG。
url: psd-to-png/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/upper-banner h1="Convert PSD to PNG via Java" h2="用于 PSD 的 Java Photoshop API 转换为包括 PNG 在内的光栅图像" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="Aspose.PSD" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSD" >}}

{{< blocks/products/pf/main-container pfName="Aspose.PSD " subTitlepfName="for Java" >}}
{{< blocks/products/pf/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-psd" liveDemosLink="https://products.aspose.app/psd/family" docsLink="https://docs.aspose.com/psd/java" installationsDocsLink="https://docs.aspose.com/psd/java" nugetLink="" nugetPackageName="" downloadAsLink="https://releases.aspose.com/psd/java" learnAsLink="https://docs.aspose.com/psd/java" apiReference="" mavenRepoLink="https://repository.aspose.com/psd/" >}}

{{% blocks/products/pf/agp/content h2="如何使用 Java 将 PSD 转换为 PNG" %}}

 为了将 PSD 渲染为 PNG，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Java 将 PSD 转换为 PNG 的步骤" %}}
...
-加载 PSD 文件
-创建一个实例
 [pngOptions](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/PngOptions)-使用 Image.Save（字符串、pngOptions）方法进行转换。
...
{{% blocks/products/pf/agp/code-block title="将 PSD 转换为 PNG-Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="PSD 到 PNG 转换直播演示" sectionDescription="[Convert PSD to PNG](https://products.aspose.app/psd/conversion/psd-to-png) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text="无需下载 Aspose API。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text="无需编写任何代码。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="只需上传您的PSD文件，它将立即转换为PNG。" >}}
