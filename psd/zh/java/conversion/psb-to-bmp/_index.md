---
title: 通过 Java 将 PSB 转换为 BMP
weight: 300
description: 将 PSB 格式转换为 BMP 文件的 Java 示例代码。使用此示例代码在任何基于 Web 或桌面 Java 的应用程序中将 PSB 转换为 BMP。
url: psb-to-bmp/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/upper-banner h1="Convert PSB to BMP via Java" h2="用于 PSB 的 Java Photoshop API 转换为包括 BMP 在内的光栅图像" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="Aspose.PSD" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSB" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Java 将 PSB 转换为 BMP 的步骤" %}}
...
-加载 PSB 文件
-创建一个实例
 [bmPoptions 等级](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/BmpOptions)-使用 Image.Save（字符串、bmPoptions）方法进行转换。
...
{{% blocks/products/pf/agp/code-block title="将 PSB 转换为 BMP-Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="PSB 到 BMP 转换直播演示" sectionDescription="[Convert PSB to BMP](https://products.aspose.app/psd/conversion/psb-to-bmp) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
