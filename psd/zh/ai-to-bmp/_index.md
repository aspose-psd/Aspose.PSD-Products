...
为了将 AI 转换为 BMP，我们将使用 <a href="/psd/{{< lang-code >}}net">Aspose.PSD for .NET</a> API 是适用于 Java 平台的功能丰富、强大且易于使用的转换 API。您可以直接从以下网址下载其最新版本 <a href="https://www.nuget.org/packages/aspose.psd">NuGet</a> 包管理器，搜索 <b>Aspose.PSD</b> 并安装。您也可以使用包管理器控制台中的以下命令。
...
1。从图像创建 Graphics 实例。 [bmPoptions](https://apireference.aspose.com/imaging/net/aspose.imaging.imageoptions/bmpoptions) 班级
...
{{< blocks/products/pf/agp/demobox sectionTitle="将 AI 转换为 BMP 的免费应用程序" sectionDescription="Check our live demos for [AI to BMP conversion](https://products.aspose.app/psd/conversion/ai-to-bmp) with following benefits." >}}
