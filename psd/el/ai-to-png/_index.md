...
1. Δημιουργήστε μια παρουσία του [PnGOPTIC](https://reference.aspose.com/psd/net/aspose.psd.imageoptions/pngoptions/) τάξη
...
{{< blocks/products/pf/agp/demobox sectionTitle="Δωρεάν εφαρμογή για μετατροπή AI σε PNG" sectionDescription="Ελέγξτε τα live demos μας για [Μετατροπή AI σε PNG](https://products.aspose.app/psd/conversion/ai-to-png) με τις ακόλουθες παροχές." >}}
