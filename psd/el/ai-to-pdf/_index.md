...
description: Δείγμα κώδικα για μετατροπή AI σε PDF C#. Χρησιμοποιήστε API παράδειγμα κώδικα για αρχεία AI δέσμης σε μετατροπή PDF μέσα VB.NET, ASP.NET ή οποιαδήποτε εφαρμογή που βασίζεται .NET.
url: ai-to-pdf/
---
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη μετατροπή του AI σε PDF μέσω Java" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD καθιστά εύκολο για τους προγραμματιστές να φορτώσετε και να μετατρέψετε αρχεία AI σε PDF σε λίγες μόνο γραμμές κώδικα.

{{% /blocks/products/pf/agp/text %}}

1. Φόρτωση του AI με [Εικόνα.Φόρτωση](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) μέθοδος
1. Δημιουργήστε μια παρουσία των γραφικών από την εικόνα. [PDFOptions](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/PdfOptions) τάξη
...
{{% blocks/products/pf/agp/code-block title="Αυτό το δείγμα κώδικα δείχνει AI σε PDF C# μετατροπή" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Δωρεάν εφαρμογή για μετατροπή AI σε PDF" sectionDescription="Check our live demos for [AI to PDF conversion](https://products.aspose.app/psd/conversion/ai-to-pdf) with following benefits." >}}
