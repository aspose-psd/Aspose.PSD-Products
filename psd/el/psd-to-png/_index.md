...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή PSD σε PNG μέσω C#" h2=".NET Photoshop API για PSD & PSB Μετατροπή σε εικόνες ράστερ συμπεριλαμβανομένων PNG" >}}
...
1. Δημιουργήστε μια παρουσία των γραφικών από την εικόνα. [PnGOPTIC](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/pngoptions) τάξη
