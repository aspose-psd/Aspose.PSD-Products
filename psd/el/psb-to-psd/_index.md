...
weight: 240
description: Δείγμα κώδικα για μετατροπή PSB σε PSD C#. Χρησιμοποιήστε το API παράδειγμα κώδικα για μαζική αρχεία PSB σε μετατροπή PSD μέσα VB.NET, ASP.NET ή οποιαδήποτε εφαρμογή που βασίζεται .NET.
url: psb-to-psd/
---
...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε PSB σε PSD Χρησιμοποιώντας Java" %}}
 ...
 Για να μετατρέψουμε το PSB σε PSD, θα χρησιμοποιήσουμε το
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD καθιστά εύκολο για τους προγραμματιστές να φορτώσετε και να μετατρέψετε αρχεία PSB σε PSD σε λίγες μόνο γραμμές κώδικα.
...
{{% blocks/products/pf/agp/code-block title="Αυτό το δείγμα κώδικα δείχνει PSB σε PSD C# μετατροπή" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Δωρεάν εφαρμογή για μετατροπή PSB σε PSD" sectionDescription="Check our live demos for [PSB to PSD conversion](https://products.aspose.app/psd/conversion/psb-to-psd) with following benefits." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="net/conversion/psb-to-bmp/" name="PSB ΣΕ BMP" description="{{bmp _name}}" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="net/conversion/psb-to-gif/" name="PSB ΣΕ GIF" description="{{bmp _name}}" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="net/conversion/psb-to-jpeg/" name="PSB ΝΑ JPEG" description="{{bmp _name}}" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="net/conversion/psb-to-pdf/" name="PSB ΣΕ PDF" description="{{bmp _name}}" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="net/conversion/psb-to-png/" name="PSB ΣΕ PNG" description="{{bmp _name}}" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="net/conversion/psb-to-psd/" name="PSB ΣΕ PSD" description="{{bmp _name}}" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="net/conversion/psb-to-tiff/" name="PSB ΣΕ TIFF" description="{{bmp _name}}" >}}
