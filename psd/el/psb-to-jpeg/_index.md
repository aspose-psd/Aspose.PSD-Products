---
title: Μετατροπή PSB σε JPEG με C#
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή PSB σε JPEG μέσω C#" h2=".NET Photoshop API για PSD & PSB Μετατροπή σε εικόνες ράστερ συμπεριλαμβανομένων JPEG" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Υψηλής Ποιότητας Απόδοση του PSB ως JPEG" %}}
1. Φορτώστε το PSB με [Εικόνα.Φόρτωση](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) μέθοδος
1. Δημιουργήστε μια παρουσία των γραφικών από την εικόνα. [ΚΕ Εκδοχές](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/jpegoptions) τάξη
...
{{% blocks/products/pf/agp/code-autogen title="Κωδικός NET C# για μετατροπή PSB σε JPEG" gistPath="" %}}
