...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη μετατροπή του AI σε PDF μέσω C#" %}}
...
1. Δημιουργήστε μια παρουσία του [PDFOptions](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/PdfOptions) τάξη
...
{{< blocks/products/pf/agp/demobox sectionTitle="Δωρεάν εφαρμογή για μετατροπή AI σε PDF" sectionDescription="Ελέγξτε τα live demos μας για [Μετατροπή AI σε PDF](https://products.aspose.app/psd/conversion/ai-to-pdf) με τις ακόλουθες παροχές." >}}
