...
{{< blocks/products/pf/agp/upper-banner-autogen h1="แปลง PSD เป็น JPEG ผ่าน C#" h2=".NET Photoshop API สำหรับ PSD และ PSB แปลงเป็นภาพแรสเตอร์รวมทั้ง JPEG" >}}
...
1.สร้างอินสแตนซ์ของกราฟิกจากภาพ [JPEGOptions](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/jpegoptions) แบ่งประเภท
...
{{% blocks/products/pf/agp/code-autogen title="รหัส .NET C# สำหรับการแปลง PSD เป็น JPEG" gistPath="" %}}
