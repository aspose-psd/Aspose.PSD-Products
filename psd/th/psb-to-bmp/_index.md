...
{{< blocks/products/pf/agp/upper-banner-autogen h1="แปลง PSB เป็น BMP ผ่าน C#" h2=".NET Photoshop API สำหรับ PSD และ PSB แปลงเป็นภาพแรสเตอร์รวมทั้ง BMP" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="การแสดงผลคุณภาพสูงของ PSB เป็น BMP" %}}
1.โหลด PSB ด้วย [รูปภาพโหลดภาพ](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) วิธี
1.สร้างอินสแตนซ์ของกราฟิกจากภาพ [บีเอ็มป็อปชัน](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/bmpoptions) แบ่งประเภท
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# รหัสสำหรับการแปลง PSB เป็น BMP" gistPath="" %}}
