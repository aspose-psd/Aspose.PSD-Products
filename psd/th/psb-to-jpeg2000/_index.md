...
description: ตัวอย่างรหัสสำหรับการแปลง PSB เป็น JPEG2000 C#ใช้รหัสตัวอย่าง API สำหรับไฟล์ PSB ชุดการแปลง JPEG2000 ภายใน VB.NET, ASP.Net หรือโปรแกรมประยุกต์ใด ๆ ตาม NET
url: psb-to-jpeg2000/
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD ทำให้ง่ายสำหรับนักพัฒนาในการโหลดและแปลงไฟล์ PSB เพื่อ JPEG2000 ในเวลาเพียงไม่กี่บรรทัดของรหัส
...
{{% blocks/products/pf/agp/code-block title="ตัวอย่างโค้ดนี้แสดงการแปลง PSB เป็น JPEG2000 C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="แอปฟรีเพื่อแปลง PSB เป็น JPEG2000" sectionDescription="Check our live demos for [PSB to JPEG2000 conversion](https://products.aspose.app/psd/conversion/psb-to-jpeg2000) with following benefits." >}}
