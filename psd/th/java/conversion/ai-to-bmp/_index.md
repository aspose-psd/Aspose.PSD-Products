---
title: แปลง AI เป็น BMP ผ่าน Java
description: ตัวอย่างโค้ดการแปลง Java สำหรับรูปแบบ AI เป็นไฟล์ BMP ใช้โค้ดตัวอย่างนี้เพื่อแปลง AI เป็น BMP ภายในแอปพลิเคชันบนเว็บหรือเดสก์ท็อป Java
url: th/java/conversion/ai-to-bmp/
---
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง AI เป็น BMP โดยใช้ Java" %}}

ในการเรนเดอร์ AI เป็น BMP เราจะใช้<a href="/psd/{{< lang-code >}}java"> Aspose.PSD สำหรับ Java</a> API ซึ่งเป็น API การแปลงที่มีคุณลักษณะหลากหลาย มีประสิทธิภาพ และใช้งานง่ายสำหรับแพลตฟอร์ม Java คุณสามารถดาวน์โหลดเวอร์ชันล่าสุดได้โดยตรงจาก<a href="https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-psd">มาเวน</a> และติดตั้งภายในโปรเจ็กต์ที่ใช้ Maven โดยเพิ่มการกำหนดค่าต่อไปนี้ใน pom.xml
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD API ช่วยให้นักพัฒนาแปลงไฟล์ AI เป็น BMP ได้ง่ายในโค้ดเพียงไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

- โหลดอิมเมจ AI อินพุต
- เริ่มต้น [BmpOptions](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/bmpOptions) วัตถุคลาส
- ระบุคุณสมบัติของภาพ
- บันทึกภาพ BMP ที่ส่งออก
...
{{< blocks/products/pf/agp/demobox sectionTitle="AI เพื่อ BMP Conversion สาธิตสด" sectionDescription="[แปลง AI เป็น BMP](https://products.aspose.app/psd/conversion/ai-to-bmp) ตอนนี้โดยไปที่เว็บไซต์ Live Demos ของเรา การสาธิตสดมีประโยชน์ดังต่อไปนี้" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" ไม่จำเป็นต้องดาวน์โหลด Aspose API" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" ไม่ต้องเขียนโค้ดใดๆ" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" แค่อัปโหลดไฟล์ AI ของคุณ มันจะถูกแปลงเป็น BMP ทันที" >}}
