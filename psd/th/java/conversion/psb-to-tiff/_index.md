---
title: แปลง PSB เพื่อ TIFF ผ่าน Java
weight: 40
description: ตัวอย่างรหัสการแปลง Java สำหรับรูปแบบ PSB ไปยังไฟล์ TIFFใช้รหัสตัวอย่างนี้เพื่อแปลง PSB เพื่อ TIFF ภายในเว็บหรือสก์ท็อปโปรแกรม Java ตาม
url: java/conversion/psb-to-tiff/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/upper-banner h1="แปลง PSB เป็น TIFF ผ่านจาวา" h2="Java Photoshop API สำหรับการแปลง PSB เป็นภาพแรสเตอร์รวมทั้ง TIFF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="Aspose.PSD" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSB" >}}

{{< blocks/products/pf/main-container pfName="Aspose.PSD " subTitlepfName="for Java" >}}
{{< blocks/products/pf/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-psd" liveDemosLink="https://products.aspose.app/psd/family" docsLink="https://docs.aspose.com/psd/java" installationsDocsLink="https://docs.aspose.com/psd/java" nugetLink="" nugetPackageName="" downloadAsLink="https://releases.aspose.com/psd/java" learnAsLink="https://docs.aspose.com/psd/java" apiReference="" mavenRepoLink="https://repository.aspose.com/psd/" >}}

{{% blocks/products/pf/agp/content h2="วิธีการแปลง PSB เพื่อ TIFF ใช้ Java" %}}

 เพื่อที่จะทำให้ PSB เป็น TIFF เราจะใช้
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD API ทำให้มันง่ายสำหรับนักพัฒนาในการแปลงไฟล์ PSB เพื่อ TIFF ในเวลาเพียงไม่กี่บรรทัดของรหัส
...
{{< blocks/products/pf/agp/demobox sectionTitle="PSB เพื่อการแปลง TIFF สาธิตสด" sectionDescription="[แปลง PSB เป็น TIFF](https://products.aspose.app/psd/conversion/psb-to-tiff) ได้แล้ววันนี้ โดยไปที่เว็บไซต์ Live Demos ของเรา การสาธิตสดมีประโยชน์ดังต่อไปนี้" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text="ไม่จำเป็นต้องดาวน์โหลด Aspose API" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text="ไม่จำเป็นต้องเขียนโค้ดใด ๆ." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="เพียงอัปโหลดไฟล์ PSB ของคุณมันจะถูกแปลงเป็น TIFF ทันที" >}}
