...
weight: 330
description: ตัวอย่างโค้ดการแปลง Java สำหรับรูปแบบ PSD เป็นไฟล์ GIF ใช้โค้ดตัวอย่างนี้เพื่อแปลง PSD เป็น GIF ภายในแอปพลิเคชันบนเว็บหรือเดสก์ท็อป Java
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="แปลง PSD เป็น GIF ผ่าน Java" h2="Java Photoshop API สำหรับการแปลง PSD เป็นภาพแรสเตอร์รวมถึง GIF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="Aspose.PSD" subTitlepfName="สำหรับ Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSD" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง PSD เป็น GIF โดยใช้ Java" %}}

 ในการเรนเดอร์ PSD เป็น GIF เราจะใช้
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD API ช่วยให้นักพัฒนาแปลงไฟล์ PSD เป็น GIF ได้ง่ายในโค้ดเพียงไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

- โหลดไฟล์ PSD
- สร้างอินสแตนซ์ของ [คลาส GifOptions](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/GifOptions)
- ใช้วิธี Image.save (String, GifOptions) สำหรับการแปลง
...
{{< blocks/products/pf/agp/demobox sectionTitle="การสาธิตการแปลงไฟล์ PSD เป็น GIF สด" sectionDescription="[แปลง PSD เป็น GIF](https://products.aspose.app/psd/conversion/psd-to-gif) ทันทีโดยไปที่เว็บไซต์ Live Demos ของเรา การสาธิตสดมีประโยชน์ดังต่อไปนี้" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" ไม่จำเป็นต้องดาวน์โหลด Aspose API" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" ไม่จำเป็นต้องเขียนโค้ดใดๆ" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" เพียงอัปโหลดไฟล์ PSD ของคุณจะถูกแปลงเป็น GIF ทันที" >}}
