 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/python-net/smart-filters/">ตัวกรองสมาร์ท</a>
    </p>
   </div>
   <div class="col-lg-4">
...
{{< blocks/products/pf/slr-tab tabTitle="ทำไม Aspose.PSD สำหรับ Python?" tabId="success-stories" >}}
