...
{{< blocks/products/pf/upper-banner h1="เพิ่มลายน้ำข้อความไปยัง PSD ผ่าน C #" h2="สร้างแอป .NET ของคุณเองเพื่อใส่ลายน้ำไฟล์ PSD โดยใช้ API ฝั่งเซิร์ฟเวอร์" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PSD" pfName="สมมุติ.PSD" subTitlepfName="สำหรับ .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="วิธีใส่ลายน้ำไฟล์ PSD โดยใช้ C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการเพิ่มลายน้ำให้กับ PSD ผ่าน C#" %}}
...
+ สร้างตัวอย่างกราฟิกจากภาพ
+ กำหนดและตั้งค่าแบบอักษร แปรง และรูปแบบสำหรับข้อความลายน้ำ
+ วาดลายน้ำโดยใช้ฟังก์ชัน Graphics.DrawString
...
{{% blocks/products/pf/agp/code-block title="เพิ่มลายน้ำให้กับ PSD - C#" offSpacer="" %}}
