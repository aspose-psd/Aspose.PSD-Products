---
title: แปลง PSB เป็น BMP ด้วย C#
...
url: th/net/conversion/psb-to-bmp/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="แปลง PSB เป็น BMP ผ่าน C#" h2=" NET Photoshop API สำหรับ PSD & PSB การแปลงเป็นภาพแรสเตอร์รวมถึง BMP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="การแสดงผล PSB คุณภาพสูงเป็น BMP" %}}
1. โหลด PSB ด้วยวิธีการ [Image.Load](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index)
1. สร้างอินสแตนซ์ของคลาส [BmpOptions](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/bmpoptions)
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# Code สำหรับ PSB เป็น BMP Conversion" gistPath="" %}}
