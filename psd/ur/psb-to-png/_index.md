---
title: پی ایس بی کو سی # کے ساتھ PNG میں تبدیل کریں
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="پی ایس بی کو سی # کے ذریعہ PNG میں تبدیل کریں" h2="پی ایس ڈی اور پی ایس بی تبادلوں کے لئے .NET فوٹوشاپ API PNG سمیت ریسٹر تصاویر کے لئے" >}}
...
{{% blocks/products/pf/agp/code-autogen title="پی ایس بی سے PNG تبادلوں کے لئے .NET سی # کوڈ" gistPath="" %}}
