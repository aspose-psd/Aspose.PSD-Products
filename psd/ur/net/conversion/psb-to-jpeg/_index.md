---
title: پی ایس بی کو جے پی ای پی میں سی # کے ساتھ تبدیل کریں
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="پی ایس بی کو جے پی ای پی میں سی # کے ذریعے تبدیل کریں" h2="JPEG سمیت ریسٹر تصاویر کے لئے پی ایس ڈی اور پی ایس بی تبادلوں کے لئے .NET فوٹوشاپ API" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="JPEG کے طور پر پی ایس بی کے اعلی معیار کی رینڈریننگ" %}}
1. پی ایس بی کے ساتھ لوڈ کریں [تصویر. لوڈ](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) طریقہ
 [جے پیگ کے اختیارات](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/jpegoptions) جماعت
...
{{% blocks/products/pf/agp/code-autogen title="پی ایس بی کے لئے جے پی ای جی پی تبادلوں کے لئے .NET سی # کوڈ" gistPath="" %}}
