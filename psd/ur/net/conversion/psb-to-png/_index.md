---
title: PSB کو C# کے ساتھ PNG میں تبدیل کریں
...
url: ur/net/conversion/psb-to-png/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="C# کے ذریعے PSB کو PNG میں تبدیل کریں" h2=" .NET فوٹوشاپ API برائے PSD اور PSB کو راسٹر امیجز بشمول PNG میں تبدیل کرنا">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PSB کی PNG کے طور پر اعلیٰ معیار کی رینڈرنگ" %}}
...
{{% blocks/products/pf/agp/code-autogen title=". NET C# کوڈ PSB سے PNG کی تبدیلی کے لیے" gistPath="" %}}
