---
title: پی ایس ڈی کو بی ایم پی کے ساتھ سی # میں تبدیل کریں
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="پی ایس ڈی کو بی ایم پی کے ذریعہ سی # میں تبدیل کریں" h2="پی ایس ڈی اور پی ایس بی تبادلوں کے لئے .NET فوٹوشاپ API BMP سمیت ریسٹر تصاویر کے لئے" >}}
...
1. تصویر سے گرافکس کی ایک مثال بنائیں. [بی ایم آپشنز](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/bmpoptions) جماعت
...
{{% blocks/products/pf/agp/code-autogen title="پی ایس ڈی کے لئے BMP تبادلوں کے لئے .NET سی # کوڈ" gistPath="" %}}
