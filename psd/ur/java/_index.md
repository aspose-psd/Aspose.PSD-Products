...
{{< blocks/products/pf/carousel-item h3="سپورٹ شدہ فائل فارمیٹس" description="جاوا کے لئے Aspose.PSD [تائید شدہ فائل فارمیٹس](https://docs.aspose.com/psd/java/supported-file-formats/)  ذیل میں درج ہیں۔" >}}
