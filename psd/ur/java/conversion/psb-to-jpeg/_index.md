---
title: جاوا کے ذریعے PSB کو JPEG میں تبدیل کریں۔
weight: 180
description: نمونہ جاوا کنورژن کوڈ PSB فارمیٹ کے لیے JPEG فائل میں۔ کسی بھی ویب یا ڈیسک ٹاپ جاوا پر مبنی ایپلیکیشن کے اندر PSB کو JPEG میں تبدیل کرنے کے لیے اس مثالی کوڈ کا استعمال کریں۔
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="جاوا کے ذریعے PSB کو JPEG میں تبدیل کریں۔" h2=" JPEG سمیت راسٹر امیجز میں PSB کی تبدیلی کے لیے Java Photoshop API" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="Aspose.PSD" subTitlepfName="جاوا کے لیے" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSB" >}}
...
{{% blocks/products/pf/agp/content h2="جاوا کا استعمال کرتے ہوئے PSB کو JPEG میں کیسے تبدیل کریں۔" %}}

 PSB کو JPEG میں رینڈر کرنے کے لیے، ہم استعمال کریں گے۔
...
{{% blocks/products/pf/agp/feature-section-col title="جاوا کے ذریعے PSB کو JPEG میں تبدیل کرنے کے اقدامات" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD API ڈویلپرز کے لیے PSB فائل کو JPEG میں کوڈ کی چند لائنوں میں تبدیل کرنا آسان بناتا ہے۔

{{% /blocks/products/pf/agp/text %}}

- PSB فائل لوڈ کریں۔
- [JpegOptions کلاس](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/JpegOptions) کی ایک مثال بنائیں۔
- تبدیلی کے لیے Image.save(String, JpegOptions) طریقہ استعمال کریں۔
...
{{% blocks/products/pf/agp/code-block title="PSB کو JPEG - Java میں تبدیل کریں۔" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="PSB سے JPEG کنورژن لائیو ڈیمو" sectionDescription="[PSB کو JPEG میں تبدیل کریں](https://products.aspose.app/psd/conversion/psb-to-jpeg) ابھی ہماری لائیو ڈیمو ویب سائٹ پر جا کر۔ لائیو ڈیمو کے درج ذیل فوائد ہیںAspose API ڈاؤن لوڈ کرنے کی ضرورت نہیں ہے۔" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" کوئی کوڈ لکھنے کی ضرورت نہیں۔" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" بس اپنی PSB فائل اپ لوڈ کریں، یہ فوری طور پر JPEG میں تبدیل ہو جائے گی۔" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/psd/java/conversion/psb-to-tiff/" name="PSB TO TIFF" description="ٹیگ کردہ تصویری فارمیٹپورٹ ایبل نیٹ ورک گرافکس" >}}
