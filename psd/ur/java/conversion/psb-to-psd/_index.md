---
title: جاوا کے ذریعے PSB کو PSD میں تبدیل کریں۔
weight: 160
description: نمونہ جاوا کنورژن کوڈ PSB فارمیٹ کے لیے PSD فائل میں۔ کسی بھی ویب یا ڈیسک ٹاپ جاوا پر مبنی ایپلیکیشن کے اندر PSB کو PSD میں تبدیل کرنے کے لیے اس مثالی کوڈ کا استعمال کریں۔
url: ur/java/conversion/psb-to-psd/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="جاوا کے ذریعے PSB کو PSD میں تبدیل کریں۔" h2="جاوا فوٹوشاپ API برائے PSB سے PSD کی تبدیلی" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PSD" pfName="Aspose.PSD" subTitlepfName="جاوا کے لیے" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSB" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="جاوا کے ذریعے PSB کو PSD میں تبدیل کرنے کے اقدامات" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD API ڈویلپرز کے لیے PSB فائل کو PSD میں کوڈ کی صرف چند لائنوں میں تبدیل کرنا آسان بناتا ہے۔

{{% /blocks/products/pf/agp/text %}}

- PSB فائل لوڈ کریں۔
- [PsdOptions کلاس] (https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/PsdOptions) کی ایک مثال بنائیں۔
- تبدیلی کے لیے Image.save(String, PsdOptions) طریقہ استعمال کریں۔
...
{{% blocks/products/pf/agp/code-block title="PSB کو PSD میں تبدیل کریں - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="PSB سے PSD کنورژن لائیو ڈیمو" sectionDescription="[PSB کو PSD میں تبدیل کریں](https://products.aspose.app/psd/conversion/psb-to-psd) ابھی ہماری لائیو ڈیمو ویب سائٹ پر جا کر۔ لائیو ڈیمو کے درج ذیل فوائد ہیںAspose API ڈاؤن لوڈ کرنے کی ضرورت نہیں ہے۔" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" کوئی کوڈ لکھنے کی ضرورت نہیں۔" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" بس اپنی PSB فائل اپ لوڈ کریں، یہ فوری طور پر PSD میں تبدیل ہو جائے گی۔" >}}
