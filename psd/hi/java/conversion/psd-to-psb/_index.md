---
title: जावा के माध्यम से PSD को PSB में बदलें
weight: 280
description: पीएसबी फ़ाइल में PSD प्रारूप के लिए नमूना जावा रूपांतरण कोड। किसी भी वेब या डेस्कटॉप जावा आधारित एप्लिकेशन में PSD को PSB में बदलने के लिए इस उदाहरण कोड का उपयोग करें।
url: hi/java/conversion/psd-to-psb/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1=" जावा के माध्यम से PSD को PSB में बदलें" h2=" Adobe Photoshop की आवश्यकता के बिना किसी भी Java अनुप्रयोगों के भीतर PSD को PSB में पढ़ें और बदलें।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PSB" pfName=" Aspose.PSD" subTitlepfName=" जावा के लिए" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSD" >}}
...
{{% blocks/products/pf/agp/content h2=" जावा का उपयोग करके PSD को PSB में कैसे बदलें" %}}
 ...
 पीएसबी को पीएसडी रेंडर करने के लिए, हम उपयोग करेंगे
...
{{% blocks/products/pf/agp/feature-section-col title="जावा के माध्यम से PSD को पीएसबी में बदलने के लिए कदम" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD API डेवलपर्स के लिए कोड की कुछ ही पंक्तियों में PSD फ़ाइल को PSB में कनवर्ट करना आसान बनाता है।

{{% /blocks/products/pf/agp/text %}}

1. छवि लोड विधि के साथ PSD फ़ाइल लोड करें
1. छवि वस्तु को PsdImage पर कास्ट करें
1. आउटपुट फ़ाइल पथ और PsdOptions के एक उदाहरण के साथ PsdImage.save विधि को कॉल करें
...
{{% blocks/products/pf/agp/code-block title="PSD को PSB - Java में बदलें" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="PSD से PSB रूपांतरण लाइव डेमो" sectionDescription="[PSB को PSB में बदलें](https://products.aspose.app/psd/conversion/psd-to-psb) अभी हमारी लाइव डेमो वेबसाइट पर जाकर। लाइव डेमो के निम्नलिखित लाभ हैं" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" बस अपनी PSD फ़ाइल अपलोड करें, इसे तुरंत PSB में बदल दिया जाएगा।" >}}
