---
title: जावा के माध्यम से एआई को पीएनजी में बदलें
description: पीएनजी फ़ाइल में एआई प्रारूप के लिए नमूना जावा रूपांतरण कोड। किसी भी वेब या डेस्कटॉप जावा आधारित एप्लिकेशन में AI को PNG में बदलने के लिए इस उदाहरण कोड का उपयोग करें।
---
...
{{% blocks/products/pf/agp/feature-section-col title="जावा के माध्यम से एआई को पीएनजी में बदलने के लिए कदम" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD API डेवलपर्स के लिए कोड की कुछ ही पंक्तियों में AI फ़ाइल को PNG में बदलना आसान बनाता है।

{{% /blocks/products/pf/agp/text %}}

- लोड इनपुट एआई छवि
- [PngOptions] (https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/pngOptions) क्लास ऑब्जेक्ट को इनिशियलाइज़ करें
- छवि गुण निर्दिष्ट करें
- आउटपुट पीएनजी छवि सहेजें
...
{{% blocks/products/pf/agp/code-block title="एआई को पीएनजी में बदलें - जावा" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="AI से PNG रूपांतरण लाइव डेमो" sectionDescription="[AI को PNG में बदलें](https://products.aspose.app/psd/conversion/ai-to-png) अभी हमारी लाइव डेमो वेबसाइट पर जाकर। लाइव डेमो के निम्नलिखित लाभ हैं" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" बस अपनी एआई फ़ाइल अपलोड करें, यह तुरंत पीएनजी में परिवर्तित हो जाएगी।" >}}
