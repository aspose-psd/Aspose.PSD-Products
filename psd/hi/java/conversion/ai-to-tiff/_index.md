---
title: जावा के माध्यम से एआई को टीआईएफएफ में बदलें
description: एआई प्रारूप के लिए टीआईएफएफ फ़ाइल के लिए नमूना जावा रूपांतरण कोड। किसी भी वेब या डेस्कटॉप जावा आधारित एप्लिकेशन में AI को TIFF में बदलने के लिए इस उदाहरण कोड का उपयोग करें।
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1=" जावा के माध्यम से एआई को टीआईएफएफ में बदलें" h2=" एडोब की आवश्यकता के बिना एआई को पढ़ने, लिखने और एआई को टीआईएफएफ में निर्यात करने के लिए नेटिव जावा लाइब्रेरी।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="Aspose.PSD" subTitlepfName=" जावा के लिए" downloadUrl="" fileiconsmall1="TIFF" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AI" >}}
...
{{% blocks/products/pf/agp/feature-section-col title=" जावा के माध्यम से एआई को टीआईएफएफ में बदलने के लिए कदम" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD API डेवलपर्स के लिए कोड की कुछ ही पंक्तियों में AI फ़ाइल को TIFF में कनवर्ट करना आसान बनाता है।

{{% /blocks/products/pf/agp/text %}}

- लोड इनपुट एआई छवि
- [TiffOptions] (https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/tiffOptions) क्लास ऑब्जेक्ट को इनिशियलाइज़ करें
...
{{% blocks/products/pf/agp/code-block title="एआई को टीआईएफएफ में बदलें - जावा" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="एआई टू टीआईएफएफ रूपांतरण लाइव डेमो" sectionDescription=" [एआई को टीआईएफएफ में बदलें](https://products.aspose.app/psd/conversion/ai-to-tiff) अभी हमारी लाइव डेमो वेबसाइट पर जाकर। लाइव डेमो के निम्नलिखित लाभ हैं" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" बस अपनी एआई फ़ाइल अपलोड करें, इसे तुरंत टीआईएफएफ में बदल दिया जाएगा।" >}}
