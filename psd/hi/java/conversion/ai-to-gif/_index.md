---
title: जावा के माध्यम से AI को GIF में बदलें
description: AI प्रारूप के लिए GIF फ़ाइल के लिए नमूना जावा रूपांतरण कोड। किसी भी वेब या डेस्कटॉप जावा आधारित एप्लिकेशन के भीतर AI को GIF में बदलने के लिए इस उदाहरण कोड का उपयोग करें।
url: java/conversion/ai-to-gif/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/upper-banner h1="जावा के माध्यम से AI को GIF में बदलें" h2="Adobe की आवश्यकता के बिना GIF को AI को पढ़ने, लिखने और निर्यात करने के लिए मूल जावा लाइब्रेरी।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="Aspose.PSD" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="GIF" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AI" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD API डेवलपर्स के लिए कोड की कुछ पंक्तियों में AI फ़ाइल को GIF में बदलना आसान बनाता है।

{{% /blocks/products/pf/agp/text %}}

- इनपुट AI छवि लोड करें
- इनिशियलाइज़ करें [GIF विकल्प](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/gifOptions) क्लास ऑब्जेक्ट
- छवि गुणों को निर्दिष्ट करें
- आउटपुट GIF इमेज सेव करें
...
{{% blocks/products/pf/agp/code-block title="AI को GIF में बदलें - जावा" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="AI से GIF रूपांतरण लाइव डेमो" sectionDescription="[AI को GIF में कन्वर्ट करें](https://products.aspose.app/psd/conversion/ai-to-gif) अभी हमारी लाइव डेमो वेबसाइट पर जाकर। लाइव डेमो के निम्नलिखित लाभ हैं" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="बस अपनी AI फ़ाइल अपलोड करें, यह तुरंत GIF में परिवर्तित हो जाएगी।" >}}
