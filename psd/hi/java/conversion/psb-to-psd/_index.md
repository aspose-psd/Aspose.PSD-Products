---
title: जावा के माध्यम से पीएसबी को पीएसडी में बदलें
weight: 160
description: पीएसबी प्रारूप के लिए पीएसडी फ़ाइल के लिए नमूना जावा रूपांतरण कोड। किसी भी वेब या डेस्कटॉप जावा आधारित एप्लिकेशन में PSB को PSD में बदलने के लिए इस उदाहरण कोड का उपयोग करें।
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1=" जावा के माध्यम से PSB को PSD में बदलें" h2=" पीएसबी से पीएसडी रूपांतरण के लिए जावा फोटोशॉप एपीआई" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PSD" pfName="असोस करें।PSD" subTitlepfName=" जावा के लिए" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSB" >}}
...
{{% blocks/products/pf/agp/content h2=" जावा का उपयोग करके PSB को PSD में कैसे बदलें" %}}

 PSB को PSD में रेंडर करने के लिए, हम उपयोग करेंगे
...
{{% blocks/products/pf/agp/feature-section-col title=" जावा के माध्यम से PSB को PSD में बदलने के चरण" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD API डेवलपर्स के लिए कोड की कुछ ही पंक्तियों में PSB फ़ाइल को PSD में कनवर्ट करना आसान बनाता है।

{{% /blocks/products/pf/agp/text %}}

- पीएसबी फाइल लोड करें
- [PsdOptions वर्ग] (https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/PsdOptions) का एक उदाहरण बनाएं।
- रूपांतरण के लिए Image.save(String, PsdOptions) विधि का उपयोग करें।
...
{{% blocks/products/pf/agp/code-block title="पीएसबी को पीएसडी में बदलें - जावा" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="PSB से PSD रूपांतरण लाइव डेमो" sectionDescription="[पीएसबी को पीएसडी में बदलें](https://products.aspose.app/psd/conversion/psb-to-psd) अभी हमारी लाइव डेमो वेबसाइट पर जाएं। लाइव डेमो के निम्नलिखित लाभ हैं" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" बस अपनी पीएसबी फ़ाइल अपलोड करें, यह तुरंत PSD में परिवर्तित हो जाएगी।" >}}
