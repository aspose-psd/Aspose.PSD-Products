...
weight: 40
description: PSB प्रारूप के लिए TIFF फ़ाइल के लिए नमूना जावा रूपांतरण कोड। किसी भी वेब या डेस्कटॉप जावा आधारित एप्लिकेशन के भीतर PSB को TIFF में बदलने के लिए इस उदाहरण कोड का उपयोग करें।
url: java/conversion/psb-to-tiff/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/upper-banner h1="जावा के माध्यम से PSB को TIFF में कनवर्ट करें" h2="पीएसबी रूपांतरण के लिए जावा फोटोशॉप एपीआई टीआईएफएफ सहित रास्टर छवियों के लिए" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="Aspose.PSD" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSB" >}}
...
{{% blocks/products/pf/agp/content h2="जावा का उपयोग करके PSB को TIFF में कैसे बदलें" %}}
 ...
 PSB को TIFF में रेंडर करने के लिए, हम इसका उपयोग करेंगे
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD API डेवलपर्स के लिए PSB फ़ाइल को कोड की कुछ पंक्तियों में TIFF में बदलना आसान बनाता है।

{{% /blocks/products/pf/agp/text %}}

- PSB फ़ाइल लोड करें
- का एक उदाहरण बनाएं [टिफ़ऑप्शन क्लास](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/TiffOptions)
- रूपांतरण के लिए Image.save (स्ट्रिंग, TiffOptions) विधि का उपयोग करें।
...
{{% blocks/products/pf/agp/code-block title="PSB को TIFF में बदलें - जावा" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="PSB से TIFF रूपांतरण लाइव डेमो" sectionDescription="[PSB को TIFF में कन्वर्ट करें](https://products.aspose.app/psd/conversion/psb-to-tiff) अभी हमारी लाइव डेमो वेबसाइट पर जाकर। लाइव डेमो के निम्नलिखित लाभ हैं" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="बस अपनी PSB फ़ाइल अपलोड करें, यह तुरंत TIFF में परिवर्तित हो जाएगी।" >}}
