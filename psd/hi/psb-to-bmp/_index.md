---
title: PSB को BMP में C# के साथ कन्वर्ट करें
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C# के माध्यम से PSB को BMP में बदलें" h2="PSD और PSB रूपांतरण के लिए .NET Photoshop API BMP सहित रास्टर छवियों में रूपांतरण" >}}
...
1। छवि से ग्राफ़िक्स का एक उदाहरण बनाएं। [BmP के विकल्प](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/bmpoptions) वर्ग
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# कोड PSB से BMP रूपांतरण के लिए" gistPath="" %}}
