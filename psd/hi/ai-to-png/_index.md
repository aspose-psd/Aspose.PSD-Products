...
{{% blocks/products/pf/agp/feature-section-col title="C# के माध्यम से AI को PNG में बदलने के चरण" %}}
...
1। का एक उदाहरण बनाएं [PNG के विकल्प](https://reference.aspose.com/psd/net/aspose.psd.imageoptions/pngoptions/) वर्ग
...
{{< blocks/products/pf/agp/demobox sectionTitle="AI को PNG में बदलने के लिए फ्री ऐप" sectionDescription="हमारे लाइव डेमो की जांच करें [AI से PNG रूपांतरण](https://products.aspose.app/psd/conversion/ai-to-png) निम्नलिखित लाभों के साथ।" >}}
