...
1। छवि से ग्राफ़िक्स का एक उदाहरण बनाएं। [PDF के विकल्प](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/PdfOptions) वर्ग
...
{{< blocks/products/pf/agp/demobox sectionTitle="AI को PDF में बदलने के लिए निःशुल्क ऐप" sectionDescription="Check our live demos for [AI to PDF conversion](https://products.aspose.app/psd/conversion/ai-to-pdf) with following benefits." >}}
