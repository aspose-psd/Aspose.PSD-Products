...
1। छवि से ग्राफ़िक्स का एक उदाहरण बनाएं। [BmP के विकल्प](https://apireference.aspose.com/imaging/net/aspose.imaging.imageoptions/bmpoptions) वर्ग
...
{{< blocks/products/pf/agp/demobox sectionTitle="AI को BMP में बदलने के लिए फ्री ऐप" sectionDescription="Check our live demos for [AI to BMP conversion](https://products.aspose.app/psd/conversion/ai-to-bmp) with following benefits." >}}
