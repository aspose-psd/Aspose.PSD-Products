---
title: सी#के साथ PSD को JP2 में बदलें
...
url: hi/net/conversion/psd-to-jp2/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="C# के माध्यम से PSD को JP2 में बदलें" h2=" PSD और पीएसबी के लिए नेट फोटोशॉप एपीआई JP2 सहित रेखापुंज छवियों में रूपांतरण">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=" JP2 के रूप में PSD का उच्च गुणवत्ता प्रतिपादन" %}}
...
{{% blocks/products/pf/agp/code-autogen title=" .NET C# कोड PSD के लिए JP2 रूपांतरण" gistPath="" %}}
