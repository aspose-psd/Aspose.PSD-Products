---
title: PSD को C# के साथ JP2 में कनवर्ट करें
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PSD को C# के माध्यम से JP2 में कनवर्ट करें" h2="PSD और PSB रूपांतरण के लिए .NET Photoshop API JP2 सहित रास्टर छवियों में रूपांतरण" >}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# कोड PSD से JP2 रूपांतरण के लिए" gistPath="" %}}
