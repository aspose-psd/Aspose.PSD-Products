---
title: सी#के माध्यम से एआई को जेपीईजी में बदलें
description: AI से JPEG C# रूपांतरण के लिए नमूना कोड। VB.NET, Asp.NET या किसी .NET आधारित एप्लिकेशन के भीतर JPEG रूपांतरण में बैच AI फ़ाइलों के लिए API उदाहरण कोड का उपयोग करें।
url: hi/net/conversion/ai-to-jpeg/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1=" AI को JPEG में C# के माध्यम से बदलें" h2="" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName=" Aspose.PSD" subTitlepfName=" .NET . के लिए" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PSD" fileiconsmall4="XML" fileiconsmall5="AI" >}}
...
{{% blocks/products/pf/agp/content h2="सी#का उपयोग करके AI को JPEG में कैसे बदलें" %}}

AI को JPEG में बदलने के लिए, हम उपयोग करेंगे<a href="/psd/{{< lang-code >}}net"> .NET के लिए Aspose.PSD</a> एपीआई जो सी # प्लेटफॉर्म के लिए एक सुविधा संपन्न, शक्तिशाली और उपयोग में आसान दस्तावेज़ हेरफेर और रूपांतरण एपीआई है। खुला<a href="https://www.nuget.org/packages/aspose.psd">नुगेट</a> पैकेज मैनेजर, के लिए खोजें<b> Aspose.PSD</b> और स्थापित करें। आप पैकेज मैनेजर कंसोल से निम्न कमांड का भी उपयोग कर सकते हैं।
...
{{% blocks/products/pf/agp/feature-section-col title=" सी# के माध्यम से एआई को जेपीईजी में बदलने के चरण" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD डेवलपर्स के लिए कोड की कुछ ही पंक्तियों में AI फ़ाइलों को JPEG में लोड और कनवर्ट करना आसान बनाता है।
...
{{< blocks/products/pf/agp/demobox sectionTitle=" एआई को जेपीईजी में बदलने के लिए मुफ्त ऐप" sectionDescription=" [AI से JPEG रूपांतरण] (https://products.aspose.app/psd/conversion/ai-to-jpeg) के लिए निम्नलिखित लाभों के साथ हमारे लाइव डेमो देखें।" >}}
