---
title: C# .NET Photoshop Manipulasi API - Aspose
weight: 90
description: C# ASP.NET VB.NET Photoshop perpustakaan untuk membuat mengedit dan mengkonversi format Photoshop PSD PSB
url: net/
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1="API .NET untuk Memanipulasi File Photoshop" h2="Buat, Baca, Edit, dan Konversi file PSD & PSB tanpa dependensi Adobe Photoshop." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/headers/aspose_psd-for-net.svg" pfName="Aspose.PSD" subTitlepfName="for .NET" downloadUrl="https://releases.aspose.com/psd/net" >}}
...
<p>Aspose.PSD untuk .NET adalah PSD canggih dan entry level AI file format manipulasi API tanpa Adobe Photoshop atau Adobe Illustrator dependensi. API memungkinkan untuk membuat dan mengedit file Photoshop serta menyediakan kemampuan untuk memperbarui properti lapisan, menambahkan tanda air, melakukan operasi grafis atau mengonversi satu format file ke format lainnya.</p>
...
<p>
 ...
 bersama dengan ekspor ke Pdf dengan teks yang dapat dipilih. Aspose.PSD sebagian mendukung fitur Adobe Photoshop seperti Adjustment Layers, Text Layer rendering dan editing, Fill Layers, Layers Effects, Editing of Raster dan Vector Masks untuk layer.
</p>
...
<div class="diagram1 d1-net">
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt=“.NET PSD Pengolahan API” src="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-net.svg" />
  <header>
   Aspose.PSD
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Kemandirian Platform" description="Aspose.PSD untuk .NET mendukung kerangka .NET mulai dari 2.0." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
...
{{< blocks/products/pf/carousel-item h3="Format File yang Didukung" description="Aspose.PSD untuk .NET mendukung format file [Photoshop & raster image] (https://docs.aspose.com/psd/net/supported-file-formats/) yang paling populer." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Canggih .NET PSD Manipulasi Fitur API
   </h2>
   <p>
    &amp;nbsp
   </p>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/converting-psd-image-to-raster-format/">Mengkonversi file Photoshop ke gambar</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/creating-opening-and-saving-images/">Memuat file Photoshop yang ada</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/cropping-psd-file-while-converting-to-png/">Klip ke daerah persegi panjang</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/drawing-images/">Menggambar & mengisi bentuk dasar</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/manipulating-adobe-photoshop-formats/?#merge-psd-layers-into-other-layers-1">Gabungkan lapisan</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/layers-and-mask-information-section/#supported-layers">Dukungan Layers</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/converting-psd-image-to-raster-format/">File PSD Preview Pixel-Sempurna Mengekspor</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/manipulating-adobe-photoshop-formats/#support-layer-effects-at-runtime">Menerapkan Layer Effects</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Tanggal dan Waktu Pembuatan Lapisan
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/working-with-text-layers/#update-text-layer-in-psd-file">Pembaruan Lapisan Teks saat Runtime</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/manipulating-adobe-photoshop-formats/#support-of-adjustment-layers">Dukungan Penyesuaian Layers</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/manipulating-adobe-photoshop-formats/#manage-channel-mixer-adjust-layers">Lapisan Penyesuaian Mixer Saluran</a>
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/manipulating-adobe-photoshop-formats/#manage-exposure-layers">Lapisan Penyesuaian Eksposur</a>
    </p>
   </div>
   <div class="col-lg-4"><em class="fa fa-align-right ico-blue fa-2x col-lg-2"></em><p class="col-lg-10">
      ...
      Lapisan Penyesuaian Hue/Saturasi
      </a></p></div>
   <div class="col-lg-4">
    <em class="fa fa-file-code-o ico-blue fa-2x col-lg-2">
    </em>
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/modifying-images/#invert-adjustment-layer">Balikkan Penyesuaian Lapisan</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/manipulating-adobe-photoshop-formats/#add-level-adjustment-layers">Tingkat Penyesuaian Lapisan</a>
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-paint-brush ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/manipulating-adobe-photoshop-formats/#support-of-clipping-mask">Rendering Masker Kliping</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/layer-vector-mask/">Runtime rasterisasi Masker Lapisan Vektor</a>
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-pencil-square-o ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/editing-raster-layer-masks-in-psd-file-via-api/">Pengeditan Raster Layer Masks</a>
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-clone ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/manipulating-adobe-photoshop-formats/#manage-opacity-of-layers">Mengelola Opacity Layers & Ratakan Layers</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/list-of-psd-layer-resources/">Dukungan dari sejumlah besar Sumber Daya Layer</a>
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/list-of-the-supported-psd-global-image-resources/">Dukungan dari sejumlah besar Sumber Daya Bagian Gambar</a>
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-pencil-square-o ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/working-with-layers/#support-of-linked-layers">Menambahkan dan menghapus Linked Layers</a>
    </p>
   </div>
   <div class="col-lg-4">
...
<li>Rendering of Stroke effect with Color Fill for export</li>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Akses & Memanipulasi Layers PSD
    </h2>
    <p>
     Aspose.PSD untuk .NET memungkinkan Anda mengakses lapisan PSD dengan kemampuan untuk menggambar di atasnya dengan gambar atau teks. Anda dapat menggabungkan lapisan, memperbarui teks pada lapisan, mengatur efek atau mengekspor lapisan sebagai gambar. Anda juga dapat menggunakan PSD .NET API untuk mendeteksi diratakan file PSD atau membuat thumbnail.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.PSD untuk .NET tidak hanya mendukung pemuatan PSD & PSB format file untuk manipulasi & konversi tetapi juga menyediakan kemampuan untuk membuat PSD & PSB file dari awal. pengembang .NET dapat menggunakan API untuk mengotomatisasi skenario yang dapat membantu mereka dalam perjalanan mereka.
    </p>
    <div class="codeblock" id="code">
     <h3>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.PSD untuk .NET menyediakan fitur pencitraan inti seperti penyesuaian warna melalui perpustakaan kelasnya. Pengembang dapat dengan mudah menyesuaikan kecerahan, kontras atau gamma pada gambar raster yang dimuat oleh API. Selain itu, pengembang dapat secara dinamis mengacaukan atau mengaburkan gambar serta menggunakan filter populer termasuk Median, Gauss Wiener, Motion Wiener dan Bradley Threshold.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-tab tabTitle="Mengapa Aspose.PSD untuk .NET?" tabId="success-stories" >}}
