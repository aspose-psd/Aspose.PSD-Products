---
title: Konversi PSB ke GIF dengan C#
...
url: id/net/conversion/psb-to-gif/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konversi PSB ke GIF melalui C#" h2=".NET Photoshop API untuk PSD & PSB Konversi ke gambar raster termasuk GIF">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Rendering Kualitas Tinggi dari PSB sebagai GIF" %}}
1. Muat PSB dengan metode [Image.Load](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index)
1. Buat instance kelas [GifOptions](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/gifoptions)
1. Panggil metode [Image.Save](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/save/index)
1. Lewati nama file keluaran dan objek GifOptions
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# Code untuk Konversi PSB ke GIF" gistPath="" %}}
