---
title: PSB'yi Java ile BMP'ye dönüştürün
weight: 300
description: PSB formatı için BMP dosyasına örnek Java dönüştürme kodu. Herhangi bir Web veya Masaüstü Java tabanlı uygulamada PSB'yi BMP'ye dönüştürmek için bu örnek kodu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="PSB'yi Java ile BMP'ye dönüştürün" h2="PSB için Java Photoshop API'si BMP dahil raster görüntülere dönüştürme" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="Aspose.PSD" subTitlepfName="Java için" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSB" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak PSB'yi BMP'ye Dönüştürme" %}}
 ...
 PSB'yi BMP'ye dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="PSB'yi Java ile BMP'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD API, geliştiricilerin PSB dosyasını sadece birkaç satır kodla BMP'ye dönüştürmesini kolaylaştırır.
...
{{% blocks/products/pf/agp/code-block title="PSB'yi BMP'ye dönüştürün - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="PSB'den BMP'ye Dönüştürme Canlı Demoları" sectionDescription="[PSB'yi BMP'ye dönüştürün](https://products.aspose.app/psd/conversion/psb-to-bmp) hemen şimdi Canlı Demolar web sitemizi ziyaret edin.Canlı demo aşağıdaki avantajlara sahiptir" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/psd/java/conversion/psb-to-png/" name="PSB TO PNG" description="Taşınabilir Ağ Grafikleri" >}}
