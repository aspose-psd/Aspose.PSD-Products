---
title: Java ile PSB'yi JPEG'e dönüştürün
weight: 180
...
{{< blocks/products/pf/upper-banner h1="PSB'yi Java ile JPEG'e dönüştürün" h2="PSB için Java Photoshop API'si JPEG dahil raster görüntülere dönüştürme" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="Aspose.PSD" subTitlepfName="Java için" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSB" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD API, geliştiricilerin PSB dosyasını sadece birkaç satır kodla JPEG'e dönüştürmesini kolaylaştırır.
...
{{% blocks/products/pf/agp/code-block title="PSB'yi JPEG'e dönüştürün - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="PSB'den JPEG'e Dönüştürme Canlı Demoları" sectionDescription="[PSB'yi JPEG'e dönüştürün](https://products.aspose.app/psd/conversion/psb-to-jpeg) hemen şimdi Canlı Demolar web sitemizi ziyaret edin.Canlı demo aşağıdaki avantajlara sahiptir" >}}
