---
title: Java ile PSD'yi TIFF'ye dönüştürün
weight: 170
description: PSD formatı için TIFF dosyasına örnek Java dönüştürme kodu. Herhangi bir Web veya Masaüstü Java tabanlı uygulamada PSD'yi TIFF'ye dönüştürmek için bu örnek kodu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="PSD'yi Java ile TIFF'ye dönüştürün" h2=" TIFF dahil olmak üzere raster görüntülere PSD Dönüşümü için Java Photoshop API" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="Aspose.PSD" subTitlepfName="Java için" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSD" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak PSD'yi TIFF'e Dönüştürme" %}}

 PSD'yi TIFF'e dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="PSD'yi Java ile TIFF'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD API, geliştiricilerin PSD dosyasını sadece birkaç satır kodla TIFF'e dönüştürmesini kolaylaştırır.
...
{{% blocks/products/pf/agp/code-block title="PSD'yi TIFF'ye dönüştürün - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="PSD'den TIFF'ye Dönüşüm Canlı Demoları" sectionDescription="[PSD'yi TIFF'ye dönüştürün](https://products.aspose.app/psd/conversion/psd-to-tiff) hemen şimdi Canlı Demolar web sitemizi ziyaret ederek.Canlı demo aşağıdaki avantajlara sahiptir" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API'yi indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece PSD dosyanızı yükleyin, anında TIFF'e dönüştürülecektir." >}}
