---
title: AI'yı Java ile JPEG2000'e dönüştürün
description: AI formatı için JPEG2000 dosyasına örnek Java dönüştürme kodu. Herhangi bir Web veya Masaüstü Java tabanlı uygulamada AI'yi JPEG2000'e dönüştürmek için bu örnek kodu kullanın.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="AI'yi Java ile JPEG2000'e dönüştürün" h2="Adobe'ye ihtiyaç duymadan AI'yı Okumak, Yazmak ve JPEG2000'e Dışa Aktarmak için Yerel Java Kitaplığı." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG2000" pfName="Aspose.PSD" subTitlepfName="Java için" downloadUrl="" fileiconsmall1="JPEG2000" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AI" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak AI'yi JPEG2000'e Dönüştürme" %}}
...
<version>aspose-psd API'nin sürümü</version>
...
{{% blocks/products/pf/agp/feature-section-col title="AI'yi Java ile JPEG2000'e Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD API, geliştiricilerin AI dosyasını sadece birkaç satır kodla JPEG2000'e dönüştürmesini kolaylaştırır.

{{% /blocks/products/pf/agp/text %}}

- Giriş AI görüntüsünü yükle
- [Jpeg2000Options](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/jpeg2000Options) sınıf nesnesini başlatın
- Görüntü özelliklerini belirtin
- Çıktı JPEG2000 görüntüsünü kaydet
...
{{% blocks/products/pf/agp/code-block title="AI'yi JPEG2000'e dönüştürün - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="AI'den JPEG2000'e Dönüştürme Canlı Demoları" sectionDescription="[AI'yi JPEG2000'e dönüştürün](https://products.aspose.app/psd/conversion/ai-to-jpeg2000) hemen şimdi Canlı Demolar web sitemizi ziyaret edin.Canlı demo aşağıdaki avantajlara sahiptir" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API'sini indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" AI dosyanızı yükleyin, anında JPEG2000'e dönüştürülecektir." >}}
