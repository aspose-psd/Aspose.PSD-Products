---
title: C# ile PSB'yi PNG'ye dönüştürün
...
url: tr/net/conversion/psb-to-png/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="PSB'yi C# ile PNG'ye dönüştürün" h2=".PSD ve PSB için NET Photoshop API PNG dahil raster görüntülere dönüştürme">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PSB'nin PNG Olarak Yüksek Kaliteli Oluşturulması" %}}
...
{{% blocks/products/pf/agp/code-autogen title=".PSB'den PNG'ye Dönüştürme için NET C# Kodu" gistPath="" %}}
