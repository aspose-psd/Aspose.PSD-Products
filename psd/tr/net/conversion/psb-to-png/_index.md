---
title: PSB'yi C# ile PNG'ye dönüştürün
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PSB'yi PNG'ye C# ile dönüştürün" h2=".NET Photoshop API PSD & PSB Dönüşüm raster görüntüleri PNG dahil olmak üzere" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PSB'nin PNG Olarak Yüksek Kalitede Oluşturulması" %}}
1. PSB'yi [Image.Load](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) yöntem
1. Bir örneği oluşturun [PNGOptions](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/pngoptions) sınıf
...
Alternatively, get the offline MSI installer or DLLs in a ZIP file from [i̇ndirilenler](https://releases.aspose.com/psd/net).
{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-autogen title=".NET C# kodu PSB PNG dönüştürme için" gistPath="" %}}
