...
1. Yapay zekayı yükleyin [Image.Load](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) yöntem
 [PDFOptions](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/PdfOptions) sınıf
...
{{< blocks/products/pf/agp/demobox sectionTitle="AI'yı PDF'ye Dönüştürmek için Ücretsiz Uygulama" sectionDescription="Check our live demos for [AI to PDF conversion](https://products.aspose.app/psd/conversion/ai-to-pdf) with following benefits." >}}
