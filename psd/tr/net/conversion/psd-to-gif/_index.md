---
title: C# ile PSD'yi GIF'e dönüştürün
...
url: tr/net/conversion/psd-to-gif/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="PSD'yi C# ile GIF'e dönüştürün" h2=".PSD ve PSB için NET Photoshop API GIF dahil raster görüntülere dönüştürme">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PSD'nin GIF Olarak Yüksek Kalitede Oluşturulması" %}}
...
{{% blocks/products/pf/agp/code-autogen title=".PSD'den GIF'e Dönüştürme için NET C# Kodu" gistPath="" %}}
