...
weight: 240
description: PSB를 PSD C#으로 변환하기 위한 샘플 코드입니다.VB.NET, ASP.NET 또는 기타 .NET 기반 응용 프로그램 내에서 배치 PSB 파일을 PSD로 변환하는 데 사용할 수 있는 API 예제 코드를 사용하십시오.
url: psb-to-psd/
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD 를 사용하면 개발자가 단 몇 줄의 코드만으로 PSB 파일을 쉽게 로드하고 PSD로 변환할 수 있습니다.
...
{{% blocks/products/pf/agp/code-block title="이 샘플 코드는 PSB에서 PSD C#으로의 변환을 보여줍니다." offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="PSB를 PSD로 변환하는 무료 앱" sectionDescription="Check our live demos for [PSB to PSD conversion](https://products.aspose.app/psd/conversion/psb-to-psd) with following benefits." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="net/conversion/psb-to-gif/" name="PSB에서 GIF로" description="{{bmp _name}}" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="net/conversion/psb-to-jpeg/" name="PSB에서 JPEG로" description="{{bmp _name}}" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="net/conversion/psb-to-pdf/" name="PSB에서 PDF로" description="{{bmp _name}}" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="net/conversion/psb-to-png/" name="PSB에서 PNG로" description="{{bmp _name}}" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="net/conversion/psb-to-psd/" name="PSB에서 PSD로" description="{{bmp _name}}" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="net/conversion/psb-to-tiff/" name="PSB에서 티파니로" description="{{bmp _name}}" >}}
