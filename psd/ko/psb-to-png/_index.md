...
{{% blocks/products/pf/agp/feature-section-col title="PSB를 PNG로 만든 고품질 렌더링" %}}
1.다음과 같이 PSB를 로드하십시오. [이미지. 로드](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) 방법
1.이미지에서 Graphics 인스턴스를 생성합니다. [PNG 옵션](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/pngoptions) 수업
...
{{% blocks/products/pf/agp/code-autogen title="PSB를 PNG로 변환하기 위한 .NET C# 코드" gistPath="" %}}
