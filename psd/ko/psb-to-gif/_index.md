---
title: C#을 사용하여 PSB를 GIF로 변환하십시오
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C#을 통해 PSB를 GIF로 변환" h2="PSD 및 PSB를 위한 .NET 포토샵 API GIF를 포함한 래스터 이미지로 변환" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="PSB를 GIF로 만든 고품질 렌더링" %}}
1.다음과 같이 PSB를 로드하십시오. [이미지. 로드](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) 방법
1.이미지에서 Graphics 인스턴스를 생성합니다. [GIF 옵션](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/gifoptions) 수업
...
{{% blocks/products/pf/agp/code-autogen title="PSB를 GIF로 변환하기 위한 .NET C# 코드" gistPath="" %}}
