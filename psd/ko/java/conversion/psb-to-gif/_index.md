---
title: 자바를 통해 PSB를 GIF로 변환
weight: 220
description: PSB 형식을 GIF 파일로 변환하는 샘플 Java 변환 코드입니다.이 예제 코드를 사용하여 모든 웹 또는 데스크톱 Java 기반 응용 프로그램 내에서 PSB를 GIF로 변환할 수 있습니다.
...
{{% blocks/products/pf/agp/content h2="자바를 사용하여 PSB를 GIF로 변환하는 방법" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="자바를 통해 PSB를 GIF로 변환하는 단계" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD API를 사용하면 개발자가 몇 줄의 코드만으로 PSB 파일을 GIF로 쉽게 변환할 수 있습니다.
...
{{< blocks/products/pf/agp/demobox sectionTitle="PSB에서 GIF로 변환 라이브 데모" sectionDescription="[Convert PSB to GIF](https://products.aspose.app/psd/conversion/psb-to-gif) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
