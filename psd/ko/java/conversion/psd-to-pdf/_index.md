---
title: Java를 통해 PSD를 PDF로 변환
weight: 360
description: PSD 형식을 PDF 파일로 변환하는 샘플 Java 변환 코드. 이 예제 코드를 사용하여 웹 또는 데스크탑 Java 기반 응용 프로그램 내에서 PSD를 PDF로 변환합니다.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Java를 통해 PSD를 PDF로 변환" h2="PSD를 PDF로 변환하는 Java Photoshop API" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="아포즈.PSD" subTitlepfName="자바용" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSD" >}}
...
{{% blocks/products/pf/agp/content h2="Java를 사용하여 PSD를 PDF로 변환하는 방법" %}}

 PSD를 PDF로 렌더링하려면 다음을 사용합니다.
...
{{% blocks/products/pf/agp/feature-section-col title="Java를 통해 PSD를 PDF로 변환하는 단계" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD API를 사용하면 개발자가 몇 줄의 코드로 PSD 파일을 PDF로 쉽게 변환할 수 있습니다.

{{% /blocks/products/pf/agp/text %}}

- PSD 파일 로드
- [PdfOptions 클래스](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/PdfOptions)의 인스턴스를 생성합니다.
- 변환을 위해 Image.save(String, PdfOptions) 메소드를 사용하십시오.
...
{{% blocks/products/pf/agp/code-block title="PSD를 PDF로 변환 - 자바" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="PSD에서 PDF로 변환 라이브 데모" sectionDescription="[PSD를 PDF로 변환](https://products.aspose.app/psd/conversion/psd-to-pdf) 지금 바로 라이브 데모 웹사이트를 방문하세요. 라이브 데모에는 다음과 같은 이점이 있습니다." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API를 다운로드할 필요가 없습니다." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" 코드를 작성할 필요가 없습니다." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" PSD 파일을 업로드하기만 하면 즉시 PDF로 변환됩니다." >}}
