---
title: 자바를 통해 PSD를 PDF로 변환
weight: 360
description: PSD 형식을 PDF 파일로 변환하는 샘플 Java 변환 코드입니다.이 예제 코드를 사용하여 모든 웹 또는 데스크톱 Java 기반 응용 프로그램 내에서 PSD를 PDF로 변환할 수 있습니다.
url: psd-to-pdf/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/upper-banner h1="Convert PSD to PDF via Java" h2="PSD를 PDF로 변환하기 위한 자바 포토샵 API" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="Aspose.PSD" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSD" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD API를 사용하면 개발자가 단 몇 줄의 코드만으로 PSD 파일을 PDF로 쉽게 변환할 수 있습니다.
...
{{< blocks/products/pf/agp/demobox sectionTitle="PSD를 PDF로 변환 라이브 데모" sectionDescription="[Convert PSD to PDF](https://products.aspose.app/psd/conversion/psd-to-pdf) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
