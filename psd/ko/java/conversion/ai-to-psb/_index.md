---
title: Java를 통해 AI를 PSB로 변환
description: AI 형식을 PSB 파일로 변환하는 샘플 Java 변환 코드. 이 예제 코드를 사용하여 웹 또는 데스크탑 Java 기반 애플리케이션 내에서 AI를 PSB로 변환합니다.
url: ko/java/conversion/ai-to-psb/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="자바를 통해 AI를 PSB로 변환" h2="Adobe 없이도 AI를 읽고 쓰고 PSB로 내보낼 수 있는 기본 Java 라이브러리." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PSB" pfName="아포즈.PSD" subTitlepfName="자바용" downloadUrl="" fileiconsmall1="PSB" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AI" >}}
...
AI를 PSB로 렌더링하기 위해 다음을 사용합니다.<a href="/psd/{{< lang-code >}}java">자바용 Aspose.PSD</a> 기능이 풍부하고 강력하며 사용하기 쉬운 Java 플랫폼용 변환 API인 API입니다. 에서 직접 최신 버전을 다운로드할 수 있습니다.<a href="https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-psd">메이븐</a>을 만들고 pom.xml에 다음 구성을 추가하여 Maven 기반 프로젝트에 설치합니다.
...
{{% blocks/products/pf/agp/feature-section-col title="Java를 통해 AI를 PSB로 변환하는 단계" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD API를 사용하면 개발자가 몇 줄의 코드로 AI 파일을 PSB로 쉽게 변환할 수 있습니다.

{{% /blocks/products/pf/agp/text %}}

- 입력 AI 이미지 로드
- [PsdOptions](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/psdOptions) 클래스 객체 초기화
- 버전 지정
- 출력 PSB 파일 저장
...
{{% blocks/products/pf/agp/code-block title="AI를 PSB로 변환 - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="AI에서 PSB로의 변환 라이브 데모" sectionDescription="지금 바로 라이브 데모 웹사이트를 방문하여 [AI를 PSB로 변환](https://products.aspose.app/psd/conversion/ai-to-psb)하십시오. 라이브 데모에는 다음과 같은 이점이 있습니다." >}}
