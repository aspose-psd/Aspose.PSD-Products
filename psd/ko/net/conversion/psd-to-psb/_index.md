---
title: C#을 통해 PSD를 PSB로 변환
weight: 210
description: PSD에서 PSB C#으로의 변환을 위한 샘플 코드. VB.NET, Asp.NET 또는 모든 .NET 기반 응용 프로그램 내에서 배치 PSD 파일을 PSB로 변환하는 API 예제 코드를 사용합니다.
url: ko/net/conversion/psd-to-psb/
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD를 사용하면 개발자가 몇 줄의 코드로 PSD 파일을 쉽게 로드하고 PSB로 변환할 수 있습니다.

{{% /blocks/products/pf/agp/text %}}

1. Image.Load 메서드로 PSD 파일 로드
1. Image 개체를 PsdImage로 캐스트
1. 출력 파일 경로 및 PsdOptions 인스턴스를 사용하여 Image.Save 메서드를 호출합니다.
...
{{< blocks/products/pf/agp/demobox sectionTitle="PSD를 PSB로 변환하는 무료 앱" sectionDescription="[PSD에서 PSB로 변환](https://products.aspose.app/psd/conversion/psd-to-psb)에 대한 라이브 데모를 확인하고 다음 혜택을 받으세요." >}}
