...
url: ko/net/conversion/psd-to-jp2/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="C#을 통해 PSD를 JP2로 변환" h2=".NET Photoshop API PSD 및 PSB JP2를 포함한 래스터 이미지로 변환">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="JP2로 PSD의 고품질 렌더링" %}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# PSD에서 JP2로의 변환용 코드" gistPath="" %}}
