...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD를 사용하면 개발자가 몇 줄의 코드로 PSB 파일을 PDF로 로드 및 변환할 수 있습니다.
...
{{% blocks/products/pf/agp/code-block title="이 샘플 코드는 PSB에서 PDF로 C# 변환을 보여줍니다." offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="PSB를 PDF로 변환하는 무료 앱" sectionDescription="[PSB에서 PDF로 변환](https://products.aspose.app/psd/conversion/psb-to-pdf)에 대한 라이브 데모를 확인하고 다음과 같은 이점을 얻을 수 있습니다." >}}
