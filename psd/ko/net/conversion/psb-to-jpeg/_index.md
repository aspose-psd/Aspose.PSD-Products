...
url: ko/net/conversion/psb-to-jpeg/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="C#을 통해 PSB를 JPEG로 변환" h2=".NET Photoshop API PSD 및 PSB JPEG를 포함한 래스터 이미지로 변환">}}
...
{{% blocks/products/pf/agp/code-autogen title="PSB에서 JPEG로의 변환을 위한 .NET C# 코드" gistPath="" %}}
