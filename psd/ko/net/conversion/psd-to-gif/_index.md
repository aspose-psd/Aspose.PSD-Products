...
url: ko/net/conversion/psd-to-gif/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="C#을 통해 PSD를 GIF로 변환" h2=".NET Photoshop API PSD 및 PSB GIF를 포함한 래스터 이미지로 변환">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="GIF로 PSD의 고품질 렌더링" %}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# PSD에서 GIF로 변환하는 코드" gistPath="" %}}
