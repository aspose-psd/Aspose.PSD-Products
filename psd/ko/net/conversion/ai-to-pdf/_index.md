...
1.인스턴스 만들기 [PDF 옵션](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/PdfOptions) 수업
...
{{< blocks/products/pf/agp/demobox sectionTitle="AI를 PDF로 변환하는 무료 앱" sectionDescription="라이브 데모를 확인하세요 [인공지능을 PDF로 변환](https://products.aspose.app/psd/conversion/ai-to-pdf) 다음과 같은 혜택이 있습니다." >}}
