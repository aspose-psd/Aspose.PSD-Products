...
weight: 210
description: نموذج التعليمات البرمجية لتحويل PSD إلى PSB C#. استخدم رمز مثال API لملفات PSD المجمعة لتحويل PSB داخل VB.NET أو ASP.Net أو أي تطبيق يستند إلى .NET.
url: psd-to-psb/
---
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل PSD إلى PSB باستخدام جافا" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD يجعل من السهل على المطورين تحميل وتحويل ملفات PSD إلى PSB في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف PSD باستخدام طريقة Image.Load
1. قم بإرسال كائن الصورة إلى PSDIImage
...
{{% blocks/products/pf/agp/code-block title="يُظهر نموذج التعليمة البرمجية هذا تحويل PSD إلى PSB C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="تطبيق مجاني لتحويل PSD إلى PSB" sectionDescription="Check our live demos for [PSD to PSB conversion](https://products.aspose.app/psd/conversion/psd-to-psb) with following benefits." >}}
