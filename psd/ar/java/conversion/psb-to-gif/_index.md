...
weight: 220
description: نموذج كود تحويل Java لتنسيق PSB إلى ملف GIF. استخدم رمز المثال هذا لتحويل PSB إلى GIF داخل أي تطبيق يستند إلى Java على الويب أو سطح المكتب.
url: java/conversion/psb-to-gif/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/upper-banner h1="تحويل PSB إلى GIF عبر جافا" h2="واجهة برمجة تطبيقات جافا فوتوشوب لتحويل PSB إلى الصور النقطية بما في ذلك GIF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="Aspose.PSD" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSB" >}}

{{< blocks/products/pf/main-container pfName="Aspose.PSD " subTitlepfName="for Java" >}}
{{< blocks/products/pf/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-psd" liveDemosLink="https://products.aspose.app/psd/family" docsLink="https://docs.aspose.com/psd/java" installationsDocsLink="https://docs.aspose.com/psd/java" nugetLink="" nugetPackageName="" downloadAsLink="https://releases.aspose.com/psd/java" learnAsLink="https://docs.aspose.com/psd/java" apiReference="" mavenRepoLink="https://repository.aspose.com/psd/" >}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل PSB إلى GIF باستخدام جافا" %}}

 من أجل تقديم PSB إلى GIF، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل PSB إلى GIF عبر جافا" %}}

{{% blocks/products/pf/agp/text %}}

 تجعل واجهة برمجة تطبيقات Aspose.PSD من السهل على المطورين تحويل ملف PSB إلى GIF في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

- قم بتحميل ملف PSB
- إنشاء مثيل لـ [فئة خيارات GIF](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/GifOptions)
- استخدم طريقة Image.save (السلسلة، GIFOptions) للتحويل.
...
{{% blocks/products/pf/agp/code-block title="تحويل PSB إلى GIF - جافا" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="العروض التوضيحية الحية لتحويل PSB إلى GIF" sectionDescription="[تحويل PSB إلى GIF](https://products.aspose.app/psd/conversion/psb-to-gif) الآن من خلال زيارة موقع Live Demos الخاص بنا. يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text="لا حاجة لتنزيل Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text="لا حاجة لكتابة أي كود." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="ما عليك سوى تحميل ملف PSB الخاص بك، وسيتم تحويله على الفور إلى GIF." >}}
