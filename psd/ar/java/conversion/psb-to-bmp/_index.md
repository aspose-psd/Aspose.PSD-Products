---
title: تحويل PSB إلى BMP عبر جافا
weight: 300
description: نموذج كود تحويل جافا لتنسيق PSB إلى ملف BMP. استخدم رمز المثال هذا لتحويل PSB إلى BMP داخل أي تطبيق يستند إلى Java على الويب أو سطح المكتب.
url: java/conversion/psb-to-bmp/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/upper-banner h1="تحويل PSB إلى BMP عبر جافا" h2="واجهة برمجة تطبيقات جافا فوتوشوب لتحويل PSB إلى الصور النقطية بما في ذلك BMP" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="Aspose.PSD" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSB" >}}

{{< blocks/products/pf/main-container pfName="Aspose.PSD " subTitlepfName="for Java" >}}
{{< blocks/products/pf/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-psd" liveDemosLink="https://products.aspose.app/psd/family" docsLink="https://docs.aspose.com/psd/java" installationsDocsLink="https://docs.aspose.com/psd/java" nugetLink="" nugetPackageName="" downloadAsLink="https://releases.aspose.com/psd/java" learnAsLink="https://docs.aspose.com/psd/java" apiReference="" mavenRepoLink="https://repository.aspose.com/psd/" >}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل PSB إلى BMP باستخدام جافا" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل PSB إلى BMP عبر جافا" %}}

{{% blocks/products/pf/agp/text %}}

 تجعل واجهة برمجة تطبيقات Aspose.PSD من السهل على المطورين تحويل ملف PSB إلى BMP في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

- قم بتحميل ملف PSB
- إنشاء مثيل لـ [فئة خيارات BMP](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/BmpOptions)
- استخدم طريقة Image.save (السلسلة، خيارات BMP) للتحويل.
...
{{% blocks/products/pf/agp/code-block title="تحويل PSB إلى BMP - جافا" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="العروض التوضيحية المباشرة لتحويل PSB إلى BMP" sectionDescription="[تحويل PSB إلى BMP](https://products.aspose.app/psd/conversion/psb-to-bmp) الآن من خلال زيارة موقع Live Demos الخاص بنا. يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
