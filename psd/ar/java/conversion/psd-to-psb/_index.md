...
{{< blocks/products/pf/upper-banner h1="تحويل PSD إلى PSB عبر جافا" h2="قراءة وتحويل PSD إلى PSB من داخل أي تطبيقات جافا دون الحاجة إلى أدوبي فوتوشوب." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PSB" pfName="Aspose.PSD" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSD" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 تجعل واجهة برمجة تطبيقات Aspose.PSD من السهل على المطورين تحويل ملف PSD إلى PSB في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف PSD باستخدام طريقة Image.Load
1. قم بإرسال كائن الصورة إلى PSDIImage
1. طريقة استدعاء PSDImage.save مع مسار ملف الإخراج ومثيل PSDOptions
...
{{% blocks/products/pf/agp/code-block title="تحويل PSD إلى PSB - جافا" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="العروض التوضيحية الحية لتحويل PSD إلى PDF" sectionDescription="[Convert PSD to PSB](https://products.aspose.app/psd/conversion/psd-to-psb) الآن من خلال زيارة موقع Live Demos الخاص بنا. يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
