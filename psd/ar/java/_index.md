...
<li> دعم أقنعة متجه الطبقة وطبقة النص المخصصة FlipRotate</li>

<li> عرض تأثير ضربة الفرشاة مع تعبئة اللون للتصدير</li>
...
<h2 class="h2title"> تنفيذ فلاتر التصوير</h2>

<p> يوفر Aspose.PSD لـ Java ميزات التصوير الأساسية مثل تعديل اللون عبر مكتبات فصوله. يمكن للمطورين بسهولة ضبط السطوع أو التباين أو جاما على الصورة النقطية التي تم تحميلها بواسطة API. علاوة على ذلك ، يمكن للمطورين ديناميكيًا تشويش الصور أو تعتيمها بالإضافة إلى استخدام المرشحات الشائعة بما في ذلك Median و Motion Wiener و Gauss Wiener و Bradley Threshold.</p>
