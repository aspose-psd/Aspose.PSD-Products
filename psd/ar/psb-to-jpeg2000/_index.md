...
description: نموذج التعليمات البرمجية لتحويل PSB إلى JPEG2000 C#. استخدم رمز مثال API لملفات PSB المجمعة لتحويل JPEG2000 داخل VB.NET أو ASP.Net أو أي تطبيق يستند إلى .NET.
url: psb-to-jpeg2000/
---
...
من أجل تحويل PSB إلى JPEG2000، سنستخدم <a href="/psd/{{< lang-code >}}net">Aspose.PSD لـ دوت نت</a> API وهي واجهة برمجة تطبيقات تحويل غنية بالميزات وقوية وسهلة الاستخدام لمنصة Java. يمكنك تنزيل أحدث إصدار مباشرة من <a href="https://www.nuget.org/packages/aspose.psd">نوجيت</a> مدير الحزم، ابحث عن <b>Aspose.PSD</b> وتثبيت. يمكنك أيضًا استخدام الأمر التالي من وحدة تحكم إدارة الحزم.
...
{{% blocks/products/pf/agp/code-block title="يُظهر نموذج التعليمة البرمجية هذا تحويل PSB إلى JPEG2000 C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="تطبيق مجاني لتحويل PSB إلى JPEG2000" sectionDescription="Check our live demos for [PSB to JPEG2000 conversion](https://products.aspose.app/psd/conversion/psb-to-jpeg2000) with following benefits." >}}
