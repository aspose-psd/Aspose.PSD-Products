---
title: تحويل AI إلى PNG عبر C #
description: نموذج كود لتحويل AI إلى PNG C #. استخدم رمز مثال API لملفات AI المجمعة لتحويل PNG داخل VB.NET أو Asp.NET أو أي تطبيق قائم على .NET.
url: ar/net/conversion/ai-to-png/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1=" تحويل AI إلى PNG عبر C #" h2="" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName=" Aspose.PSD" subTitlepfName=" لـ .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PSD" fileiconsmall4="XML" fileiconsmall5="AI" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 يجعل Aspose.PSD من السهل على المطورين تحميل وتحويل ملفات AI إلى PNG في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/code-block title=" يوضح نموذج الكود هذا تحويل AI إلى PNG C #" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle=" تطبيق مجاني لتحويل AI إلى PNG" sectionDescription=" تحقق من العروض الحية لـ [تحويل AI إلى PNG] (https://products.aspose.app/psd/conversion/ai-to-png) مع الفوائد التالية." >}}
