---
title: تحويل PSD إلى TIFF باستخدام C #
...
url: ar/net/conversion/psd-to-tiff/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1=" تحويل PSD إلى TIFF عبر C #" h2=" .NET Photoshop API لتحويل PSD و PSB إلى صور نقطية بما في ذلك TIFF">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=" عرض عالي الجودة لـ PSD كـ TIFF" %}}
...
{{% blocks/products/pf/agp/code-autogen title=" كود .NET C # لتحويل PSD إلى TIFF" gistPath="" %}}
