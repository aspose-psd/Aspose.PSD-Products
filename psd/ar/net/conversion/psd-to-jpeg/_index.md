---
title: تحويل PSD إلى JPEG باستخدام C #
...
url: ar/net/conversion/psd-to-jpeg/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1=" تحويل PSD إلى JPEG عبر C #" h2=" .NET Photoshop API لتحويل PSD & PSB إلى صور نقطية بما في ذلك JPEG">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=" عرض عالي الجودة لملف PSD بصيغة JPEG" %}}
...
{{% blocks/products/pf/agp/code-autogen title=" كود .NET C # لتحويل PSD إلى JPEG" gistPath="" %}}
