---
title: تحويل PSD إلى JP2 باستخدام C #
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل PSD إلى JP2 عبر C#" h2=".NET Photoshop API لتحويل PSD و PSB إلى صور نقطية بما في ذلك JP2" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="عرض عالي الجودة لـ PSD كـ JP2" %}}
1. قم بتحميل PSD مع [صورة. تحميل](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) طريقة
 [خيارات جيه بي إي جي 2000](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/jpeg2000options) صنف
