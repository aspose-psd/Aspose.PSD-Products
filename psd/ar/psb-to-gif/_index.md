---
title: تحويل PSB إلى GIF باستخدام C#
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل PSB إلى GIF عبر C#" h2=".NET Photoshop API لتحويل PSD و PSB إلى الصور النقطية بما في ذلك GIF" >}}
...
1. قم بإنشاء مثيل للرسومات من الصورة. [خيارات GIF](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/gifoptions) صنف
...
{{% blocks/products/pf/agp/code-autogen title="كود .NET C# لتحويل PSB إلى GIF" gistPath="" %}}
