---
title: C# で PSD ファイルを JPEG に変換する方法
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C# を使用して PSD ファイルを JPEG に変換する" h2=".NET Photoshop API for PSD および PSB から JPEG を含むラスターイメージへの変換" >}}
...
1。画像から Graphics のインスタンスを作成します。 [JPEG オプション](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/jpegoptions) クラス
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# コードを使用して PSD ファイルを JPEG に変換する方法" gistPath="" %}}
