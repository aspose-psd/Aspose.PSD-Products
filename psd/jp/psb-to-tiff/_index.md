---
title: C# で PSB ファイルを TIFF 形式に変換する方法
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C# を使用して PSB ファイルを TIFF 形式に変換する" h2=".NET Photoshop API for PSD および PSB から TIFF を含むラスターイメージへの変換" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="TIFF形式でのPSBの高品質レンダリング" %}}
1。PSB に次の値をロードします。 [画像. 読み込み](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) 方法
1。画像から Graphics のインスタンスを作成します。 [TIFF オプション](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/tiffoptions) クラス
...
{{% blocks/products/pf/agp/code-autogen title="PSB から TIFF への変換用の .NET C# コード" gistPath="" %}}
