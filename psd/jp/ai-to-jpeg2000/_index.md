---
title: C# を使用して AI を JPEG2000 に変換する
description: AI から JPEG2000 への C# 変換のサンプルコードです。VB.NET、ASP.NET、または任意の.NET ベースのアプリケーション内で AI ファイルを JPEG2000 に一括変換するための API サンプルコードを使用してください。
url: ai-to-jpeg2000/
---
...
AI を JPEG2000 に変換するには、 <a href="/psd/{{< lang-code >}}net">.NET 用の Aspose.PSD</a> APIは、機能が豊富で強力で使いやすいJavaプラットフォーム用の変換APIです。最新バージョンは、以下から直接ダウンロードできます。 <a href="https://www.nuget.org/packages/aspose.psd">ナゲット</a> パッケージマネージャ、検索 <b>Aspose.PSD</b> そしてインストール。パッケージマネージャーコンソールから次のコマンドを使用することもできます。
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD を使用すると、開発者はわずか数行のコードで簡単に AI ファイルを JPEG2000 にロードおよび変換できます。
...
{{% blocks/products/pf/agp/code-block title="このサンプルコードは AI から JPEG2000 C# への変換を示しています" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="人工知能をJPEG2000に変換する無料アプリ" sectionDescription="Check our live demos for [AI to JPEG2000 conversion](https://products.aspose.app/psd/conversion/ai-to-jpeg2000) with following benefits." >}}
