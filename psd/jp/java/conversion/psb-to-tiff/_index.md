---
title: Java経由でPSBをTIFFに変換する
weight: 40
description: PSB形式からTIFFファイルへのサンプルJava変換コード。このサンプルコードを使用して、WebまたはデスクトップJavaベースのアプリケーション内でPSBをTIFFに変換します。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Java経由でPSBをTIFFに変換する" h2="TIFFを含むラスター画像へのPSB変換用のJavaPhotoshopAPI" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName=" Aspose.PSD" subTitlepfName="Javaの場合" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSB" >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してPSBをTIFFに変換する方法" %}}

 PSBをTIFFにレンダリングするために、
...
{{% blocks/products/pf/agp/feature-section-col title="Javaを介してPSBをTIFFに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD APIを使用すると、開発者は数行のコードでPSBファイルをTIFFに簡単に変換できます。
...
{{% blocks/products/pf/agp/code-block title="PSBをTIFFに変換-Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="PSBからTIFFへの変換ライブデモ" sectionDescription=" [PSBをTIFFに変換]（https://products.aspose.app/psd/conversion/psb-to-tiff）は、ライブデモのWebサイトにアクセスしてください。ライブデモには次の利点があります。" >}}
