---
title: Javaを介してPSBをGIFに変換する
weight: 220
description: PSB形式からGIFファイルへのサンプルJava変換コード。このサンプルコードを使用して、WebまたはデスクトップJavaベースのアプリケーション内でPSBをGIFに変換します。
---
...
{{% blocks/products/pf/agp/feature-section-col title="Javaを介してPSBをGIFに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD APIを使用すると、開発者は数行のコードでPSBファイルをGIFに簡単に変換できます。
...
{{% blocks/products/pf/agp/code-block title="PSBをGIFに変換-Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="PSBからGIFへの変換ライブデモ" sectionDescription=" [PSBをGIFに変換]（https://products.aspose.app/psd/conversion/psb-to-gif）今すぐライブデモのWebサイトにアクセスしてください。ライブデモには次の利点があります。" >}}
