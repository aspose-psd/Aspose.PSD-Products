---
title: Java 経由で PSD ファイルを JPEG に変換する
weight: 20
description: PSD フォーマットから JPEG ファイルへの Java 変換コードのサンプル。このサンプルコードを使用して、Web またはデスクトップ Java ベースのアプリケーション内で PSD を JPEG に変換します。
url: java/conversion/psd-to-jpeg/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/upper-banner h1="Java 経由で PSD を JPEG に変換する" h2="JPEG を含むラスターイメージへの PSD 変換用 Java Photoshop API" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="Aspose.PSD" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSD" >}}

{{< blocks/products/pf/main-container pfName="Aspose.PSD " subTitlepfName="for Java" >}}
{{< blocks/products/pf/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-psd" liveDemosLink="https://products.aspose.app/psd/family" docsLink="https://docs.aspose.com/psd/java" installationsDocsLink="https://docs.aspose.com/psd/java" nugetLink="" nugetPackageName="" downloadAsLink="https://releases.aspose.com/psd/java" learnAsLink="https://docs.aspose.com/psd/java" apiReference="" mavenRepoLink="https://repository.aspose.com/psd/" >}}

{{% blocks/products/pf/agp/content h2="Java を使用して PSD を JPEG に変換する方法" %}}

 PSD を JPEG にレンダリングするには、
...
{{% blocks/products/pf/agp/feature-section-col title="Java 経由で PSD ファイルを JPEG に変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD API を使用すると、開発者はわずか数行のコードで PSD ファイルを JPEG に簡単に変換できます。
...
{{% blocks/products/pf/agp/code-block title="PSD ファイルを JPEG 形式に変換-Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="PSDからJPEGへの変換ライブデモ" sectionDescription="[PSD ファイルを JPEG ファイルに変換します](https://products.aspose.app/psd/conversion/psd-to-jpeg) 今すぐライブデモのWebサイトにアクセスしてください。ライブデモには次の利点があります。" >}}
