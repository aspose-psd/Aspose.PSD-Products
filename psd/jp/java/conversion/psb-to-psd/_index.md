---
title: Javaを介してPSBをPSDに変換する
weight: 160
description: PSB形式からPSDファイルへのサンプルJava変換コード。このサンプルコードを使用して、WebまたはデスクトップJavaベースのアプリケーション内でPSBをPSDに変換します。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Javaを介してPSBをPSDに変換する" h2="PSBからPSDへの変換用のJavaPhotoshopAPI" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PSD" pfName=" Aspose.PSD" subTitlepfName="Javaの場合" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSB" >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してPSBをPSDに変換する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Javaを介してPSBをPSDに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD APIを使用すると、開発者は数行のコードでPSBファイルをPSDに簡単に変換できます。

{{% /blocks/products/pf/agp/text %}}

-PSBファイルをロードします
-[PsdOptionsクラス]（https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/PsdOptions）のインスタンスを作成します。
-変換にはImage.save（String、PsdOptions）メソッドを使用します。
...
{{% blocks/products/pf/agp/code-block title="PSBをPSDに変換-Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="PSBからPSDへの変換ライブデモ" sectionDescription=" [PSBをPSDに変換]（https://products.aspose.app/psd/conversion/psb-to-psd）ライブデモのWebサイトにアクセスしてください。ライブデモには次の利点があります。" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/psd/java/conversion/psb-to-pdf/" name="PSB TO PDF" description="ポータブルドキュメントフォーマット" >}}
