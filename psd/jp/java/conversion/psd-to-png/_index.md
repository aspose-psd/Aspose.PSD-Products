---
title: Java 経由で PSD ファイルを PNG に変換する
weight: 80
description: PSD フォーマットから PNG ファイルへの Java 変換コードのサンプル。このサンプルコードを使用して、Web またはデスクトップ Java ベースのアプリケーション内で PSD を PNG に変換します。
url: psd-to-png/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/upper-banner h1="Convert PSD to PNG via Java" h2="PNG を含むラスターイメージへの PSD 変換用 Java フォトショップ API" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="Aspose.PSD" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSD" >}}

{{< blocks/products/pf/main-container pfName="Aspose.PSD " subTitlepfName="for Java" >}}
{{< blocks/products/pf/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-psd" liveDemosLink="https://products.aspose.app/psd/family" docsLink="https://docs.aspose.com/psd/java" installationsDocsLink="https://docs.aspose.com/psd/java" nugetLink="" nugetPackageName="" downloadAsLink="https://releases.aspose.com/psd/java" learnAsLink="https://docs.aspose.com/psd/java" apiReference="" mavenRepoLink="https://repository.aspose.com/psd/" >}}

{{% blocks/products/pf/agp/content h2="Java を使用して PSD を PNG に変換する方法" %}}

 PSD を PNG にレンダリングするには、
...
{{% blocks/products/pf/agp/feature-section-col title="Java 経由で PSD ファイルを PNG に変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD API を使用すると、開発者はわずか数行のコードで PSD ファイルを PNG に簡単に変換できます。

{{% /blocks/products/pf/agp/text %}}

-PSD ファイルを読み込む
-のインスタンスを作成 [PNG オプションクラス](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/PngOptions)
-変換には Image.save (文字列、PNGオプション) メソッドを使用してください。
...
{{% blocks/products/pf/agp/code-block title="PSD ファイルを PNG 形式に変換-Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="PSDからPNGへの変換ライブデモ" sectionDescription="[Convert PSD to PNG](https://products.aspose.app/psd/conversion/psd-to-png) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
