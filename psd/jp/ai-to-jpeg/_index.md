...
1。のインスタンスを作成 [JPEG オプション](https://reference.aspose.com/psd/net/aspose.psd.imageoptions/jpegoptions/) クラス
...
{{< blocks/products/pf/agp/demobox sectionTitle="AIをJPEGに変換する無料アプリ" sectionDescription="ライブデモをチェックして [AI から JPEG へのコンバージョン](https://products.aspose.app/psd/conversion/ai-to-jpeg) 次のようなメリットがあります。" >}}
