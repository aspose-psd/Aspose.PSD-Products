---
title: C＃を介してPSBをPDFに変換する
weight: 340
description: PSBからPDFC＃への変換のサンプルコード。VB.NET、Asp.NET、または任意の.NETベースのアプリケーション内でのバッチPSBファイルからPDFへの変換にAPIサンプルコードを使用します。
url: jp/net/conversion/psb-to-pdf/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1=" C＃経由でPSBをPDFに変換" h2="" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName=" Aspose.PSD" subTitlepfName=" for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSB" >}}
...
{{% blocks/products/pf/agp/feature-section-col title=" C＃を介してPSBをPDFに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSDを使用すると、開発者は数行のコードでPSBファイルを簡単にロードしてPDFに変換できます。
...
{{% blocks/products/pf/agp/code-block title="このサンプルコードは、PSBからPDFへのC＃変換を示しています" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="PSBをPDFに変換する無料アプリ" sectionDescription=" [PSBからPDFへの変換]（https://products.aspose.app/psd/conversion/psb-to-pdf）のライブデモを確認してください。次の利点があります。" >}}
