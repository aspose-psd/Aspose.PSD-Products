---
title: C＃を介してPSDをPSBに変換する
weight: 210
description: PSDからPSBC＃への変換のサンプルコード。VB.NET、Asp.NET、または任意の.NETベースのアプリケーション内でのバッチPSDファイルからPSBへの変換にAPIサンプルコードを使用します。
url: jp/net/conversion/psd-to-psb/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1=" C＃を介してPSDをPSBに変換します" h2="" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PSB" pfName=" Aspose.PSD" subTitlepfName=" for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSD" >}}

{{< blocks/products/pf/main-container pfName=" Aspose.PSD" subTitlepfName=" for .NET" >}}
{{< blocks/products/pf/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-psd" liveDemosLink="https://products.aspose.app/psd/family" docsLink="https://docs.aspose.com/psd/net" installationsDocsLink="https://docs.aspose.com/psd/net" nugetLink="https://www.nuget.org/packages/aspose.psd" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/psd/net" learnAsLink="https://docs.aspose.com/psd/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2=" C＃を使用してPSDをPSBに変換する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title=" C＃を介してPSDをPSBに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSDを使用すると、開発者は数行のコードでPSDファイルを簡単にロードしてPSBに変換できます。

{{% /blocks/products/pf/agp/text %}}

1.Image.Loadメソッドを使用してPSDファイルをロードします
1.ImageオブジェクトをPsdImageにキャストします
1.出力ファイルパスとPsdOptionsのインスタンスを使用してImage.Saveメソッドを呼び出します
...
{{% blocks/products/pf/agp/code-block title="このサンプルコードは、PSDからPSBへのC＃変換を示しています" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="PSDをPSBに変換する無料アプリ" sectionDescription=" [PSDからPSBへの変換]（https://products.aspose.app/psd/conversion/psd-to-psb）のライブデモを確認してください。次の利点があります。" >}}
