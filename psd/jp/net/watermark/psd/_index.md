...
{{% blocks/products/pf/agp/feature-section-col title=" C＃を介してPSDに透かしを追加する手順" %}}
...
+画像からグラフィックスのインスタンスを作成します。
+透かしテキストのフォント、ブラシ、フォーマットを定義および設定します
+Graphics.DrawString関数を使用して透かしを描画します
...
{{% blocks/products/pf/agp/code-block title=" PSDに透かしを追加-C＃" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section title="その他のサポートされている透かし形式" subTitle=" C＃を使用すると、次のようなさまざまな形式に簡単に透かしを入れることができます。" >}}
