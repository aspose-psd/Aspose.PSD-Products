...
{{< blocks/products/pf/carousel-item h3="サポートされているファイル形式" description=".NET 用の Aspose.PSD が最もよくサポートされています [フォトショップとラスター画像](https://docs.aspose.com/psd/net/supported-file-formats/)  ファイル形式。" >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/editing-raster-layer-masks-in-psd-file-via-api/">ラスターレイヤーマスクの編集</a>
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-clone ico-blue fa-2x col-lg-2">
