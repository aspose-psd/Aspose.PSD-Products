...
1. Створіть екземпляр [Параметри JPEG 2000](https://reference.aspose.com/psd/net/aspose.psd.imageoptions/jpeg2000options/) клас
...
{{< blocks/products/pf/agp/demobox sectionTitle="Безкоштовний додаток для перетворення AI в JPEG" sectionDescription="Перевірте наші живі демо для [Перетворення АІ в JPEG2000](https://products.aspose.app/psd/conversion/ai-to-jpeg2000) з наступними перевагами»." >}}
