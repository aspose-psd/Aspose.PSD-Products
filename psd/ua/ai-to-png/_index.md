...
1. Створіть екземпляр [Параметри PNG](https://reference.aspose.com/psd/net/aspose.psd.imageoptions/pngoptions/) клас
...
{{< blocks/products/pf/agp/demobox sectionTitle="Безкоштовний додаток для перетворення AI в PNG" sectionDescription="Перевірте наші живі демо для [Перетворення AI в PNG](https://products.aspose.app/psd/conversion/ai-to-png) з наступними перевагами»." >}}
