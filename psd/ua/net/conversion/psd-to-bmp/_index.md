---
title: Перетворіть PSD на BMP за допомогою C#
description: Експорт PSD, PSB і AI файлів через .NET API
family: psd
platformtag: net
feature: conversion
informat: PSD
...
url: ua/net/conversion/psd-to-bmp/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Перетворити PSD на BMP за допомогою C#" h2=".NET Photoshop API для PSD і PSB Перетворення в растрові зображення, включаючи BMP">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Висока якість відтворення PSD у форматі BMP" %}}
...
1. Створіть екземпляр класу [BmpOptions](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/bmpoptions)
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# Код для перетворення PSD в BMP" gistPath="" %}}
