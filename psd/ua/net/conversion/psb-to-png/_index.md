---
title: Перетворення PSB на PNG за допомогою C#
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Перетворення PSB в PNG через C#" h2=".NET Photoshop API для PSD & PSB Перетворення на растрові зображення, включаючи PNG" >}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# Код для PSB в PNG перетворення" gistPath="" %}}
