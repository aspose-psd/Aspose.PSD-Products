...
1. Створіть екземпляр [Параметри PDF](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/PdfOptions) клас
...
{{< blocks/products/pf/agp/demobox sectionTitle="Безкоштовний додаток для перетворення AI в PDF" sectionDescription="Перевірте наші живі демо для [Перетворення AI в PDF](https://products.aspose.app/psd/conversion/ai-to-pdf) з наступними перевагами»." >}}
