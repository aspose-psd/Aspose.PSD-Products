---
title: Перетворення PSB на TIFF за допомогою C#
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Перетворення PSB в TIFF через C#" h2=".NET Photoshop API для PSD & PSB Перетворення в растрові зображення, включаючи TIFF" >}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# Код для PSB в TIFF перетворення" gistPath="" %}}
