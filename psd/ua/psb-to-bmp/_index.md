...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Перетворення PSB в BMP через C#" h2=".NET Photoshop API для PSD & PSB Перетворення в растрові зображення, включаючи BMP" >}}
...
1. Створіть екземпляр графіки з зображення. [Варіанти BMP](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/bmpoptions) клас
