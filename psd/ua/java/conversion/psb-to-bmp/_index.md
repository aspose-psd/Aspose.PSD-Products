---
title: Перетворіть PSB на BMP через Java
weight: 300
description: Зразок коду перетворення Java для формату PSB у файл BMP. Використовуйте цей приклад коду, щоб перетворити PSB на BMP у будь-якому веб- або настільному додатку Java на базі.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Перетворити PSB на BMP через Java" h2="Java Photoshop API для перетворення PSB на растрові зображення, включаючи BMP" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="Aspose.PSD" subTitlepfName="для Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSB" >}}
...
{{% blocks/products/pf/agp/content h2="Як перетворити PSB на BMP за допомогою Java" %}}

 Щоб передати PSB в BMP, ми будемо використовувати
...
{{% blocks/products/pf/agp/feature-section-col title="Кроки для перетворення PSB на BMP через Java" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD API дозволяє розробникам легко конвертувати файл PSB у BMP лише за кілька рядків коду.

{{% /blocks/products/pf/agp/text %}}

- Завантажте файл PSB
- Створіть екземпляр [BmpOptions class](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/BmpOptions).
...
{{% blocks/products/pf/agp/code-block title="Перетворити PSB на BMP - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle=" Живі демонстрації з перетворення PSB в BMP" sectionDescription="[Перетворити PSB на BMP](https://products.aspose.app/psd/conversion/psb-to-bmp) прямо зараз, відвідавши наш веб-сайт Live Demos. Пряма демонстрація має такі переваги" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Просто завантажте файл PSB, він буде миттєво перетворений у BMP." >}}
