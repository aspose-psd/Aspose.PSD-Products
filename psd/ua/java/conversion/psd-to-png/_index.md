---
title: Конвертуйте PSD у PNG за допомогою Java
weight: 80
description: Зразок коду перетворення Java для формату PSD у файл PNG. Використовуйте цей приклад коду для перетворення PSD у PNG у будь-якому веб- або настільному додатку Java на базі.
url: ua/java/conversion/psd-to-png/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Перетворіть PSD у PNG за допомогою Java" h2="Java Photoshop API для перетворення PSD на растрові зображення, включаючи PNG" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="Aspose.PSD" subTitlepfName="для Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSD" >}}
...
{{% blocks/products/pf/agp/content h2="Як перетворити PSD у PNG за допомогою Java" %}}

 Щоб відобразити PSD у PNG, ми будемо використовувати
...
{{% blocks/products/pf/agp/feature-section-col title="Кроки для перетворення PSD у PNG через Java" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD API дозволяє розробникам легко конвертувати PSD-файл у PNG лише за кілька рядків коду.
...
{{% blocks/products/pf/agp/code-block title="Перетворити PSD у PNG - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Пряма демонстрація перетворення PSD в PNG" sectionDescription="[Перетворіть PSD у PNG](https://products.aspose.app/psd/conversion/psd-to-png) прямо зараз, відвідавши наш веб-сайт Live Demos. Жива демонстрація має такі переваги" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Просто завантажте свій PSD-файл, і він буде миттєво перетворений у PNG." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="java/conversion/psd-to-pdf/" name="PSD TO PDF" description="Переносний формат документів" >}}
