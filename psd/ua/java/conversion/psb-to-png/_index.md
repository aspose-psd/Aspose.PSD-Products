---
title: Перетворіть PSB у PNG через Java
weight: 110
description: Зразок коду перетворення Java для формату PSB у файл PNG. Використовуйте цей приклад коду, щоб перетворити PSB у PNG у будь-якому веб- або настільному додатку Java на базі.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Перетворити PSB у PNG через Java" h2="API Java Photoshop для перетворення PSB на растрові зображення, включаючи PNG" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="Aspose.PSD" subTitlepfName="для Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSB" >}}
...
{{% blocks/products/pf/agp/content h2="Як перетворити PSB у PNG за допомогою Java" %}}

 Щоб відобразити PSB у PNG, ми будемо використовувати
...
{{% blocks/products/pf/agp/feature-section-col title="Кроки для перетворення PSB у PNG через Java" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD API дозволяє розробникам легко конвертувати файл PSB у PNG лише за кілька рядків коду.

{{% /blocks/products/pf/agp/text %}}

- Завантажте файл PSB
- Створіть екземпляр [класу PngOptions](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/PngOptions).
...
{{% blocks/products/pf/agp/code-block title="Перетворити PSB у PNG - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Демонстраційні відео перетворення PSB в PNG" sectionDescription="[Перетворити PSB у PNG](https://products.aspose.app/psd/conversion/psb-to-png) прямо зараз, відвідавши наш веб-сайт Live Demos. Жива демонстрація має такі переваги" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Просто завантажте файл PSB, він буде миттєво перетворений у PNG." >}}
