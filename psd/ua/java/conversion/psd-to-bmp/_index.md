---
title: Конвертуйте PSD в BMP за допомогою Java
weight: 260
description: Зразок коду перетворення Java для формату PSD у файл BMP. Використовуйте цей приклад коду для перетворення PSD у BMP у будь-якому веб- або настільному додатку Java на базі.
url: ua/java/conversion/psd-to-bmp/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Перетворіть PSD на BMP за допомогою Java" h2="Java Photoshop API для перетворення PSD на растрові зображення, включаючи BMP" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="Aspose.PSD" subTitlepfName="для Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSD" >}}
...
{{% blocks/products/pf/agp/content h2="Як перетворити PSD на BMP за допомогою Java" %}}

 Щоб відобразити PSD у BMP, ми будемо використовувати
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD API дозволяє розробникам легко конвертувати PSD-файл у BMP лише за кілька рядків коду.
...
{{% blocks/products/pf/agp/code-block title="Перетворити PSD на BMP - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle=" Живі демонстрації з перетворення PSD в BMP" sectionDescription="[Перетворити PSD на BMP](https://products.aspose.app/psd/conversion/psd-to-bmp) прямо зараз, відвідавши наш веб-сайт Live Demos. Жива демонстрація має такі переваги" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Просто завантажте свій PSD-файл, і він буде миттєво перетворений у BMP." >}}
