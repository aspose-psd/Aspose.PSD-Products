---
title: Перетворіть AI у PNG через Java
description: Зразок коду перетворення Java для формату AI у файл PNG. Використовуйте цей приклад коду, щоб перетворити AI у PNG у будь-якому веб- або настільному додатку Java на базі.
url: ua/java/conversion/ai-to-png/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Перетворіть AI у PNG за допомогою Java" h2="Нативна бібліотека Java для читання, запису й експорту AI у PNG без потреби Adobe." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="Aspose.PSD" subTitlepfName="для Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AI" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Кроки для перетворення AI у PNG через Java" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD API дозволяє розробникам легко конвертувати файл AI у PNG лише за кілька рядків коду.

{{% /blocks/products/pf/agp/text %}}

- Завантажте вхідне зображення AI
- Ініціалізуйте об'єкт класу [PngOptions](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/pngOptions)
...
{{% blocks/products/pf/agp/code-block title="Перетворити AI у PNG – Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Живі демонстрації перетворення AI в PNG" sectionDescription="[Перетворити AI у PNG](https://products.aspose.app/psd/conversion/ai-to-png) прямо зараз, відвідавши наш веб-сайт Live Demos. Жива демонстрація має такі переваги" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Просто завантажте свій файл AI, і він буде миттєво перетворений у PNG." >}}
