---
title: Перетворіть AI у JPEG за допомогою Java
description: Зразок коду перетворення Java для формату AI у файл JPEG. Використовуйте цей приклад коду, щоб перетворити AI у JPEG у будь-якому веб- або настільному додатку Java на базі.
url: ua/java/conversion/ai-to-jpeg/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Перетворіть AI у JPEG за допомогою Java" h2="Нативна бібліотека Java для читання, запису й експорту AI у JPEG без потреби Adobe." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="Aspose.PSD" subTitlepfName="для Java" downloadUrl="" fileiconsmall1="JPEG" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AI" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD API дозволяє розробникам легко конвертувати AI-файл у JPEG лише за кілька рядків коду.

{{% /blocks/products/pf/agp/text %}}

- Завантажте вхідне зображення AI
- Ініціалізуйте об'єкт класу [JpegOptions](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/jpegOptions)
- Вкажіть властивості зображення
- Зберегти вихідне зображення JPEG
...
{{% blocks/products/pf/agp/code-block title="Перетворити AI в JPEG - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Живі демонстрації перетворення AI в JPEG" sectionDescription="[Перетворити AI у JPEG](https://products.aspose.app/psd/conversion/ai-to-jpeg) прямо зараз, відвідавши наш веб-сайт Live Demos. Жива демонстрація має такі переваги" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Просто завантажте свій файл AI, і він буде миттєво перетворений у JPEG." >}}
