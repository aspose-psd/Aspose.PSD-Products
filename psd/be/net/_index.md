...
<p>
 ...
 разам з экспартам у Pdf з тэкстам для выбару. Aspose.PSD часткова падтрымлівае такія функцыі Adobe Photoshop, як карэкціруючыя пласты, візуалізацыя і рэдагаванне тэкставага пласта, слаі запаўнення, эфекты слаёў, рэдагаванне растравых і вектарных масак для слаёў.
</p>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      <a href="https://docs.aspose.com/psd/net/manipulating-adobe-photoshop-formats/?#merge-psd-layers-into-other-layers-1">Аб'яднаць пласты</a>
    </p>
   </div>
   <div class="col-lg-4">
...
<h2 class="h2title">Апошнія магчымасці PSD API</h2>

<p> Aspose.PSD для .NET API пастаянна дадае новыя функцыі, каб зрабіць яго магутным. Вось спіс некалькіх выбараў з апошніх дададзеных.</p>

<ul>

<li>Падтрымка слаёў залівання. Узор, колер і градыентная заліўка</li>

<li>Падтрымка GdFlResource, VmskResource, PtFlResource і VsmsResource</li>

<li>Загружаць файлы малюнкаў JPEG/PNG/і г.д. у PsdImage без прамой загрузкі</li>

<li>Растэрызацыя вектарных масак слаёў і карыстальніцкага перавароту тэкставага пласта</li>

<li>Аказанне эфекту абводкі з каляровай заліўкай для экспарту</li>
...
{{< blocks/products/pf/slr-tab tabTitle="Чаму Aspose.PSD для .NET?" tabId="success-stories" >}}
