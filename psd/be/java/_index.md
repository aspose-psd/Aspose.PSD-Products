...
<h2 class="h2title">Апошнія функцыі PSD API</h2>
...
<li>Падтрымка вектарных масак слаёў і карыстальніцкага перавароту тэкставага пласта</li>
...
<h2 class="h2title">Укараненне фільтраў малюнкаў</h2>

<p>Aspose.PSD для Java забяспечвае асноўныя функцыі візуалізацыі, такія як рэгуляванне колеру праз свае бібліятэкі класаў. Распрацоўшчыкі могуць лёгка наладзіць яркасць, кантраснасць або гаму растравага малюнка, загружанага з дапамогай API. Акрамя таго, распрацоўшчыкі могуць дынамічна размываць або размываць выявы, а таксама выкарыстоўваць папулярныя фільтры, у тым ліку Медыяну, Рух Вінера, Гаўса Вінера і Брэдлі Парог.</p>
