---
title: Канвертаваць AI ў JPEG праз Java
description: Прыклад кода пераўтварэння Java для фармату AI ў файл JPEG. Выкарыстоўвайце гэты прыклад кода для пераўтварэння AI ў JPEG у любым вэб- або настольным Java-прыкладанні.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Канвертаваць AI ў JPEG праз Java" h2=" Родная бібліятэка Java для чытання, запісу і экспарту AI ў JPEG без неабходнасці Adobe." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="Aspose.PSD" subTitlepfName="для Java" downloadUrl="" fileiconsmall1="JPEG" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AI" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Крокі для пераўтварэння AI ў JPEG праз Java" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD API дазваляе распрацоўшчыкам лёгка канвертаваць файл AI ў JPEG ўсяго за некалькі радкоў кода.

{{% /blocks/products/pf/agp/text %}}

- Загрузіць уваходны малюнак AI
- Ініцыялізаваць аб'ект класа [JpegOptions](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/jpegOptions)
- Пакажыце ўласцівасці выявы
- Захаваць выхадны малюнак JPEG
...
{{% blocks/products/pf/agp/code-block title="Пераўтварыць AI ў JPEG - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Жывыя дэманстрацыі пераўтварэння AI ў JPEG" sectionDescription="[Канвертаваць AI ў JPEG](https://products.aspose.app/psd/conversion/ai-to-jpeg) прама зараз, наведаўшы наш вэб-сайт Live Demos. Жывая дэманстрацыя мае наступныя перавагі" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Проста загрузіце файл AI, ён будзе імгненна ператвораны ў JPEG." >}}
