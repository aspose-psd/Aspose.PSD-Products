---
title: Канвертаваць PSD у PNG праз Java
weight: 80
description: Прыклад кода пераўтварэння Java для фармату PSD у файл PNG. Выкарыстоўвайце гэты прыклад кода для пераўтварэння PSD ў PNG у любым вэб- або настольным Java-прыкладанні.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Канвертаваць PSD у PNG праз Java" h2=" API Java Photoshop для пераўтварэння PSD у растравыя выявы, уключаючы PNG" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="Aspose.PSD" subTitlepfName="для Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSD" >}}
...
{{% blocks/products/pf/agp/content h2="Як канвертаваць PSD у PNG з дапамогай Java" %}}

 Каб перавесці PSD у PNG, мы будзем выкарыстоўваць
...
{{% blocks/products/pf/agp/feature-section-col title="Крокі для пераўтварэння PSD у PNG праз Java" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD API дазваляе распрацоўшчыкам лёгка канвертаваць PSD-файл у PNG усяго за некалькі радкоў кода.
...
{{% blocks/products/pf/agp/code-block title="Канвертаваць PSD у PNG - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Прыкладныя дэманстрацыі пераўтварэння PSD ў PNG" sectionDescription="[Канвертаваць PSD у PNG](https://products.aspose.app/psd/conversion/psd-to-png) прама зараз, наведаўшы наш вэб-сайт Live Demos. Жывая дэманстрацыя мае наступныя перавагі" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Проста загрузіце файл PSD, ён будзе імгненна ператвораны ў PNG." >}}
