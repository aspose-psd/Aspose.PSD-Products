---
title: Канвертаваць PSD ў TIFF праз Java
weight: 170
description: Прыклад кода пераўтварэння Java для фармату PSD ў файл TIFF. Выкарыстоўвайце гэты прыклад кода для пераўтварэння PSD ў TIFF у любым вэб- або настольным Java-прыкладанні.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Канвертаваць PSD у TIFF праз Java" h2=" API Java Photoshop для пераўтварэння PSD у растравыя выявы, уключаючы TIFF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="Aspose.PSD" subTitlepfName="для Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSD" >}}
...
{{% blocks/products/pf/agp/content h2="Як канвертаваць PSD ў TIFF з дапамогай Java" %}}

 Каб перавесці PSD у TIFF, мы будзем выкарыстоўваць
...
{{% blocks/products/pf/agp/feature-section-col title="Крокі для пераўтварэння PSD ў TIFF праз Java" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD API дазваляе распрацоўшчыкам лёгка канвертаваць PSD-файл у TIFF усяго за некалькі радкоў кода.
...
{{% blocks/products/pf/agp/code-block title="Канвертаваць PSD у TIFF - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Прыкладныя дэманстрацыі пераўтварэння PSD ў TIFF" sectionDescription="[Канвертаваць PSD у TIFF](https://products.aspose.app/psd/conversion/psd-to-tiff) прама зараз, наведаўшы наш вэб-сайт Live Demos. Жывая дэманстрацыя мае наступныя перавагі" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Проста загрузіце файл PSD, ён будзе імгненна ператвораны ў TIFF." >}}
