---
title: Канвертаваць AI ў JPEG2000 праз Java
description: Прыклад кода пераўтварэння Java для фармату AI ў файл JPEG2000. Выкарыстоўвайце гэты прыклад кода для пераўтварэння AI ў JPEG2000 у любым вэб- або настольным Java-прыкладанні.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Канвертаваць AI ў JPEG2000 праз Java" h2="Уласная бібліятэка Java для чытання, запісу і экспарту AI ў JPEG2000 без неабходнасці Adobe." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG2000" pfName="Aspose.PSD" subTitlepfName="для Java" downloadUrl="" fileiconsmall1="JPEG2000" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AI" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Крокі для пераўтварэння AI ў JPEG2000 праз Java" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD API дазваляе распрацоўшчыкам лёгка канвертаваць файл AI ў JPEG2000 усяго за некалькі радкоў кода.

{{% /blocks/products/pf/agp/text %}}

- Загрузіць уваходны малюнак AI
- Ініцыялізаваць аб'ект класа [Jpeg2000Options](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/jpeg2000Options)
- Пакажыце ўласцівасці выявы
- Захаваць выхадны малюнак JPEG2000
...
{{% blocks/products/pf/agp/code-block title="Пераўтварыць AI ў JPEG2000 - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Жывыя дэма-версіі пераўтварэння AI ў JPEG2000" sectionDescription="[Канвертаваць AI ў JPEG2000](https://products.aspose.app/psd/conversion/ai-to-jpeg2000) прама зараз, наведаўшы наш вэб-сайт Live Demos. Жывая дэманстрацыя мае наступныя перавагі" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Проста загрузіце файл AI, ён будзе імгненна ператвораны ў JPEG2000." >}}
