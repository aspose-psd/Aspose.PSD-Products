---
title: PSB in TIFF mit C# konvertieren
...
url: de/net/conversion/psb-to-tiff/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="PSB über C# in TIFF konvertieren" h2=".NET Photoshop API für PSD- und PSB-Konvertierung in Rasterbilder einschließlich TIFF">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Hochwertige Wiedergabe von PSB als TIFF" %}}
1. Laden Sie das PSB mit der Methode [Image.Load](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index).
1. Erstellen Sie eine Instanz der Klasse [TiffOptions](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/tiffoptions).
...
{{% blocks/products/pf/agp/code-autogen title=".NET C#-Code für PSB-zu-TIFF-Konvertierung" gistPath="" %}}
