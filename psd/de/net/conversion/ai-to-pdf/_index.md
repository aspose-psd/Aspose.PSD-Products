...
1. Erstellen Sie eine Instanz von [PDF-Optionen](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/PdfOptions) Klasse
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von AI in PDF" sectionDescription="Schauen Sie sich unsere Live-Demos an für [Konvertierung von AI in PDF](https://products.aspose.app/psd/conversion/ai-to-pdf) mit folgenden Vorteilen." >}}
