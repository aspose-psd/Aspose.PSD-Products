---
title: AI in PSB über C# konvertieren
description: Beispielcode für die Konvertierung von AI in PSB C#. Verwenden Sie den API-Beispielcode für die Batch-Konvertierung von AI-Dateien in PSB innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
url: de/net/conversion/ai-to-psb/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="KI über C# in PSB konvertieren" h2="" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PSB" pfName="Aspose.PSD" subTitlepfName="für .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PSD" fileiconsmall4="XML" fileiconsmall5="AI" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie AI in PSB mit C#" %}}

Um AI in PSB umzuwandeln, verwenden wir<a href="/psd/{{< lang-code >}}net">Aspose.PSD für .NET</a> API, eine funktionsreiche, leistungsstarke und einfach zu verwendende API zur Dokumentenbearbeitung und -konvertierung für die C#-Plattform. Offen<a href="https://www.nuget.org/packages/aspose.psd">NuGet</a> Paketmanager, suche nach<b>Aspose.PSD</b> und installieren. Sie können auch den folgenden Befehl in der Paket-Manager-Konsole verwenden.
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von AI in PSB über C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD erleichtert Entwicklern das Laden und Konvertieren von AI-Dateien in PSB in nur wenigen Codezeilen.
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die AI-zu-PSB-C#-Konvertierung" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von AI in PSB" sectionDescription="Sehen Sie sich unsere Live-Demos für die [Konvertierung von AI zu PSB](https://products.aspose.app/psd/conversion/ai-to-psb) mit folgenden Vorteilen an." >}}
