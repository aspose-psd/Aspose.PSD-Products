---
title: Konvertiere AI über Java zu JPEG2000
description: Beispiel für einen Java-Konvertierungscode für das AI-Format in eine JPEG2000-Datei. Verwenden Sie diesen Beispielcode, um AI in JPEG2000 in jeder Web- oder Desktop-Java-basierten Anwendung zu konvertieren.
...
{{% blocks/products/pf/agp/content h2="Wie konvertiert man AI mit Java in JPEG2000" %}}

Um AI auf JPEG2000 zu rendern, verwenden wir <a href="/psd/{{< lang-code >}}java">Aspose.PSD für Java</a> API, eine funktionsreiche, leistungsstarke und benutzerfreundliche Konvertierungs-API für die Java-Plattform. Sie können die neueste Version direkt herunterladen von <a href="https://repository.aspose.com/psd/">Maven</a> und installieren Sie es in Ihrem Maven-basierten Projekt, indem Sie die folgenden Konfigurationen zur pom.xml hinzufügen.
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zur Konvertierung von AI in JPEG2000 über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Die Aspose.PSD API macht es Entwicklern einfach, AI-Dateien in nur wenigen Codezeilen in JPEG2000 zu konvertieren.

{{% /blocks/products/pf/agp/text %}}

- AI-Eingabebild laden
- Initialisieren [JPEG2000-Optionen](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/jpeg2000Options) Klassenobjekt
- Geben Sie die Bildeigenschaften an
- JPEG2000-Ausgabebild speichern
...
{{% blocks/products/pf/agp/code-block title="AI in JPEG2000 konvertieren - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Live-Demos zur Konvertierung von AI zu JPEG2000" sectionDescription="[Convert AI to JPEG2000](https://products.aspose.app/psd/conversion/ai-to-jpeg2000) besuchen Sie jetzt unsere Live-Demo-Website. Die Live-Demo hat die folgenden Vorteile" >}}
