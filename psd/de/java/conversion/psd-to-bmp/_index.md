---
title: PSD über Java in BMP konvertieren
weight: 260
description: Beispiel-Java-Konvertierungscode für das PSD-Format in eine BMP-Datei. Verwenden Sie diesen Beispielcode, um PSD in BMP in jeder Web- oder Desktop-Java-basierten Anwendung zu konvertieren.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konvertieren Sie PSD über Java in BMP" h2="Java Photoshop API für PSD-Konvertierung in Rasterbilder einschließlich BMP" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="Aspose.PSD" subTitlepfName="für Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSD" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie PSD in BMP mit Java" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Die Aspose.PSD-API macht es Entwicklern leicht, PSD-Dateien in nur wenigen Codezeilen in BMP zu konvertieren.
...
{{% blocks/products/pf/agp/code-block title="Konvertiere PSD in BMP - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="PSD-zu-BMP-Konvertierung Live-Demos" sectionDescription="[PSD in BMP konvertieren](https://products.aspose.app/psd/conversion/psd-to-bmp) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
