---
title: Konvertiere AI in PNG über Java
description: Beispiel für einen Java-Konvertierungscode für das AI-Format in eine PNG-Datei. Verwenden Sie diesen Beispielcode, um AI in jeder Web- oder Desktop-Java-basierten Anwendung in PNG zu konvertieren.
url: java/conversion/ai-to-png/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/upper-banner h1="Konvertiere KI über Java in PNG" h2="Native Java-Bibliothek zum Lesen, Schreiben und Exportieren von AI in PNG, ohne dass Adobe erforderlich ist." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="Aspose.PSD" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AI" >}}
...
Um AI in PNG zu rendern, verwenden wir <a href="/psd/{{< lang-code >}}java">Aspose.PSD für Java</a> API, eine funktionsreiche, leistungsstarke und benutzerfreundliche Konvertierungs-API für die Java-Plattform. Sie können die neueste Version direkt herunterladen von <a href="https://repository.aspose.com/psd/">Maven</a> und installieren Sie es in Ihrem Maven-basierten Projekt, indem Sie die folgenden Konfigurationen zur pom.xml hinzufügen.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Die Aspose.PSD API macht es Entwicklern einfach, AI-Dateien in nur wenigen Codezeilen in PNG zu konvertieren.

{{% /blocks/products/pf/agp/text %}}

- AI-Eingabebild laden
- Initialisieren [PNG-Optionen](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/pngOptions) Klassenobjekt
- Geben Sie die Bildeigenschaften an
- PNG-Ausgabebild speichern
...
{{< blocks/products/pf/agp/demobox sectionTitle="Live-Demos zur Konvertierung von AI in PNG" sectionDescription="[Convert AI to PNG](https://products.aspose.app/psd/conversion/ai-to-png) besuchen Sie jetzt unsere Live-Demo-Website. Die Live-Demo hat die folgenden Vorteile" >}}
