...
Um AI in PDF zu konvertieren, verwenden wir <a href="/psd/{{< lang-code >}}net">Aspose.PSD für .NET</a> API, eine funktionsreiche, leistungsstarke und benutzerfreundliche Konvertierungs-API für die Java-Plattform. Sie können die neueste Version direkt herunterladen von <a href="https://www.nuget.org/packages/aspose.psd">NuGet</a> Paketmanager, suche nach <b>Aspose.PSD</b> und installiere. Sie können auch den folgenden Befehl von der Package Manager-Konsole aus verwenden.
...
1. Erstellen Sie eine Instanz von Graphics aus dem Bild. [PDF-Optionen](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/PdfOptions) Klasse
