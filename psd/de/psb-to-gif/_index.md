---
title: PSB mit C# in GIF konvertieren
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="PSB über C# in GIF konvertieren" h2=".NET Photoshop-API für PSD- und PSB-Konvertierung in Rasterbilder einschließlich GIF" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Qualitativ hochwertiges Rendern von PSB als GIF" %}}
1. Laden Sie das PSB mit [Bild. Laden](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) Methode
1. Erstellen Sie eine Instanz von Graphics aus dem Bild. [GIF-Optionen](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/gifoptions) Klasse
...
{{% blocks/products/pf/agp/code-autogen title=".NET C#-Code für die Konvertierung von PSB in GIF" gistPath="" %}}
