---
title: PSB über C# zu PSD konvertieren
weight: 240
description: Beispielcode für die Konvertierung von PSB in PSD C#. Verwenden Sie API-Beispielcode für die Batch-Konvertierung von PSB-Dateien in PSD in VB.NET, ASP.Net oder einer beliebigen .NET-basierten Anwendung.
url: psb-to-psd/
---
...
{{% blocks/products/pf/agp/content h2="Wie konvertiert man PSB mit Java in PSD" %}}
 ...
 Um PSB in PSD zu konvertieren, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD macht es Entwicklern einfach, PSB-Dateien in nur wenigen Codezeilen zu laden und in PSD zu konvertieren.
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die C#-Konvertierung von PSB zu PSD" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von PSB in PSD" sectionDescription="Check our live demos for [PSB to PSD conversion](https://products.aspose.app/psd/conversion/psb-to-psd) with following benefits." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="net/conversion/psb-to-gif/" name="PSB ZU GIF" description="{{bmp _name}}" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="net/conversion/psb-to-jpeg/" name="PSB ZU JPEG" description="{{bmp _name}}" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="net/conversion/psb-to-pdf/" name="PSB ZU PDF" description="{{bmp _name}}" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="net/conversion/psb-to-png/" name="PSB ZU PNG" description="{{bmp _name}}" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="net/conversion/psb-to-psd/" name="PSB ZU PSD" description="{{bmp _name}}" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="net/conversion/psb-to-tiff/" name="PSB ZU TIFF" description="{{bmp _name}}" >}}
