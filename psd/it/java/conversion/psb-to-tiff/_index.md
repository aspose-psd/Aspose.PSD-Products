...
weight: 40
description: Esempio di codice di conversione Java per il formato PSB in file TIFF. Utilizzare questo codice di esempio per convertire PSB in TIFF all'interno di qualsiasi applicazione basata su Java Web o desktop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converti PSB in TIFF tramite Java" h2="API Java Photoshop per PSB Conversione in immagini raster incluso TIFF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="Aspose.PSD" subTitlepfName="per Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSB" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 L'API Aspose.PSD semplifica agli sviluppatori la conversione di file PSB in TIFF in poche righe di codice.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Dimostrazioni live di conversione da PSB a TIFF" sectionDescription="[Convert PSB to TIFF](https://products.aspose.app/psd/conversion/psb-to-tiff) in questo momento visitando il nostro sito Web di demo dal vivo.La demo dal vivo presenta i seguenti vantaggi" >}}
