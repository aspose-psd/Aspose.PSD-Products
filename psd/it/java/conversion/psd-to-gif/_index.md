---
title: Converti PSD in GIF tramite Java
weight: 330
description: Esempio di codice di conversione Java per il formato PSD in file GIF. Usa questo codice di esempio per convertire PSD in GIF all'interno di qualsiasi applicazione Web o desktop basata su Java.
url: java/conversion/psd-to-gif/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/upper-banner h1="Converti PSD in GIF tramite Java" h2="API Java Photoshop per la conversione PSD in immagini raster incluse GIF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="GIF" pfName="Aspose.PSD" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSD" >}}

{{< blocks/products/pf/main-container pfName="Aspose.PSD " subTitlepfName="for Java" >}}
{{< blocks/products/pf/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-psd" liveDemosLink="https://products.aspose.app/psd/family" docsLink="https://docs.aspose.com/psd/java" installationsDocsLink="https://docs.aspose.com/psd/java" nugetLink="" nugetPackageName="" downloadAsLink="https://releases.aspose.com/psd/java" learnAsLink="https://docs.aspose.com/psd/java" apiReference="" mavenRepoLink="https://repository.aspose.com/psd/" >}}

{{% blocks/products/pf/agp/content h2="Come convertire PSD in GIF usando Java" %}}

 Per rendere PSD in GIF, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire PSD in GIF tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

 L'API Aspose.PSD consente agli sviluppatori di convertire facilmente i file PSD in GIF in poche righe di codice.
...
{{% blocks/products/pf/agp/code-block title="Converti PSD in GIF - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo live di conversione da PSD a GIF" sectionDescription="[Convertire PSD in GIF](https://products.aspose.app/psd/conversion/psd-to-gif) in questo momento visitando il nostro sito Web Live Demos. La demo live offre i seguenti vantaggi" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text="Non è necessario scaricare l'API Aspose»." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text="Non c'è bisogno di scrivere alcun codice»." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Basta caricare il tuo file PSD, verrà convertito istantaneamente in GIF." >}}
