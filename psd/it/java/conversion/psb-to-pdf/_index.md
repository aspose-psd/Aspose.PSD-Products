...
weight: 190
description: Esempio di codice di conversione Java per il formato PSB in file PDF. Usa questo codice di esempio per convertire PSB in PDF all'interno di qualsiasi applicazione Web o desktop basata su Java.
...
{{% blocks/products/pf/agp/content h2="Come convertire PSB in PDF usando Java" %}}
 ...
 Per renderizzare PSB in PDF, useremo
...
{{% blocks/products/pf/agp/text %}}
 ...
 L'API Aspose.PSD consente agli sviluppatori di convertire facilmente i file PSB in PDF in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

- Caricare il file PSB
- Crea un'istanza di [classe PDFOptions](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/PdfOptions)
- Usa il metodo Image.save (String, PDFOptions) per la conversione.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo live di conversione da PSB a PDF" sectionDescription="[Convertire PSB in PDF](https://products.aspose.app/psd/conversion/psb-to-pdf) in questo momento visitando il nostro sito Web Live Demos. La demo live offre i seguenti vantaggi" >}}
