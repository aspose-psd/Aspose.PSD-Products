...
weight: 160
description: Esempio di codice di conversione Java per il formato PSB in file PSD. Usa questo codice di esempio per convertire PSB in PSD all'interno di qualsiasi applicazione Web o desktop basata su Java.
url: psb-to-psd/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/upper-banner h1="Convert PSB to PSD via Java" h2="API Java Photoshop per la conversione da PSB a PSD" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PSD" pfName="Aspose.PSD" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PSB" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire PSB in PSD usando Java" %}}
 ...
 Per rendere PSB in PSD, useremo
...
{{% blocks/products/pf/agp/text %}}
 ...
 L'API Aspose.PSD consente agli sviluppatori di convertire facilmente i file PSB in PSD in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

- Caricare il file PSB
- Crea un'istanza di [classe PSDOptions](https://apireference.aspose.com/psd/java/com.aspose.psd.imageoptions/PsdOptions)
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo live di conversione da PSB a PSD" sectionDescription="[Convert PSB to PSD](https://products.aspose.app/psd/conversion/psb-to-psd) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
