---
title: Converti AI in BMP tramite C#
description: Codice di esempio per la conversione da AI a BMP C#. Utilizzare il codice di esempio API per la conversione batch di file AI in BMP all'interno di VB.NET, Asp.NET o qualsiasi applicazione basata su .NET.
url: it/net/conversion/ai-to-bmp/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converti AI in BMP tramite C#" h2="" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/psd/aspose_psd-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="Aspose.PSD" subTitlepfName="per .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PSD" fileiconsmall4="XML" fileiconsmall5="AI" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire AI in BMP usando C#" %}}

Per convertire l'IA in BMP, useremo<a href="/psd/{{< lang-code >}}net">Aspose.PSD per .NET</a> API che è un'API di conversione e manipolazione dei documenti ricca di funzionalità, potente e facile da usare per la piattaforma C#. Aprire<a href="https://www.nuget.org/packages/aspose.psd">NuGet</a> gestore pacchetti, cerca<b>Aspose.PSD</b> e installa. È inoltre possibile utilizzare il seguente comando dalla Console di gestione pacchetti.
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire AI in BMP tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.PSD semplifica agli sviluppatori il caricamento e la conversione di file AI in BMP in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Caricare l'IA con il metodo [Image.Load](https://apiference.aspose.com/psd/net/aspose.psd/image/methods/load/index)
1. Crea un'istanza della classe [BmpOptions](https://apiference.aspose.com/imaging/net/aspose.imaging.imageoptions/bmpoptions)
...
{{% blocks/products/pf/agp/code-block title="Questo codice di esempio mostra la conversione da AI a BMP C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="App gratuita per convertire l'IA in BMP" sectionDescription="Controlla le nostre demo dal vivo per [conversione da AI a BMP](https://products.aspose.app/psd/conversion/ai-to-bmp) con i seguenti vantaggi." >}}
