...
weight: 210
description: Codice di esempio per la conversione C# da PSD a PSB. Utilizzare il codice di esempio API per la conversione batch di file PSD in PSB all'interno di VB.NET, Asp.NET o qualsiasi applicazione basata su .NET.
url: it/net/conversion/psd-to-psb/
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD semplifica agli sviluppatori il caricamento e la conversione di file PSD in PSB in poche righe di codice.
...
{{% blocks/products/pf/agp/code-block title="Questo codice di esempio mostra la conversione C# da PSD a PSB" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="App gratuita per convertire PSD in PSB" sectionDescription="Controlla le nostre demo dal vivo per [conversione da PSD a PSB](https://products.aspose.app/psd/conversion/psd-to-psb) con i seguenti vantaggi." >}}
