---
title: Converti PSB in BMP con C#
...
url: it/net/conversion/psb-to-bmp/
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti PSB in BMP tramite C#" h2=".NET Photoshop API per PSD e PSB Conversione in immagini raster incluso BMP">}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET Codice C# per la conversione da PSB a BMP" gistPath="" %}}
