...
weight: 240
description: Codice di esempio per la conversione da PSB a PSD C#. Utilizzare il codice di esempio API per la conversione batch di file PSB in PSD all'interno di VB.NET, Asp.NET o qualsiasi applicazione basata su .NET.
url: it/net/conversion/psb-to-psd/
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.PSD semplifica agli sviluppatori il caricamento e la conversione di file PSB in PSD in poche righe di codice.
...
{{< blocks/products/pf/agp/demobox sectionTitle="App gratuita per convertire PSB in PSD" sectionDescription="Controlla le nostre demo dal vivo per [conversione da PSB a PSD](https://products.aspose.app/psd/conversion/psb-to-psd) con i seguenti vantaggi." >}}
