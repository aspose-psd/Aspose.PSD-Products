...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti PSD in JPEG tramite C#" h2=".NET Photoshop API per la conversione da PSD e PSB a immagini raster, incluso JPEG" >}}
...
1. Carica il PSD con [Immagine.Load](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) metodo
 [Opzioni JPEG](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/jpegoptions) classe
...
{{% blocks/products/pf/agp/code-autogen title="Codice C# .NET per la conversione da PSD a JPEG" gistPath="" %}}
