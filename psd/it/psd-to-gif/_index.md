---
title: Converti PSD in GIF con C#
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti PSD in GIF tramite C#" h2=".NET Photoshop API per la conversione da PSD e PSB a immagini raster incluse GIF" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Rendering di alta qualità di PSD come GIF" %}}
1. Carica il PSD con [Immagine.Load](https://apireference.aspose.com/psd/net/aspose.psd/image/methods/load/index) metodo
1. Crea un'istanza di Graphics dall'immagine. [Opzioni GIF](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/gifoptions) classe
...
{{% blocks/products/pf/agp/code-autogen title="Codice C# .NET per la conversione da PSD a GIF" gistPath="" %}}
