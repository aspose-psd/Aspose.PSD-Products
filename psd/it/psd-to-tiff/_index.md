...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti PSD in TIFF tramite C#" h2=".NET Photoshop API per la conversione da PSD e PSB a immagini raster, incluso TIFF" >}}
...
1. Crea un'istanza di Graphics dall'immagine. [Opzioni TIFF](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/tiffoptions) classe
...
{{% blocks/products/pf/agp/code-autogen title="Codice C# .NET per la conversione da PSD a TIFF" gistPath="" %}}
