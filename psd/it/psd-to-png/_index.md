...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti PSD in PNG tramite C#" h2=".NET Photoshop API per la conversione da PSD e PSB a immagini raster tra cui PNG" >}}
...
1. Crea un'istanza di Graphics dall'immagine. [Opzioni PNG](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/pngoptions) classe
...
{{% blocks/products/pf/agp/code-autogen title="Codice C# .NET per la conversione da PSD a PNG" gistPath="" %}}
