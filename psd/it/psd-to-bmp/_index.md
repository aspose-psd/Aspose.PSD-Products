---
title: Convertire PSD in BMP con C#
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti PSD in BMP tramite C#" h2=".NET Photoshop API per la conversione in immagini raster tra cui BMP" >}}
...
1. Crea un'istanza di Graphics dall'immagine. [Opzioni BMP](https://apireference.aspose.com/psd/net/aspose.psd.imageoptions/bmpoptions) classe
...
{{% blocks/products/pf/agp/code-autogen title="Codice C# .NET per la conversione da PSD a BMP" gistPath="" %}}
